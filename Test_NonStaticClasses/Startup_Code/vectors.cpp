...
VectorTable const __vector_table = {
   ...
   &__StackTop,                                /*    0   -16  Initial stack pointer                                                            */
   {
      ...
      USBDM::Pit::Channel<0>::irqHandler,      /*   64,   48  Periodic Interrupt Timer                                                         */
      USBDM::Pit::Channel<1>::irqHandler,      /*   65,   49  Periodic Interrupt Timer                                                         */
      USBDM::Pit::Channel<2>::irqHandler,      /*   66,   50  Periodic Interrupt Timer                                                         */
      USBDM::Pit::Channel<3>::irqHandler,      /*   67,   51  Periodic Interrupt Timer                                                         */
