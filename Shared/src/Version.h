...
#define USBDM_VERSION_NANO   320     //!< DLL Nano version #

#ifdef LOG
#define USBDM_VERSION_STRING "4.12.1.325-Debug" //!< Version as string
#else
#define USBDM_VERSION_STRING "4.12.1.325"       //!< Version as string
#endif
