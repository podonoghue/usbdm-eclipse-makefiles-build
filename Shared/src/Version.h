...
#define USBDM_VERSION_NANO   270     //!< DLL Nano version #

#ifdef LOG
#define USBDM_VERSION_STRING "4.12.1.270-Debug" //!< Version as string
#else
#define USBDM_VERSION_STRING "4.12.1.270"       //!< Version as string
#endif
