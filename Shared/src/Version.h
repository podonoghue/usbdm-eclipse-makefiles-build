...
#define USBDM_VERSION_NANO   275     //!< DLL Nano version #

#ifdef LOG
#define USBDM_VERSION_STRING "4.12.1.275-Debug" //!< Version as string
#else
#define USBDM_VERSION_STRING "4.12.1.275"       //!< Version as string
#endif
