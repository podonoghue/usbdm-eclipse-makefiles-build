...
#define USBDM_VERSION_NANO   340     //!< DLL Nano version #

#ifdef LOG
#define USBDM_VERSION_STRING "4.12.1.340-Debug" //!< Version as string
#else
#define USBDM_VERSION_STRING "4.12.1.340"       //!< Version as string
#endif
