...
#define USBDM_VERSION_NANO   290     //!< DLL Nano version #

#ifdef LOG
#define USBDM_VERSION_STRING "4.12.1.290-Debug" //!< Version as string
#else
#define USBDM_VERSION_STRING "4.12.1.290"       //!< Version as string
#endif
