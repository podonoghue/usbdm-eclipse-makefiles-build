...
UsbdmDialogueSkeleton::UsbdmDialogueSkeleton( wxWindow* parent, wxWindowID id, const wxString& title, const wxPoint& pos, const wxSize& size, long style ) : wxDialog( parent, id, title, pos, size, style )
{
	...
	bdmSelectChoiceControl = new wxChoice( sbSizer4->GetStaticBox(), wxID_ANY, wxDefaultPosition, wxDefaultSize, bdmSelectChoiceControlChoices, 0 );
	...
	bdmRefreshButtonControl = new wxButton( sbSizer4->GetStaticBox(), wxID_ANY, wxT("Detect"), wxDefaultPosition, wxDefaultSize, 0 );
	...
	connectionSpeedStaticTextWarning = new wxStaticText( sbSizer6->GetStaticBox(), wxID_ANY, wxT("Speed < Target Clock Frequency/5"), wxDefaultPosition, wxDefaultSize, 0 );
	...
	loadFileButtonControl = new wxButton( sbSizer7->GetStaticBox(), wxID_ANY, wxT("Load Hex File"), wxDefaultPosition, wxDefaultSize, 0 );
	...
	deviceTypeChoiceControl = new wxChoice( sbSizer12->GetStaticBox(), wxID_ANY, wxDefaultPosition, wxDefaultSize, deviceTypeChoiceControlChoices, 0 );
	...
	trimAddressStaticControl = new wxStaticText( sbSizer13->GetStaticBox(), wxID_ANY, wxT("Flash Trim Address"), wxDefaultPosition, wxDefaultSize, 0 );
	trimAddressStaticControl->Wrap( -1 );
	gbSizer31->Add( trimAddressStaticControl, wxGBPosition( 0, 0 ), wxGBSpan( 1, 2 ), wxLEFT, 10 );

	trimFrequencyStaticControl = new wxStaticText( sbSizer13->GetStaticBox(), wxID_ANY, wxT("Trim Frequency"), wxDefaultPosition, wxDefaultSize, 0 );
	trimFrequencyStaticControl->Wrap( -1 );
	gbSizer31->Add( trimFrequencyStaticControl, wxGBPosition( 0, 2 ), wxGBSpan( 1, 2 ), wxRIGHT|wxLEFT, 5 );

	trimAddressTextControl = new NumberTextEditCtrl( sbSizer13->GetStaticBox(), wxID_ANY, wxEmptyString, wxDefaultPosition, wxDefaultSize, 0 );
	...
	trimAddressStaticControlHex = new wxStaticText( sbSizer13->GetStaticBox(), wxID_ANY, wxT("(hex)     "), wxDefaultPosition, wxDefaultSize, 0 );
	...
	trimFrequencyTextControl = new NumberTextEditCtrl( sbSizer13->GetStaticBox(), wxID_ANY, wxEmptyString, wxDefaultPosition, wxDefaultSize, 0 );
	...
	trimFrequencyStaticControlkHz = new wxStaticText( sbSizer13->GetStaticBox(), wxID_ANY, wxT("kHz    "), wxDefaultPosition, wxDefaultSize, 0 );
	...
	trimFrequencyCheckBoxControl = new wxCheckBox( sbSizer13->GetStaticBox(), wxID_ANY, wxT("Do trim"), wxDefaultPosition, wxDefaultSize, 0 );
	...
	trimValueStaticControl = new wxStaticText( sbSizer13->GetStaticBox(), wxID_ANY, wxT("Calculated trim Value ?.??"), wxDefaultPosition, wxDefaultSize, 0 );
	...
	securityRadioBoxControl->SetSelection( 3 );
	...
	sbSizer16 = new wxStaticBoxSizer( new wxStaticBox( fTargetPanel, wxID_ANY, wxT("Reset Method") ), wxVERTICAL );
	...
	programFlashButtonControl = new wxButton( sbSizer15->GetStaticBox(), wxID_ANY, wxT("Program Flash"), wxDefaultPosition, wxDefaultSize, 0 );
	...
	flexNvmDescriptionStaticControl = new wxStaticText( sbSizer3->GetStaticBox(), wxID_ANY, wxT("EEPROM emulation will be disabled if device is mass erased"), wxDefaultPosition, wxDefaultSize, 0 );
	...
	customSecurityCheckbox = new wxCheckBox( sbSizer41->GetStaticBox(), wxID_ANY, wxT("Enable"), wxDefaultPosition, wxDefaultSize, 0 );
	...
	securityMemoryRegionChoice = new wxChoice( sbSizer41->GetStaticBox(), wxID_ANY, wxDefaultPosition, wxDefaultSize, securityMemoryRegionChoiceChoices, 0 );
	...
	resetChoiceControl->Connect( wxEVT_COMMAND_CHOICE_SELECTED, wxCommandEventHandler( UsbdmDialogueSkeleton::onResetChoiceSelect ), NULL, this );
...
UsbdmDialogueSkeleton::~UsbdmDialogueSkeleton()
{
	...
	resetChoiceControl->Disconnect( wxEVT_COMMAND_CHOICE_SELECTED, wxCommandEventHandler( UsbdmDialogueSkeleton::onResetChoiceSelect ), NULL, this );
