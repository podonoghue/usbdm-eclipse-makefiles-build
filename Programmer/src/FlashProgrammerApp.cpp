...
static const wxCmdLineEntryDesc g_cmdLineDesc[] = {
      { wxCMD_LINE_SWITCH, "help",          NULL, "Help" },
      { wxCMD_LINE_PARAM,  NULL,            NULL, "Name of the S19 Hex file to load",                               wxCMD_LINE_VAL_STRING, wxCMD_LINE_PARAM_OPTIONAL },
      ...
      { wxCMD_LINE_SWITCH, "execute",       NULL, "Leave target power on & reset to normal mode at completion",                           },
      ...
      { wxCMD_LINE_OPTION, "target",        NULL, "Target type (RS08, HCS08, HCS12, S12Z, CFV1, CFVX, ARM, MC56F)", wxCMD_LINE_VAL_STRING },
#ifdef __unix__
