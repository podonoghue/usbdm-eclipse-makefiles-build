...
set JB16_Files=TBDML_JB16_SOIC20[Minimal].pdf TBDML_JB16_SOIC28[Minimal].pdf USBDM_JB16_SOIC28[USB_Stick].pdf Flash_Images.sx.zip
set JMxx_Files=USBDM_JMxxCLD.pdf Flash_Images.sx.zip
set JS16_Files=USBDM_JS16CWJ.pdf USBDM_SWD_JS16CWJ.pdf USBDM_SWD_SER_JS16CWJ.pdf Flash_Images.sx.zip
set JMxxCF_Files=USBDM_CF_JMxxCLD_V3.pdf Flash_Images.sx.zip
set JS16CF_Files=USBDM_CF_JS16CWJ.pdf USBDM_CF_SER_JS16CWJ.pdf Flash_Images.sx.zip
set Kinetis_Adapter_Files=KinetisAdapter.pdf KinetisAdapter.zip Flash_Images.sx.zip
