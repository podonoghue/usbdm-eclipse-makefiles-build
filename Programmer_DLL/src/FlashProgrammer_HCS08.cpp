...
//! +---------------------------------------------------+ -+
//!
USBDM_ErrorCode FlashProgrammer_HCS08::loadLargeTargetProgram(uint8_t    *buffer,
                                                        uint32_t              loadAddress,
                                                        uint32_t              size,
...
//!
USBDM_ErrorCode FlashProgrammer_HCS08::checkUnsupportedTarget() {
   LOGGING;
   USBDM_ErrorCode rc;
   uint32_t targetSDID;
...
//!
void FlashProgrammer_HCS08::deleteSecurityAreas(void) {
   securityAreaCount = 0;
}
...
//! @return error code see \ref USBDM_ErrorCode.
//!
USBDM_ErrorCode FlashProgrammer_HCS08::recordSecurityArea(const uint32_t address, const int size, const uint8_t *data) {
...
//!
void FlashProgrammer_HCS08::restoreSecurityAreas(FlashImagePtr flashImage) {
   LOGGING_Q;
...
//!
USBDM_ErrorCode FlashProgrammer_HCS08::doFlashBlock(FlashImagePtr flashImage,
