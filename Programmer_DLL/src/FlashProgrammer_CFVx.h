/*
 * FlashProgrammer_CFVx.h
 *
 *  Created on: 22 Mar 2015
 *      Author: podonoghue
 */

#ifndef SOURCE_FLASHPROGRAMMER_CFVX_H_
#define SOURCE_FLASHPROGRAMMER_CFVX_H_
...
class USBDM_FLASHPROGRAMMER_DECLSPEC FlashProgrammer_CFVx : public FlashProgrammerCommon {

public:
   FlashProgrammer_CFVx();
   virtual ~FlashProgrammer_CFVx();
