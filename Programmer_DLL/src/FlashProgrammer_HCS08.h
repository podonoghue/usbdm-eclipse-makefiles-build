...
#ifndef SOURCE_FLASHPROGRAMMER_HCS08_H_
#define SOURCE_FLASHPROGRAMMER_HCS08_H_
...
class USBDM_FLASHPROGRAMMER_DECLSPEC FlashProgrammer_HCS08 : public FlashProgrammerCommon {

public:
   FlashProgrammer_HCS08();
   virtual ~FlashProgrammer_HCS08();
