...
//!
USBDM_ErrorCode FlashProgrammer_ARM::readTargetChipId(uint32_t *targetSDID) {
   LOGGING_E;
...
//! @return error code, see \ref USBDM_ErrorCode
//!
USBDM_ErrorCode FlashProgrammer_ARM::massEraseTarget(void) {
   LOGGING;
...
USBDM_ErrorCode FlashProgrammer_ARM::getCalculatedTrimValue(uint16_t &value) {
...
extern "C" FlashProgrammer USBDM_FLASHPROGRAMMER_DECLSPEC *createPluginInstance() {
   return new FlashProgrammer_ARM();
}
