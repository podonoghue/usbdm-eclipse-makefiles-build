...
//!
USBDM_ErrorCode FlashProgrammer_CFV1::readTargetChipId(uint32_t *targetSDID) {
   LOGGING_E;
...
//! @return error code, see \ref USBDM_ErrorCode
//!
USBDM_ErrorCode FlashProgrammer_CFV1::massEraseTarget(void) {
   LOGGING;
...
extern "C" FlashProgrammer USBDM_FLASHPROGRAMMER_DECLSPEC *createPluginInstance() {
   return new FlashProgrammer_CFV1();
}
