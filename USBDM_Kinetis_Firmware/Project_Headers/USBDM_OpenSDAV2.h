/*! @file
    ...
    USBDM_OpenSDA - USBDM-SWD for OpenSDA2 on FRDM-K22F & K64F boards (MK20 chip)
...
//
#define HW_CAPABILITY       (CAP_VDDCONTROL|CAP_RST_IO|CAP_SWD_HW|CAP_CDC|CAP_CORE_REGS)
#define TARGET_CAPABILITY   (CAP_VDDCONTROL|CAP_RST   |CAP_ARM_SWD|CAP_CDC)
