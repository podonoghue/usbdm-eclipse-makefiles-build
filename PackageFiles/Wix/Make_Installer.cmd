...
rem set LIGHT_DIRS=-b %SRC_DIR%\DeviceData -b %SRC_DIR%\Stationery -b %SRC_DIR%\FlashImages -b %SRC_DIR%\WizardPatches -b %SRC_DIR%\Examples -b %SRC_DIR%\CodewarriorUpdateSite -b %SRC_DIR%\EclipseUpdateSite
