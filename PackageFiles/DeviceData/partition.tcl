...
;######################################################################################
;#
;# @param flashRegions - list of flash array addresses (not used)
;#
...
;#
   puts "*** calculateFlashDivider { $busFrequency }"
...
;######################################################################################
;#
;#  Initialise flash before first use
;#  Uses flash speed calculated from BDM connection speed
;#
proc initFlash { } {
   
   ;# Flash speed calculated from BDM connection speed
   set busFrequency [expr [speed]/1000]
   puts "*** initFlash: measured bus frequency = $busFrequency kHz"
...
;# The device is left entirely blank which is treated as unsecured by these HCS devices.
;#
