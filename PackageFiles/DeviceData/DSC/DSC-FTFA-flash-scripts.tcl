...
proc loadSymbols {} {
   ...
   set ::FTFA_FSTAT                      x:0x01C780
   set ::FTFA_FCNFG                      x:0x01C781
   set ::FTFA_FSEC                       x:0x01C782
   set ::FTFA_FOPT                       x:0x01C783
...
proc isUnsecure { } {
   ...
   set securityValue [rb $::FTFA_FSEC]
   puts [format "isUnsecure{} - FTFA_FSEC=0x%X" $securityValue ]
