...
// MCG_MC_HIRCLPEN ==============================
//
//   <q> High-frequency IRC (IRC48MHz) low power Enable (HIRCLPEN) <name=mcg_mc_hirclpen>
//   <i> Enables the HIRC in Low-power modes (Stop/VLPR/VLPW/VLPS)[MCG_MC_HIRCLPEN]
//     <0=> HIRC source is not enabled
//     <1=> HIRC source is enabled
#define MCG_MC_HIRCLPEN_V 0
#define MCG_MC_HIRCLPEN_M (MCG_MC_HIRCLPEN_V<<MCG_MC_HIRCLPEN_SHIFT)
