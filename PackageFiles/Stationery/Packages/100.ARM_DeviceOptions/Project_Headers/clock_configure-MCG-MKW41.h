...
//<i> In BLPE mode, MCGOUT is derived from the external reference clock. The FLL is disabled.
...
//  <i> Derived from slow IRC, fast IRC, ERC or FLL
...
#define SIM_SOPT2_LPUART0SRC_M  SIM_SOPT2_LPUART0SRC(SIM_SOPT2_LPUART0SRC_V)

#if (SIM_SOPT2_LPUART0SRC_V == (0))
#define SYSTEM_LPUART0_CLOCK (0)
#elif (SIM_SOPT2_LPUART0SRC_V == (1))
#define SYSTEM_LPUART0_CLOCK SYSTEM_MCGFLL_CLOCK
#elif (SIM_SOPT2_LPUART0SRC_V == (2))
#define SYSTEM_LPUART0_CLOCK OSCCLK_CLOCK
