...
// <validate=net.sourceforge.usbdm.annotationEditor.validators.ClockValidate_MKE04(48000000, 24000000, 48000000)>
//
// FLL clock                                                                    fllFactor
// <validate=net.sourceforge.usbdm.annotationEditor.validators.ICSClockValidate(1280     )>
