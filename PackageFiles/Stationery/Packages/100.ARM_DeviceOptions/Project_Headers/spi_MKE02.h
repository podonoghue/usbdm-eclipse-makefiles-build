...
enum PinselSpi {
   //! SPI0_SCK, SPI0_MOSI, SPI0_MISO, SPI0_PCS0 => PTB2, PTB3, PTB4, PTB5
   PinselSpi_Ptb2_Ptb3_Ptb4_PtB5 = SIM_PINSEL_SPI0PS(0),

   //! SPI0_SCK, SPI0_MOSI, SPI0_MISO, SPI0_PCS0 => PTE0, PTE1, PTE2, PTE3
   PinselSpi_Pte0_Pte1_Pte2_Pte3 = SIM_PINSEL_SPI0PS(1),
};
...
public:
   ...
   //! Pin selection table
   static constexpr uint32_t pinSelections[] = {
         PinselSpi_Ptb2_Ptb3_Ptb4_PtB5,
         PinselSpi_Pte0_Pte1_Pte2_Pte3,
   };

   static constexpr uint32_t pinSelection = PinselSpi_Ptb2_Ptb3_Ptb4_PtB5;
    ...
    */
   static void initPCRs(uint32_t pinSelValue=pinSelection) {
      SIM->PINSEL = (SIM->PINSEL&~SIM_PINSEL_SPI0PS_MASK)|pinSelValue;
   }
