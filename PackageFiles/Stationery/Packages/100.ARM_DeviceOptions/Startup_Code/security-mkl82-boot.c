/*
 *  @file security.c
 *  Derived from security-mkl82-boot.c
 *
 *  Security and NV options for flash with boot options
 *  Reference KL82P121M72SF0RM
...
<h> Flash boot options
   ...
   <o1> Boot Source Selection
      ...
      <0=> 0: Boot from Flash
      <64=> 1: Reserved
      <128=> 2: Boot from bootloader ROM with enabled QSPI0
...
#define FOPT_MISC      (0x23)   // q2
#define FOPT_RESERVED  (0x18)   // Bits not controlled by above
