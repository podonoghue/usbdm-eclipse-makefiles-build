/*
 *  @file security.c
 *  Derived from security-mk-boot.c
 *
 *  Security and NV options for flash
 *  Reference K82P121M150SF5RM
...
#define FOPT_VALUE (FOPT_RESERVED|FOPT_MISC|FOPT_BOOTSRC)
#else
#define FOPT_VALUE (FOPT_RESERVED|FOPT_MISC|FOPT_BOOT_OFF)
#endif
