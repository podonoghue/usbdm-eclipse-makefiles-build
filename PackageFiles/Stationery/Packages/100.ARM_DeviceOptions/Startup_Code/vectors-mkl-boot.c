/*
 *  @file vectors.c
 *  Derived from  vectors-mkl-boot.c
 *
...
#define FOPT_MISC      (0x27)
#define FOPT_RESERVED  (0x18)

#if defined(NV_FOPT_BOOTSRC_SEL) && BOOT_ENABLE
#define FOPT_VALUE (FOPT_BOOTSRC|FOPT_MISC|FOPT_RESERVED)
#else
#define FOPT_VALUE (0xC2|FOPT_MISC|FOPT_RESERVED)
#endif
