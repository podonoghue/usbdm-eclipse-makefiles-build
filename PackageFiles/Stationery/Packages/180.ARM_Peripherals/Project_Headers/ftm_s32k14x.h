/**
 * @file     ftm.h (180.ARM_Peripherals/Project_Headers/ftm_s32k14x.h)
...
enum FtmClockSource {
   ...
   FtmClockSource_FixedFreq   = FTM_SC_CLKS(2),            //!< Fixed frequency clock
   FtmClockSource_RtcClk      = FtmClockSource_FixedFreq,  //!< Fixed frequency clock (RTC)
...
public:
   ...
   /**
    * Enable timer overflow interrupts in NVIC
    */
   static void enableTimerOverflowNvicInterrupts() {
      NVIC_EnableIRQ(Info::irqNums[5]);
   }
    ...
    */
   static void enableTimerOverflowNvicInterrupts(uint32_t nvicPriority) {
      enableNvicInterrupt(nvicPriority, Info::irqNums[5]);
   }

   /**
    * Disable timer overflow interrupts in NVIC
    */
   static void disableTimerOverflowNvicInterrupts() {
      NVIC_DisableIRQ(Info::irqNums[5]);
   }

   /**
    * Enable timer fault interrupts in NVIC
    */
   static void enableFaultNvicInterrupts() {
      NVIC_EnableIRQ(Info::irqNums[4]);
   }
    ...
    * @note Any pending interrupts are cleared before enabling.
    */
   static void enableFaultNvicInterrupts(uint32_t nvicPriority) {
      enableNvicInterrupt(nvicPriority, Info::irqNums[4]);
   }

   /**
    * Disable timer fault interrupts in NVIC
    */
   static void disableFaultNvicInterrupts() {
      NVIC_DisableIRQ(Info::irqNums[4]);
   }

   /**
    * Enable a channel interrupt in NVIC
    *
    * @tparam channel Channel to enable
    */
   template<unsigned channel>
   static void enableChannelNvicInterrupts() {
      NVIC_EnableIRQ(Info::irqNums[channel]);
   }
    ...
    */
   template<unsigned channel>
   static void enableChannelNvicInterrupts(uint32_t nvicPriority) {
      enableNvicInterrupt(nvicPriority, Info::irqNums[channel]);
   }

   /**
    * Disable a channel interrupt in NVIC
    *
    * @tparam channel Channel to enable
    */
   template<unsigned channel>
   static void disableChannelNvicInterrupts() {
      NVIC_DisableIRQ(Info::irqNums[channel]);
   }
...
public:
   ...
   public:
       ...
       */
      static void enableChannelNvicInterrupts() {
         Ftm::enableChannelNvicInterrupts<channel>();
      }
       ...
       */
      static void enableChannelNvicInterrupts(uint32_t nvicPriority) {
         Ftm::enableChannelNvicInterrupts<channel>(nvicPriority);
      }
