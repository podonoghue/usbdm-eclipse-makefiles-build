...
//   <o> ADC0_DM3 Pin Selection [ADC0_DM3] <constant>
...
//   <o> ADC0_DP3 Pin Selection [ADC0_DP3] <constant>
...
//   <o> ADC0_SE4b Pin Selection [PTC2(D10)] <constant>
...
//   <o> ADC0_SE6b Pin Selection [PTD5(A3)] <constant>
...
//   <o> ADC0_SE7b Pin Selection [PTD6(A2)] <constant>
...
//   <o> ADC0_SE8 Pin Selection [PTB0(A5,ACC_SCL)] <constant>
...
//   <o> ADC0_SE9 Pin Selection [PTB1(A4,ACC_SDA)] <constant>
...
//   <o> ADC0_SE12 Pin Selection [PTB2(D15)] <constant>
...
//   <o> ADC0_SE13 Pin Selection [PTB3(D14)] <constant>
...
//   <o> ADC0_SE14 Pin Selection [PTC0(A0)] <constant>
...
//   <o> ADC0_SE15 Pin Selection [PTC1(A1)] <constant>
...
//   <o> FTM0_CH0 Pin Selection [PTA3, PTC1(A1)] 
...
//   <o> FTM0_CH1 Pin Selection [PTA4(D21), PTC2(D10)] 
...
//   <o> FTM0_CH2 Pin Selection [PTA5(D2), PTC3(D6,LED_RED)] 
...
//   <o> FTM0_CH3 Pin Selection [PTC4(D7)] <constant>
...
//   <o> FTM0_CH4 Pin Selection [PTD4(D3,LED_GREEN)] <constant>
...
//   <o> FTM0_CH5 Pin Selection [PTA0, PTD5(A3)] 
...
//   <o> FTM0_CH6 Pin Selection [PTA1(D5), PTD6(A2)] 
...
//   <o> FTM0_CH7 Pin Selection [PTA2(D9,LED_BLUE), PTD7(D22)] 
...
//   <o> FTM1_CH0 Pin Selection [PTA12(D8), PTB0(A5,ACC_SCL)] 
...
//   <o> FTM1_CH1 Pin Selection [PTA13(D24), PTB1(A4,ACC_SDA)] 
...
//   <o> LPTMR0_ALT2 Pin Selection [PTC5(D18)] 
...
// ADC0_DM3 = ADC0_DM3
#define ADC0_DM3_ADC_NUM           0     //!< ADC0_DM3 ADC number
#define ADC0_DM3_ADC_CH            3     //!< ADC0_DM3 ADC channel
#define ADC0_DM3_ADC_FN            0     //!< ADC0_DM3 Pin multiplexor for ADC
...
// ADC0_DP3 = ADC0_DP3
#define ADC0_DP3_ADC_NUM           0     //!< ADC0_DP3 ADC number
#define ADC0_DP3_ADC_CH            3     //!< ADC0_DP3 ADC channel
#define ADC0_DP3_ADC_FN            0     //!< ADC0_DP3 Pin multiplexor for ADC
...
// PTA1 = GPIOA_1,FTM0_CH6 (Alias: D5)
...
// PTA2 = GPIOA_2,FTM0_CH7 (Alias: D9,LED_BLUE)
...
// PTA4 = GPIOA_4,FTM0_CH1 (Alias: D21)
...
// PTA5 = GPIOA_5,FTM0_CH2 (Alias: D2)
...
// PTA12 = GPIOA_12,FTM1_CH0 (Alias: D8)
...
// PTA13 = GPIOA_13,FTM1_CH1 (Alias: D24)
...
// PTB0 = ADC0_SE8,GPIOB_0,I2C0_SCL,FTM1_CH0 (Alias: A5,ACC_SCL)
...
// PTB1 = ADC0_SE9,GPIOB_1,I2C0_SDA,FTM1_CH1 (Alias: A4,ACC_SDA)
...
// PTB3 = ADC0_SE13,GPIOB_3,I2C0_SDA (Alias: D14)
...
// PTC0 = ADC0_SE14,GPIOC_0,SPI0_PCS4 (Alias: A0)
...
// PTC1 = ADC0_SE15,GPIOC_1,SPI0_PCS3,FTM0_CH0 (Alias: A1)
...
// PTC2 = ADC0_SE4b,GPIOC_2,SPI0_PCS2,FTM0_CH1 (Alias: D10)
...
// PTC3 = GPIOC_3,SPI0_PCS1,FTM0_CH2 (Alias: D6,LED_RED)
...
// PTC4 = GPIOC_4,SPI0_PCS0,FTM0_CH3 (Alias: D7)
...
// PTC5 = GPIOC_5,SPI0_SCK,LPTMR0_ALT2 (Alias: D18)
...
// PTD1 = ADC0_SE5b,GPIOD_1,SPI0_SCK (Alias: D13)
...
// PTD4 = GPIOD_4,SPI0_PCS1,FTM0_CH4 (Alias: D3,LED_GREEN)
...
// PTD5 = ADC0_SE6b,GPIOD_5,SPI0_PCS2,FTM0_CH5 (Alias: A3)
...
// PTD6 = ADC0_SE7b,GPIOD_6,SPI0_PCS3,FTM0_CH6 (Alias: A2)
...
// PTD7 = GPIOD_7,FTM0_CH7 (Alias: D22)
