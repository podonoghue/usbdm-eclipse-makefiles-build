...
//   <o> ADC0_SE16  [ADC0_SE16/ADC0_SE21] <constant>
//   <i> Selects which peripheral function is mapped to ADC0_SE16 pin
//     <0=> ADC0_SE16/ADC0_SE21
//     <0=> Default
#define ADC0_SE16_SEL        0                   
...
//   <o> ADC1_SE16  [ADC1_SE16/ADC0_SE22] <constant>
//   <i> Selects which peripheral function is mapped to ADC1_SE16 pin
//     <0=> ADC1_SE16/ADC0_SE22
//     <0=> Default
#define ADC1_SE16_SEL        0                   
...
// PTA0 Pin Mapping
//   <o> PTA0  (Alias:D8)  [GPIOA_0, FTM0_CH5] 
...
// PTA1 Pin Mapping
//   <o> PTA1  (Alias:D3)  [GPIOA_1, FTM0_CH6] 
...
// PTA2 Pin Mapping
//   <o> PTA2  (Alias:D5)  [GPIOA_2, FTM0_CH7] 
...
// PTA7 Pin Mapping
//   <o> PTA7  [ADC0_SE10, GPIOA_7, FTM0_CH4] 
...
// PTA8 Pin Mapping
//   <o> PTA8  [ADC0_SE11, GPIOA_8, FTM1_CH0] 
//   <i> Selects which peripheral function is mapped to PTA8 pin
//     <0=> ADC0_SE11
//     <1=> GPIOA_8
//     <3=> FTM1_CH0
//     <0=> Default
...
// PTA9 Pin Mapping
//   <o> PTA9  [GPIOA_9, FTM1_CH1] 
//   <i> Selects which peripheral function is mapped to PTA9 pin
//     <1=> GPIOA_9
//     <3=> FTM1_CH1
//     <1=> Default
#define PTA9_SEL             1                   
...
// PTA10 Pin Mapping
//   <o> PTA10  [GPIOA_10, FTM2_CH0] 
//   <i> Selects which peripheral function is mapped to PTA10 pin
//     <1=> GPIOA_10
//     <3=> FTM2_CH0
//     <1=> Default
#define PTA10_SEL            1                   
...
// PTA11 Pin Mapping
//   <o> PTA11  [GPIOA_11, FTM2_CH1, I2C2_SDA] 
//   <i> Selects which peripheral function is mapped to PTA11 pin
//     <1=> GPIOA_11
//     <3=> FTM2_CH1
//     <5=> I2C2_SDA
//     <1=> Default
...
// PTA12 Pin Mapping
//   <o> PTA12  [GPIOA_12, FTM1_CH0, I2C2_SCL] 
...
// PTA13 Pin Mapping
//   <o> PTA13  [GPIOA_13, FTM1_CH1, I2C2_SDA] 
...
// PTA14 Pin Mapping
//   <o> PTA14  [GPIOA_14, SPI0_PCS0, I2C2_SCL] 
...
// PTA24 Pin Mapping
//   <o> PTA24  [GPIOA_24] <constant>
//   <i> Selects which peripheral function is mapped to PTA24 pin
//     <1=> GPIOA_24
//     <1=> Default
#define PTA24_SEL            1                   

// PTA25 Pin Mapping
//   <o> PTA25  [GPIOA_25] <constant>
//   <i> Selects which peripheral function is mapped to PTA25 pin
//     <1=> GPIOA_25
//     <1=> Default
#define PTA25_SEL            1                   

// PTA26 Pin Mapping
//   <o> PTA26  [GPIOA_26] <constant>
//   <i> Selects which peripheral function is mapped to PTA26 pin
//     <1=> GPIOA_26
//     <1=> Default
#define PTA26_SEL            1                   

// PTA27 Pin Mapping
//   <o> PTA27  [GPIOA_27] <constant>
//   <i> Selects which peripheral function is mapped to PTA27 pin
//     <1=> GPIOA_27
//     <1=> Default
#define PTA27_SEL            1                   

// PTA28 Pin Mapping
//   <o> PTA28  [GPIOA_28] <constant>
//   <i> Selects which peripheral function is mapped to PTA28 pin
//     <1=> GPIOA_28
//     <1=> Default
#define PTA28_SEL            1                   

// PTA29 Pin Mapping
//   <o> PTA29  [GPIOA_29] <constant>
//   <i> Selects which peripheral function is mapped to PTA29 pin
//     <1=> GPIOA_29
//     <1=> Default
#define PTA29_SEL            1                   

// PTB0 Pin Mapping
//   <o> PTB0  [ADC0_SE8/ADC1_SE8, GPIOB_0, I2C0_SCL, FTM1_CH0] 
...
// PTB1 Pin Mapping
//   <o> PTB1  [ADC0_SE9/ADC1_SE9, GPIOB_1, I2C0_SDA, FTM1_CH1] 
...
// PTB2 Pin Mapping
//   <o> PTB2  (Alias:A0)  [ADC0_SE12, GPIOB_2, I2C0_SCL] 
...
// PTB3 Pin Mapping
//   <o> PTB3  (Alias:A1)  [ADC0_SE13, GPIOB_3, I2C0_SDA] 
...
// PTB9 Pin Mapping
//   <o> PTB9  (Alias:D2)  [GPIOB_9, SPI1_PCS1] 
...
// PTB10 Pin Mapping
//   <o> PTB10  (Alias:A2)  [ADC1_SE14, GPIOB_10, SPI1_PCS0] 
...
// PTB11 Pin Mapping
//   <o> PTB11  (Alias:A3)  [ADC1_SE15, GPIOB_11, SPI1_SCK] 
...
// PTB12 Pin Mapping
//   <o> PTB12  [GPIOB_12, FTM1_CH0, FTM0_CH4] 
//   <i> Selects which peripheral function is mapped to PTB12 pin
//     <1=> GPIOB_12
//     <3=> FTM1_CH0
//     <4=> FTM0_CH4
//     <1=> Default
...
// PTB13 Pin Mapping
//   <o> PTB13  [GPIOB_13, FTM1_CH1, FTM0_CH5] 
//   <i> Selects which peripheral function is mapped to PTB13 pin
//     <1=> GPIOB_13
//     <3=> FTM1_CH1
//     <4=> FTM0_CH5
//     <1=> Default
...
// PTB23 Pin Mapping
//   <o> PTB23  (Alias:D4)  [GPIOB_23, SPI2_SIN, SPI0_PCS5] 
...
// PTC1 Pin Mapping
//   <o> PTC1  [ADC0_SE15, GPIOC_1, SPI0_PCS3, FTM0_CH0] 
...
// PTC2 Pin Mapping
//   <o> PTC2  (Alias:D6)  [ADC0_SE4b, GPIOC_2, SPI0_PCS2, FTM0_CH1] 
...
// PTC3 Pin Mapping
//   <o> PTC3  (Alias:D7)  [GPIOC_3, SPI0_PCS1, FTM0_CH2] 
...
// PTC4 Pin Mapping
//   <o> PTC4  (Alias:D9)  [GPIOC_4, SPI0_PCS0, FTM0_CH3] 
...
// PTC8 Pin Mapping
//   <o> PTC8  [ADC1_SE4b, GPIOC_8, FTM3_CH4] 
...
// PTC9 Pin Mapping
//   <o> PTC9  [ADC1_SE5b, GPIOC_9, FTM3_CH5] 
...
// PTC10 Pin Mapping
//   <o> PTC10  (Alias:A5)  [ADC1_SE6b, GPIOC_10, I2C1_SCL, FTM3_CH6] 
...
// PTC11 Pin Mapping
//   <o> PTC11  (Alias:A4)  [ADC1_SE7b, GPIOC_11, I2C1_SDA, FTM3_CH7] 
...
// PTC16 Pin Mapping
//   <o> PTC16  (Alias:D0)  [GPIOC_16] <constant>
...
// PTC17 Pin Mapping
//   <o> PTC17  (Alias:D1)  [GPIOC_17] <constant>
...
// PTD0 Pin Mapping
//   <o> PTD0  (Alias:D10)  [GPIOD_0, SPI0_PCS0, FTM3_CH0] 
...
// PTD1 Pin Mapping
//   <o> PTD1  (Alias:D13)  [ADC0_SE5b, GPIOD_1, SPI0_SCK, FTM3_CH1] 
...
// PTD2 Pin Mapping
//   <o> PTD2  (Alias:D11)  [GPIOD_2, SPI0_SOUT, FTM3_CH2, I2C0_SCL] 
...
// PTD3 Pin Mapping
//   <o> PTD3  (Alias:D12)  [GPIOD_3, SPI0_SIN, FTM3_CH3, I2C0_SDA] 
...
// PTD4 Pin Mapping
//   <o> PTD4  (Alias:nRF24L01_cs)  [GPIOD_4, SPI0_PCS1, FTM0_CH4, SPI1_PCS0] 
...
// PTD5 Pin Mapping
//   <o> PTD5  (Alias:nRF24L01_sck)  [ADC0_SE6b, GPIOD_5, SPI0_PCS2, FTM0_CH5, SPI1_SCK] 
...
// PTD6 Pin Mapping
//   <o> PTD6  (Alias:nRF24L01_mosi)  [ADC0_SE7b, GPIOD_6, SPI0_PCS3, FTM0_CH6, SPI1_SOUT] 
...
// PTD7 Pin Mapping
//   <o> PTD7  (Alias:nRF24L01_miso)  [GPIOD_7, FTM0_CH7, SPI1_SIN] 
...
// PTD8 Pin Mapping
//   <o> PTD8  [GPIOD_8, I2C0_SCL] 
//   <i> Selects which peripheral function is mapped to PTD8 pin
//     <1=> GPIOD_8
//     <2=> I2C0_SCL
//     <1=> Default
#define PTD8_SEL             1                   
...
// PTD9 Pin Mapping
//   <o> PTD9  [GPIOD_9, I2C0_SDA] 
//   <i> Selects which peripheral function is mapped to PTD9 pin
//     <1=> GPIOD_9
//     <2=> I2C0_SDA
//     <1=> Default
#define PTD9_SEL             1                   
...
// PTD10 Pin Mapping
//   <o> PTD10  [GPIOD_10] <constant>
//   <i> Selects which peripheral function is mapped to PTD10 pin
//     <1=> GPIOD_10
//     <1=> Default
#define PTD10_SEL            1                   

// PTD11 Pin Mapping
//   <o> PTD11  [GPIOD_11, SPI2_PCS0, SDHC0_CLKIN] 
//   <i> Selects which peripheral function is mapped to PTD11 pin
//     <1=> GPIOD_11
//     <2=> SPI2_PCS0
//     <4=> SDHC0_CLKIN
//     <1=> Default
...
// PTD12 Pin Mapping
//   <o> PTD12  [GPIOD_12, SPI2_SCK, SDHC0_D4] 
//   <i> Selects which peripheral function is mapped to PTD12 pin
//     <1=> GPIOD_12
//     <2=> SPI2_SCK
//     <4=> SDHC0_D4
//     <1=> Default
...
// PTD13 Pin Mapping
//   <o> PTD13  [GPIOD_13, SPI2_SOUT, SDHC0_D5] 
//   <i> Selects which peripheral function is mapped to PTD13 pin
//     <1=> GPIOD_13
//     <2=> SPI2_SOUT
//     <4=> SDHC0_D5
//     <1=> Default
...
// PTD14 Pin Mapping
//   <o> PTD14  [GPIOD_14, SPI2_SIN, SDHC0_D6] 
//   <i> Selects which peripheral function is mapped to PTD14 pin
//     <1=> GPIOD_14
//     <2=> SPI2_SIN
//     <4=> SDHC0_D6
//     <1=> Default
...
// PTD15 Pin Mapping
//   <o> PTD15  [GPIOD_15, SPI2_PCS1, SDHC0_D7] 
//   <i> Selects which peripheral function is mapped to PTD15 pin
//     <1=> GPIOD_15
//     <2=> SPI2_PCS1
//     <4=> SDHC0_D7
//     <1=> Default
...
// PTE0 Pin Mapping
//   <o> PTE0  [ADC1_SE4a, GPIOE_0, SPI1_PCS1, SDHC0_D1, I2C1_SDA] 
...
// PTE1 Pin Mapping
//   <o> PTE1  [ADC1_SE5a, GPIOE_1, SPI1_SOUT, SDHC0_D0, I2C1_SCL, SPI1_SIN] 
...
// PTE2 Pin Mapping
//   <o> PTE2  [ADC0_DP2/ADC1_SE6a, GPIOE_2, SPI1_SCK, SDHC0_DCLK] 
//   <i> Selects which peripheral function is mapped to PTE2 pin
//     <0=> ADC0_DP2/ADC1_SE6a
//     <1=> GPIOE_2
//     <2=> SPI1_SCK
//     <4=> SDHC0_DCLK
//     <0=> Default
...
// PTE3 Pin Mapping
//   <o> PTE3  [ADC0_DM2/ADC1_SE7a, GPIOE_3, SPI1_SIN, SDHC0_CMD, SPI1_SOUT] 
//   <i> Selects which peripheral function is mapped to PTE3 pin
//     <0=> ADC0_DM2/ADC1_SE7a
//     <1=> GPIOE_3
//     <2=> SPI1_SIN
//     <4=> SDHC0_CMD
//     <7=> SPI1_SOUT
...
// PTE4 Pin Mapping
//   <o> PTE4  [GPIOE_4, SPI1_PCS0, SDHC0_D3] 
...
// PTE5 Pin Mapping
//   <o> PTE5  [GPIOE_5, SPI1_PCS2, SDHC0_D2, FTM3_CH0] 
...
// PTE6 Pin Mapping
//   <o> PTE6  [GPIOE_6, SPI1_PCS3, FTM3_CH1] 
...
// PTE8 Pin Mapping
//   <o> PTE8  [GPIOE_8, FTM3_CH3] 
//   <i> Selects which peripheral function is mapped to PTE8 pin
//     <1=> GPIOE_8
//     <6=> FTM3_CH3
//     <1=> Default
#define PTE8_SEL             1                   
...
// PTE9 Pin Mapping
//   <o> PTE9  [GPIOE_9, FTM3_CH4] 
//   <i> Selects which peripheral function is mapped to PTE9 pin
//     <1=> GPIOE_9
//     <6=> FTM3_CH4
//     <1=> Default
#define PTE9_SEL             1                   
...
// PTE10 Pin Mapping
//   <o> PTE10  [GPIOE_10, FTM3_CH5] 
//   <i> Selects which peripheral function is mapped to PTE10 pin
//     <1=> GPIOE_10
//     <6=> FTM3_CH5
//     <1=> Default
#define PTE10_SEL            1                   
...
// PTE11 Pin Mapping
//   <o> PTE11  [GPIOE_11, FTM3_CH6] 
//   <i> Selects which peripheral function is mapped to PTE11 pin
//     <1=> GPIOE_11
//     <6=> FTM3_CH6
//     <1=> Default
#define PTE11_SEL            1                   
...
// PTE12 Pin Mapping
//   <o> PTE12  [GPIOE_12, FTM3_CH7] 
//   <i> Selects which peripheral function is mapped to PTE12 pin
//     <1=> GPIOE_12
//     <6=> FTM3_CH7
//     <1=> Default
#define PTE12_SEL            1                   
...
// PTE24 Pin Mapping
//   <o> PTE24  (Alias:D15)  [ADC0_SE17, GPIOE_24, I2C0_SCL] 
...
// PTE25 Pin Mapping
//   <o> PTE25  (Alias:D14)  [ADC0_SE18, GPIOE_25, I2C0_SDA] 
...
// PTE27 Pin Mapping
//   <o> PTE27  [GPIOE_27] <constant>
//   <i> Selects which peripheral function is mapped to PTE27 pin
//     <1=> GPIOE_27
//     <1=> Default
#define PTE27_SEL            1                   

// PTE28 Pin Mapping
//   <o> PTE28  [GPIOE_28] <constant>
//   <i> Selects which peripheral function is mapped to PTE28 pin
//     <1=> GPIOE_28
//     <1=> Default
#define PTE28_SEL            1                   
