...
//   <o> PTB2 [ADC0_SE12, GPIOB_2, I2C0_SCL, UART0_RTS_b, ENET0_1588_TMR0, FTM0_FLT3]<name=PTB2_SIG_SEL>
...
//   <o> PTB3 [ADC0_SE13, GPIOB_3, I2C0_SDA, UART0_CTS_b/UART0_COL_b, ENET0_1588_TMR1, FTM0_FLT0]<name=PTB3_SIG_SEL>
...
//   <o> PTC16 [GPIOC_16, UART3_RX, ENET0_1588_TMR0, FB_CS5_b/FB_TSIZ1/FB_BE23_16_BLS15_8_b]<name=PTC16_SIG_SEL>
...
//   <o> PTC17 [GPIOC_17, UART3_TX, ENET0_1588_TMR1, FB_CS4_b/FB_TSIZ0/FB_BE31_24_BLS7_0_b]<name=PTC17_SIG_SEL>
...
//   <o> PTD4 [GPIOD_4/LLWU_P14, SPI0_PCS1, UART0_RTS_b, FTM0_CH4, FB_AD2, EWM_IN, SPI1_PCS0]<name=PTD4_SIG_SEL>
...
//   <o> PTD5 [ADC0_SE6b, GPIOD_5, SPI0_PCS2, UART0_CTS_b/UART0_COL_b, FTM0_CH5, FB_AD1, EWM_OUT_b, SPI1_SCK]<name=PTD5_SIG_SEL>
...
//   <o> PTD6 [ADC0_SE7b, GPIOD_6/LLWU_P15, SPI0_PCS3, UART0_RX, FTM0_CH6, FB_AD0, FTM0_FLT0, SPI1_SOUT]<name=PTD6_SIG_SEL>
...
//   <o> PTD7 [GPIOD_7, CMT_IRO, UART0_TX, FTM0_CH7, FTM0_FLT1, SPI1_SIN]<name=PTD7_SIG_SEL>
...
//   <o> PTE24 [ADC0_SE17, GPIOE_24, UART4_TX, I2C0_SCL, EWM_OUT_b]<name=PTE24_SIG_SEL>
...
//   <o> PTE25 [ADC0_SE18, GPIOE_25, UART4_RX, I2C0_SDA, EWM_IN]<name=PTE25_SIG_SEL>
...
//   <o> PTE26 [GPIOE_26, ENET_1588_CLKIN, UART4_CTS_b, RTC_CLKOUT, USB_CLKIN]<name=PTE26_SIG_SEL>
...
constexpr PcrInfo Adc0Info[32] = {
 ...
 /*  2 */  { PORTE_CLOCK_MASK, PORTE_BasePtr+offsetof(PORT_Type,PCR[2]),  GPIOE_BasePtr,  2,  0 },
#else
 /*  2 */  { 0 },
#endif
 /*  3 */  { 0 },
 ...
 /* 10 */  { PORTA_CLOCK_MASK, PORTA_BasePtr+offsetof(PORT_Type,PCR[7]),  GPIOA_BasePtr,  7,  0 },
#else
 /* 10 */  { 0 },
#endif
#if (ADC0_SE11_PIN_SEL == 1)
 /* 11 */  { PORTA_CLOCK_MASK, PORTA_BasePtr+offsetof(PORT_Type,PCR[8]),  GPIOA_BasePtr,  8,  0 },
#else
 /* 11 */  { 0 },
#endif
...
constexpr PcrInfo Adc1Info[32] = {
 ...
 /* 10 */  { PORTB_CLOCK_MASK, PORTB_BasePtr+offsetof(PORT_Type,PCR[4]),  GPIOB_BasePtr,  4,  0 },
#else
 /* 10 */  { 0 },
#endif
#if (ADC1_SE11_PIN_SEL == 1)
 /* 11 */  { PORTB_CLOCK_MASK, PORTB_BasePtr+offsetof(PORT_Type,PCR[5]),  GPIOB_BasePtr,  5,  0 },
#else
 /* 11 */  { 0 },
#endif
...
constexpr PcrInfo Ftm0Info[32] = {
 ...
 /*  3 */  { PORTA_CLOCK_MASK, PORTA_BasePtr+offsetof(PORT_Type,PCR[6]),  GPIOA_BasePtr,  6,  3 },
 ...
 /*  4 */  { PORTA_CLOCK_MASK, PORTA_BasePtr+offsetof(PORT_Type,PCR[7]),  GPIOA_BasePtr,  7,  3 },
#elif (FTM0_CH4_PIN_SEL == 2)
 /*  4 */  { PORTB_CLOCK_MASK, PORTB_BasePtr+offsetof(PORT_Type,PCR[12]), GPIOB_BasePtr,  12, 4 },
 ...
 /*  5 */  { PORTB_CLOCK_MASK, PORTB_BasePtr+offsetof(PORT_Type,PCR[13]), GPIOB_BasePtr,  13, 4 },
...
constexpr PcrInfo Ftm1Info[32] = {
 ...
 /*  0 */  { PORTA_CLOCK_MASK, PORTA_BasePtr+offsetof(PORT_Type,PCR[8]),  GPIOA_BasePtr,  8,  3 },
 ...
 /*  0 */  { PORTB_CLOCK_MASK, PORTB_BasePtr+offsetof(PORT_Type,PCR[12]), GPIOB_BasePtr,  12, 3 },
#else
 /*  0 */  { 0 },
#endif
#if (FTM1_CH1_PIN_SEL == 1)
 /*  1 */  { PORTA_CLOCK_MASK, PORTA_BasePtr+offsetof(PORT_Type,PCR[9]),  GPIOA_BasePtr,  9,  3 },
 ...
 /*  1 */  { PORTB_CLOCK_MASK, PORTB_BasePtr+offsetof(PORT_Type,PCR[13]), GPIOB_BasePtr,  13, 3 },
#else
 /*  1 */  { 0 },
#endif
};
...
constexpr PcrInfo Ftm2Info[32] = {
 ...
 /*  0 */  { PORTA_CLOCK_MASK, PORTA_BasePtr+offsetof(PORT_Type,PCR[10]), GPIOA_BasePtr,  10, 3 },
 ...
 /*  1 */  { PORTA_CLOCK_MASK, PORTA_BasePtr+offsetof(PORT_Type,PCR[11]), GPIOA_BasePtr,  11, 3 },
...
constexpr PcrInfo Spi2Info[32] = {
 ...
 /*  0 */  { PORTB_CLOCK_MASK, PORTB_BasePtr+offsetof(PORT_Type,PCR[21]), GPIOB_BasePtr,  21, 2 },
#elif (SPI2_SCK_PIN_SEL == 2)
 /*  0 */  { PORTD_CLOCK_MASK, PORTD_BasePtr+offsetof(PORT_Type,PCR[12]), GPIOD_BasePtr,  12, 2 },
#else
 /*  0 */  { 0 },
#endif
#if (SPI2_SIN_PIN_SEL == 1)
 /*  1 */  { PORTB_CLOCK_MASK, PORTB_BasePtr+offsetof(PORT_Type,PCR[23]), GPIOB_BasePtr,  23, 2 },
#elif (SPI2_SIN_PIN_SEL == 2)
 /*  1 */  { PORTD_CLOCK_MASK, PORTD_BasePtr+offsetof(PORT_Type,PCR[14]), GPIOD_BasePtr,  14, 2 },
#else
 /*  1 */  { 0 },
#endif
#if (SPI2_SOUT_PIN_SEL == 1)
 /*  2 */  { PORTB_CLOCK_MASK, PORTB_BasePtr+offsetof(PORT_Type,PCR[22]), GPIOB_BasePtr,  22, 2 },
#elif (SPI2_SOUT_PIN_SEL == 2)
 /*  2 */  { PORTD_CLOCK_MASK, PORTD_BasePtr+offsetof(PORT_Type,PCR[13]), GPIOD_BasePtr,  13, 2 },
#else
 /*  2 */  { 0 },
#endif
#if (SPI2_PCS0_PIN_SEL == 1)
 /*  3 */  { PORTB_CLOCK_MASK, PORTB_BasePtr+offsetof(PORT_Type,PCR[20]), GPIOB_BasePtr,  20, 2 },
#elif (SPI2_PCS0_PIN_SEL == 2)
 /*  3 */  { PORTD_CLOCK_MASK, PORTD_BasePtr+offsetof(PORT_Type,PCR[11]), GPIOD_BasePtr,  11, 2 },
#else
 /*  3 */  { 0 },
#endif
#if (SPI2_PCS1_PIN_SEL == 1)
 /*  4 */  { PORTD_CLOCK_MASK, PORTD_BasePtr+offsetof(PORT_Type,PCR[15]), GPIOD_BasePtr,  15, 2 },
#else
 /*  4 */  { 0 },
#endif
};
...
constexpr PcrInfo I2c0Info[32] = {
 ...
 /*  0 */  { PORTD_CLOCK_MASK, PORTD_BasePtr+offsetof(PORT_Type,PCR[8]),  GPIOD_BasePtr,  8,  2 },
 ...
 /*  1 */  { PORTD_CLOCK_MASK, PORTD_BasePtr+offsetof(PORT_Type,PCR[9]),  GPIOD_BasePtr,  9,  2 },
...
constexpr PcrInfo I2c2Info[32] = {
 ...
 /*  0 */  { PORTA_CLOCK_MASK, PORTA_BasePtr+offsetof(PORT_Type,PCR[14]), GPIOA_BasePtr,  14, 5 },
#else
 /*  0 */  { 0 },
#endif
#if (I2C2_SDA_PIN_SEL == 1)
 /*  1 */  { PORTA_CLOCK_MASK, PORTA_BasePtr+offsetof(PORT_Type,PCR[11]), GPIOA_BasePtr,  11, 5 },
