 ...
 * @version   1.2.0
 * @brief     Pin declarations for FRDM_K22F1M0, generated from MK22F12.csv
...
//   <o> PTB3 (Alias:D14) [ADC0_SE13, GPIOB_3, I2C0_SDA, UART0_CTS_b/UART0_COL_b, FTM0_FLT0]<name=PTB3_SIG_SEL>
...
//   <o> PTB16 (Alias:ConRx) [GPIOB_16, SPI1_SOUT, UART0_RX, FTM_CLKIN0, FB_AD17, EWM_IN]<name=PTB16_SIG_SEL>
//   <i> Selects which peripheral signal is mapped to PTB16 pin
//     <-2=> Disabled (reset default)
//     <1=> GPIOB_16<selection=GPIOB_16_PIN_SEL,PTB16 (Alias:ConRx)>
//     <2=> SPI1_SOUT<selection=SPI1_SOUT_PIN_SEL,PTB16 (Alias:ConRx)>
...
//   <o> PTB17 (Alias:ConTx) [GPIOB_17, SPI1_SIN, UART0_TX, FTM_CLKIN1, FB_AD16, EWM_OUT_b]<name=PTB17_SIG_SEL>
//   <i> Selects which peripheral signal is mapped to PTB17 pin
//     <-2=> Disabled (reset default)
//     <1=> GPIOB_17<selection=GPIOB_17_PIN_SEL,PTB17 (Alias:ConTx)>
//     <2=> SPI1_SIN<selection=SPI1_SIN_PIN_SEL,PTB17 (Alias:ConTx)>
...
//   <o> PTD5 (Alias:A3) [ADC0_SE6b, GPIOD_5, SPI0_PCS2, UART0_CTS_b/UART0_COL_b, FTM0_CH5, FB_AD1, EWM_OUT_b]<name=PTD5_SIG_SEL>
...
//   <o> PTE0 (Alias:D1) [ADC1_SE4a, GPIOE_0, SPI1_PCS1, UART1_TX, SDHC0_D1, TRACE_CLKOUT, I2C1_SDA, RTC_CLKOUT]<name=PTE0_SIG_SEL>
...
//     <2=> SPI1_PCS1<selection=SPI1_PCS1_PIN_SEL,PTE0 (Alias:D1)>
//     <3=> UART1_TX<selection=UART1_TX_PIN_SEL,PTE0 (Alias:D1)>
//     <4=> SDHC0_D1<selection=SDHC0_D1_PIN_SEL,PTE0 (Alias:D1)>
...
//   <o> PTE1 (Alias:D0) [ADC1_SE5a, GPIOE_1/LLWU_P0, SPI1_SOUT, UART1_RX, SDHC0_D0, TRACE_D3, I2C1_SCL, SPI1_SIN]<name=PTE1_SIG_SEL>
...
//     <2=> SPI1_SOUT<selection=SPI1_SOUT_PIN_SEL,PTE1 (Alias:D0)>
//     <3=> UART1_RX<selection=UART1_RX_PIN_SEL,PTE1 (Alias:D0)>
//     <4=> SDHC0_D0<selection=SDHC0_D0_PIN_SEL,PTE1 (Alias:D0)>
//     <5=> TRACE_D3<selection=TRACE_D3_PIN_SEL,PTE1 (Alias:D0)>
//     <6=> I2C1_SCL<selection=I2C1_SCL_PIN_SEL,PTE1 (Alias:D0)>
//     <7=> SPI1_SIN<selection=SPI1_SIN_PIN_SEL,PTE1 (Alias:D0)>
//     <1=> Default
...
//     <3=> PTC8 (Alias:D4)<selection=PTC8_SIG_SEL,ADC1_SE4b/CMP0_IN2>
//     <2=> Default
...
//     <3=> PTC9 (Alias:D23)<selection=PTC9_SIG_SEL,ADC1_SE5b/CMP0_IN3>
//     <2=> Default
...
//     <3=> PTC10 (Alias:D25)<selection=PTC10_SIG_SEL,ADC1_SE6b>
//     <2=> Default
...
//     <3=> PTC11 (Alias:D17, ACC_INT1)<selection=PTC11_SIG_SEL,ADC1_SE7b>
//     <2=> Default
...
//     <2=> PTE0 (Alias:D1)<selection=PTE0_SIG_SEL,RTC_CLKOUT>
//     <0=> Default
...
//     <2=> PTC5 (Alias:D18)<selection=PTC5_SIG_SEL,CMP0_OUT>
//     <0=> Default
...
//     <2=> PTC4 (Alias:D7)<selection=PTC4_SIG_SEL,CMP1_OUT>
//     <0=> Default
...
//     <2=> PTD4 (Alias:D3, LED_GREEN)<selection=PTD4_SIG_SEL,FTM0_CH4>
//     <0=> Default
...
//     <3=> PTD5 (Alias:A3)<selection=PTD5_SIG_SEL,FTM0_CH5>
//     <0=> Default
...
//     <2=> PTD7 (Alias:D22)<selection=PTD7_SIG_SEL,FTM0_FLT1>
//     <0=> Default
...
//     <3=> PTA12 (Alias:D8)<selection=PTA12_SIG_SEL,FTM1_QD_PHA>
//     <0=> Default
...
//     <3=> PTA13 (Alias:D24)<selection=PTA13_SIG_SEL,FTM1_QD_PHB>
//     <0=> Default
...
//     <4=> PTD2 (Alias:D11)<selection=PTD2_SIG_SEL,I2C0_SCL>
//     <0=> Default
...
//     <4=> PTD3 (Alias:D12)<selection=PTD3_SIG_SEL,I2C0_SDA>
//     <0=> Default
...
//     <2=> PTA13 (Alias:D24)<selection=PTA13_SIG_SEL,I2C2_SDA>
//     <0=> Default
...
//     <4=> PTC6 (Alias:D19, ACC_INT2)<selection=PTC6_SIG_SEL,I2S0_MCLK>
//     <0=> Default
...
//     <0=> Disabled
//     <1=> PTE1 (Alias:D0)<selection=PTE1_SIG_SEL,SDHC0_D0>
//     <0=> Default
...
//     <0=> Disabled
//     <1=> PTE0 (Alias:D1)<selection=PTE0_SIG_SEL,SDHC0_D1>
//     <0=> Default
...
//     <2=> PTC4 (Alias:D7)<selection=PTC4_SIG_SEL,SPI0_PCS0>
//     <3=> PTD0 (Alias:D16)<selection=PTD0_SIG_SEL,SPI0_PCS0>
//     <0=> Default
...
//     <2=> PTC5 (Alias:D18)<selection=PTC5_SIG_SEL,SPI0_SCK>
...
//     <2=> PTC7 (Alias:D20)<selection=PTC7_SIG_SEL,SPI0_SIN>
...
//     <2=> PTC6 (Alias:D19, ACC_INT2)<selection=PTC6_SIG_SEL,SPI0_SOUT>
...
//     <2=> PTE0 (Alias:D1)<selection=PTE0_SIG_SEL,SPI1_PCS1>
//     <0=> Default
...
//     <0=> Disabled
//     <1=> PTB17 (Alias:ConTx)<selection=PTB17_SIG_SEL,SPI1_SIN>
//     <2=> PTE3<selection=PTE3_SIG_SEL,SPI1_SIN>
//     <3=> PTE1 (Alias:D0)<selection=PTE1_SIG_SEL,SPI1_SIN>
//     <0=> Default
...
//     <0=> Disabled
//     <1=> PTB16 (Alias:ConRx)<selection=PTB16_SIG_SEL,SPI1_SOUT>
//     <2=> PTE1 (Alias:D0)<selection=PTE1_SIG_SEL,SPI1_SOUT>
...
//     <3=> PTB3 (Alias:D14)<selection=PTB3_SIG_SEL,UART0_CTS_b/UART0_COL_b>
//     <4=> PTD5 (Alias:A3)<selection=PTD5_SIG_SEL,UART0_CTS_b/UART0_COL_b>
//     <0=> Default
...
//     <3=> PTB2 (Alias:D15)<selection=PTB2_SIG_SEL,UART0_RTS_b>
//     <4=> PTD4 (Alias:D3, LED_GREEN)<selection=PTD4_SIG_SEL,UART0_RTS_b>
//     <0=> Default
...
//     <3=> PTB16 (Alias:ConRx)<selection=PTB16_SIG_SEL,UART0_RX>
//     <4=> PTD6 (Alias:A2)<selection=PTD6_SIG_SEL,UART0_RX>
//     <3=> Default
...
//     <3=> PTB17 (Alias:ConTx)<selection=PTB17_SIG_SEL,UART0_TX>
//     <4=> PTD7 (Alias:D22)<selection=PTD7_SIG_SEL,UART0_TX>
//     <3=> Default
