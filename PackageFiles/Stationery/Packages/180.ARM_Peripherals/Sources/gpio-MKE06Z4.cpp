...
const DigitalIO digitalIO_PTA4     = {(volatile GPIO_Type*)GPIOA,(1UL<<4)};
...
static const PinInit pinInit[] = {
   ...
   { PORT_PCR_MUX(PTI4_SIG_SEL)|DigitalIO::DEFAULT_PCR, &PORTI->PCR[4]},
#endif
#if defined(PTI5_SIG_SEL) && (PTI5_SIG_SEL>=0)
   { PORT_PCR_MUX(PTI5_SIG_SEL)|DigitalIO::DEFAULT_PCR, &PORTI->PCR[5]},
#endif
#if defined(PTI6_SIG_SEL) && (PTI6_SIG_SEL>=0)
   { PORT_PCR_MUX(PTI6_SIG_SEL)|DigitalIO::DEFAULT_PCR, &PORTI->PCR[6]},
#endif
};
