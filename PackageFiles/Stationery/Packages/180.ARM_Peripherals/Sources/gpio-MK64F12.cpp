...
const AnalogueIO analogueIO_ADC0_SE22      = {{0,                0         }, ADC0,     &ADC0_CLOCK_REG,    ADC0_CLOCK_MASK,    22};
...
#if (PTA7_SIG_SEL == 0)
const AnalogueIO analogueIO_ADC0_SE10      = {{&PORTA->PCR[7],   PORTA_CLOCK_MASK}, ADC0,     &ADC0_CLOCK_REG,    ADC0_CLOCK_MASK,    10};
#endif
#if (PTA8_SIG_SEL == 0)
const AnalogueIO analogueIO_ADC0_SE11      = {{&PORTA->PCR[8],   PORTA_CLOCK_MASK}, ADC0,     &ADC0_CLOCK_REG,    ADC0_CLOCK_MASK,    11};
#endif
#if (PTA17_SIG_SEL == 0)
...
#endif
#if (PTB4_SIG_SEL == 0)
const AnalogueIO analogueIO_ADC1_SE10      = {{&PORTB->PCR[4],   PORTB_CLOCK_MASK}, ADC1,     &ADC1_CLOCK_REG,    ADC1_CLOCK_MASK,    10};
#endif
#if (PTB5_SIG_SEL == 0)
const AnalogueIO analogueIO_ADC1_SE11      = {{&PORTB->PCR[5],   PORTB_CLOCK_MASK}, ADC1,     &ADC1_CLOCK_REG,    ADC1_CLOCK_MASK,    11};
#endif
#if (PTB6_SIG_SEL == 0)
...
#endif
#if (PTE2_SIG_SEL == 0)
const AnalogueIO analogueIO_ADC0_SE2       = {{&PORTE->PCR[2],   PORTE_CLOCK_MASK}, ADC0,     &ADC0_CLOCK_REG,    ADC0_CLOCK_MASK,    2};
#endif
#if (PTE3_SIG_SEL == 0)
...
#endif
#if (PTA6_SIG_SEL == 3)
const PwmIO  pwmIO_FTM0_CH3  = {{&PORTA->PCR[6],   PORTA_CLOCK_MASK},(volatile FTM_Type*)FTM0,   3,    PORT_PCR_MUX(3),&FTM0_CLOCK_REG,    FTM0_CLOCK_MASK, FTM0_SC};
#endif
#if (PTA7_SIG_SEL == 3)
const PwmIO  pwmIO_FTM0_CH4  = {{&PORTA->PCR[7],   PORTA_CLOCK_MASK},(volatile FTM_Type*)FTM0,   4,    PORT_PCR_MUX(3),&FTM0_CLOCK_REG,    FTM0_CLOCK_MASK, FTM0_SC};
#endif
#if (PTA8_SIG_SEL == 3)
const PwmIO  pwmIO_FTM1_CH0  = {{&PORTA->PCR[8],   PORTA_CLOCK_MASK},(volatile FTM_Type*)FTM1,   0,    PORT_PCR_MUX(3),&FTM1_CLOCK_REG,    FTM1_CLOCK_MASK, FTM1_SC};
#endif
#if (PTA9_SIG_SEL == 3)
const PwmIO  pwmIO_FTM1_CH1  = {{&PORTA->PCR[9],   PORTA_CLOCK_MASK},(volatile FTM_Type*)FTM1,   1,    PORT_PCR_MUX(3),&FTM1_CLOCK_REG,    FTM1_CLOCK_MASK, FTM1_SC};
#endif
#if (PTA10_SIG_SEL == 3)
const PwmIO  pwmIO_FTM2_CH0  = {{&PORTA->PCR[10],  PORTA_CLOCK_MASK},(volatile FTM_Type*)FTM2,   0,    PORT_PCR_MUX(3),&FTM2_CLOCK_REG,    FTM2_CLOCK_MASK, FTM2_SC};
#endif
#if (PTA11_SIG_SEL == 3)
const PwmIO  pwmIO_FTM2_CH1  = {{&PORTA->PCR[11],  PORTA_CLOCK_MASK},(volatile FTM_Type*)FTM2,   1,    PORT_PCR_MUX(3),&FTM2_CLOCK_REG,    FTM2_CLOCK_MASK, FTM2_SC};
#endif
#if (PTA12_SIG_SEL == 3)
...
#endif
#if (PTC8_SIG_SEL == 3)
const PwmIO  pwmIO_FTM3_CH4  = {{&PORTC->PCR[8],   PORTC_CLOCK_MASK},(volatile FTM_Type*)FTM3,   4,    PORT_PCR_MUX(3),&FTM3_CLOCK_REG,    FTM3_CLOCK_MASK, FTM3_SC};
#endif
#if (PTC9_SIG_SEL == 3)
const PwmIO  pwmIO_FTM3_CH5  = {{&PORTC->PCR[9],   PORTC_CLOCK_MASK},(volatile FTM_Type*)FTM3,   5,    PORT_PCR_MUX(3),&FTM3_CLOCK_REG,    FTM3_CLOCK_MASK, FTM3_SC};
#endif
#if (PTC10_SIG_SEL == 3)
const PwmIO  pwmIO_FTM3_CH6  = {{&PORTC->PCR[10],  PORTC_CLOCK_MASK},(volatile FTM_Type*)FTM3,   6,    PORT_PCR_MUX(3),&FTM3_CLOCK_REG,    FTM3_CLOCK_MASK, FTM3_SC};
#endif
#if (PTC11_SIG_SEL == 3)
const PwmIO  pwmIO_FTM3_CH7  = {{&PORTC->PCR[11],  PORTC_CLOCK_MASK},(volatile FTM_Type*)FTM3,   7,    PORT_PCR_MUX(3),&FTM3_CLOCK_REG,    FTM3_CLOCK_MASK, FTM3_SC};
#endif
#if (PTD0_SIG_SEL == 4)
const PwmIO  pwmIO_FTM3_CH0  = {{&PORTD->PCR[0],   PORTD_CLOCK_MASK},(volatile FTM_Type*)FTM3,   0,    PORT_PCR_MUX(4),&FTM3_CLOCK_REG,    FTM3_CLOCK_MASK, FTM3_SC};
#endif
#if (PTD1_SIG_SEL == 4)
const PwmIO  pwmIO_FTM3_CH1  = {{&PORTD->PCR[1],   PORTD_CLOCK_MASK},(volatile FTM_Type*)FTM3,   1,    PORT_PCR_MUX(4),&FTM3_CLOCK_REG,    FTM3_CLOCK_MASK, FTM3_SC};
#endif
#if (PTD2_SIG_SEL == 4)
const PwmIO  pwmIO_FTM3_CH2  = {{&PORTD->PCR[2],   PORTD_CLOCK_MASK},(volatile FTM_Type*)FTM3,   2,    PORT_PCR_MUX(4),&FTM3_CLOCK_REG,    FTM3_CLOCK_MASK, FTM3_SC};
#endif
#if (PTD3_SIG_SEL == 4)
const PwmIO  pwmIO_FTM3_CH3  = {{&PORTD->PCR[3],   PORTD_CLOCK_MASK},(volatile FTM_Type*)FTM3,   3,    PORT_PCR_MUX(4),&FTM3_CLOCK_REG,    FTM3_CLOCK_MASK, FTM3_SC};
#endif
#if (PTD4_SIG_SEL == 4)
...
#endif
#if (PTE5_SIG_SEL == 6)
const PwmIO  pwmIO_FTM3_CH0  = {{&PORTE->PCR[5],   PORTE_CLOCK_MASK},(volatile FTM_Type*)FTM3,   0,    PORT_PCR_MUX(6),&FTM3_CLOCK_REG,    FTM3_CLOCK_MASK, FTM3_SC};
#endif
#if (PTE6_SIG_SEL == 6)
const PwmIO  pwmIO_FTM3_CH1  = {{&PORTE->PCR[6],   PORTE_CLOCK_MASK},(volatile FTM_Type*)FTM3,   1,    PORT_PCR_MUX(6),&FTM3_CLOCK_REG,    FTM3_CLOCK_MASK, FTM3_SC};
#endif
#if (PTE7_SIG_SEL == 6)
const PwmIO  pwmIO_FTM3_CH2  = {{&PORTE->PCR[7],   PORTE_CLOCK_MASK},(volatile FTM_Type*)FTM3,   2,    PORT_PCR_MUX(6),&FTM3_CLOCK_REG,    FTM3_CLOCK_MASK, FTM3_SC};
#endif
#if (PTE8_SIG_SEL == 6)
const PwmIO  pwmIO_FTM3_CH3  = {{&PORTE->PCR[8],   PORTE_CLOCK_MASK},(volatile FTM_Type*)FTM3,   3,    PORT_PCR_MUX(6),&FTM3_CLOCK_REG,    FTM3_CLOCK_MASK, FTM3_SC};
#endif
#if (PTE9_SIG_SEL == 6)
const PwmIO  pwmIO_FTM3_CH4  = {{&PORTE->PCR[9],   PORTE_CLOCK_MASK},(volatile FTM_Type*)FTM3,   4,    PORT_PCR_MUX(6),&FTM3_CLOCK_REG,    FTM3_CLOCK_MASK, FTM3_SC};
#endif
#if (PTE10_SIG_SEL == 6)
const PwmIO  pwmIO_FTM3_CH5  = {{&PORTE->PCR[10],  PORTE_CLOCK_MASK},(volatile FTM_Type*)FTM3,   5,    PORT_PCR_MUX(6),&FTM3_CLOCK_REG,    FTM3_CLOCK_MASK, FTM3_SC};
#endif
#if (PTE11_SIG_SEL == 6)
const PwmIO  pwmIO_FTM3_CH6  = {{&PORTE->PCR[11],  PORTE_CLOCK_MASK},(volatile FTM_Type*)FTM3,   6,    PORT_PCR_MUX(6),&FTM3_CLOCK_REG,    FTM3_CLOCK_MASK, FTM3_SC};
#endif
#if (PTE12_SIG_SEL == 6)
const PwmIO  pwmIO_FTM3_CH7  = {{&PORTE->PCR[12],  PORTE_CLOCK_MASK},(volatile FTM_Type*)FTM3,   7,    PORT_PCR_MUX(6),&FTM3_CLOCK_REG,    FTM3_CLOCK_MASK, FTM3_SC};
#endif
...
static const PinInit pinInit[] = {
   ...
   { PORT_PCR_MUX(PTA8_SIG_SEL)|DigitalIO::DEFAULT_PCR, &PORTA->PCR[8]},
#endif
#if defined(PTA9_SIG_SEL) && (PTA9_SIG_SEL>=0)
   { PORT_PCR_MUX(PTA9_SIG_SEL)|DigitalIO::DEFAULT_PCR, &PORTA->PCR[9]},
#endif
#if defined(PTA10_SIG_SEL) && (PTA10_SIG_SEL>=0)
   { PORT_PCR_MUX(PTA10_SIG_SEL)|DigitalIO::DEFAULT_PCR, &PORTA->PCR[10]},
#endif
#if defined(PTA11_SIG_SEL) && (PTA11_SIG_SEL>=0)
   { PORT_PCR_MUX(PTA11_SIG_SEL)|DigitalIO::DEFAULT_PCR, &PORTA->PCR[11]},
#endif
   ...
   { PORT_PCR_MUX(PTA24_SIG_SEL)|DigitalIO::DEFAULT_PCR, &PORTA->PCR[24]},
#endif
#if defined(PTA25_SIG_SEL) && (PTA25_SIG_SEL>=0)
   { PORT_PCR_MUX(PTA25_SIG_SEL)|DigitalIO::DEFAULT_PCR, &PORTA->PCR[25]},
#endif
#if defined(PTA26_SIG_SEL) && (PTA26_SIG_SEL>=0)
   { PORT_PCR_MUX(PTA26_SIG_SEL)|DigitalIO::DEFAULT_PCR, &PORTA->PCR[26]},
#endif
#if defined(PTA27_SIG_SEL) && (PTA27_SIG_SEL>=0)
   { PORT_PCR_MUX(PTA27_SIG_SEL)|DigitalIO::DEFAULT_PCR, &PORTA->PCR[27]},
#endif
#if defined(PTA28_SIG_SEL) && (PTA28_SIG_SEL>=0)
   { PORT_PCR_MUX(PTA28_SIG_SEL)|DigitalIO::DEFAULT_PCR, &PORTA->PCR[28]},
#endif
#if defined(PTA29_SIG_SEL) && (PTA29_SIG_SEL>=0)
   { PORT_PCR_MUX(PTA29_SIG_SEL)|DigitalIO::DEFAULT_PCR, &PORTA->PCR[29]},
#endif
   ...
   { PORT_PCR_MUX(PTB12_SIG_SEL)|DigitalIO::DEFAULT_PCR, &PORTB->PCR[12]},
#endif
#if defined(PTB13_SIG_SEL) && (PTB13_SIG_SEL>=0)
   { PORT_PCR_MUX(PTB13_SIG_SEL)|DigitalIO::DEFAULT_PCR, &PORTB->PCR[13]},
#endif
   ...
   { PORT_PCR_MUX(PTD8_SIG_SEL)|DigitalIO::DEFAULT_PCR, &PORTD->PCR[8]},
#endif
#if defined(PTD9_SIG_SEL) && (PTD9_SIG_SEL>=0)
   { PORT_PCR_MUX(PTD9_SIG_SEL)|DigitalIO::DEFAULT_PCR, &PORTD->PCR[9]},
#endif
#if defined(PTD10_SIG_SEL) && (PTD10_SIG_SEL>=0)
   { PORT_PCR_MUX(PTD10_SIG_SEL)|DigitalIO::DEFAULT_PCR, &PORTD->PCR[10]},
#endif
#if defined(PTD11_SIG_SEL) && (PTD11_SIG_SEL>=0)
   { PORT_PCR_MUX(PTD11_SIG_SEL)|DigitalIO::DEFAULT_PCR, &PORTD->PCR[11]},
#endif
#if defined(PTD12_SIG_SEL) && (PTD12_SIG_SEL>=0)
   { PORT_PCR_MUX(PTD12_SIG_SEL)|DigitalIO::DEFAULT_PCR, &PORTD->PCR[12]},
#endif
#if defined(PTD13_SIG_SEL) && (PTD13_SIG_SEL>=0)
   { PORT_PCR_MUX(PTD13_SIG_SEL)|DigitalIO::DEFAULT_PCR, &PORTD->PCR[13]},
#endif
#if defined(PTD14_SIG_SEL) && (PTD14_SIG_SEL>=0)
   { PORT_PCR_MUX(PTD14_SIG_SEL)|DigitalIO::DEFAULT_PCR, &PORTD->PCR[14]},
#endif
#if defined(PTD15_SIG_SEL) && (PTD15_SIG_SEL>=0)
   { PORT_PCR_MUX(PTD15_SIG_SEL)|DigitalIO::DEFAULT_PCR, &PORTD->PCR[15]},
#endif
   ...
   { PORT_PCR_MUX(PTE8_SIG_SEL)|DigitalIO::DEFAULT_PCR, &PORTE->PCR[8]},
#endif
#if defined(PTE9_SIG_SEL) && (PTE9_SIG_SEL>=0)
   { PORT_PCR_MUX(PTE9_SIG_SEL)|DigitalIO::DEFAULT_PCR, &PORTE->PCR[9]},
#endif
#if defined(PTE10_SIG_SEL) && (PTE10_SIG_SEL>=0)
   { PORT_PCR_MUX(PTE10_SIG_SEL)|DigitalIO::DEFAULT_PCR, &PORTE->PCR[10]},
#endif
#if defined(PTE11_SIG_SEL) && (PTE11_SIG_SEL>=0)
   { PORT_PCR_MUX(PTE11_SIG_SEL)|DigitalIO::DEFAULT_PCR, &PORTE->PCR[11]},
#endif
#if defined(PTE12_SIG_SEL) && (PTE12_SIG_SEL>=0)
   { PORT_PCR_MUX(PTE12_SIG_SEL)|DigitalIO::DEFAULT_PCR, &PORTE->PCR[12]},
#endif
   ...
   { PORT_PCR_MUX(PTE27_SIG_SEL)|DigitalIO::DEFAULT_PCR, &PORTE->PCR[27]},
#endif
#if defined(PTE28_SIG_SEL) && (PTE28_SIG_SEL>=0)
   { PORT_PCR_MUX(PTE28_SIG_SEL)|DigitalIO::DEFAULT_PCR, &PORTE->PCR[28]},
#endif
};
