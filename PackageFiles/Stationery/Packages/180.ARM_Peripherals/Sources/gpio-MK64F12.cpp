...
const USBDM::GpioD<8>     gpioD_8;             //!< See @ref USBDM::DigitalIOT
const USBDM::GpioD<9>     gpioD_9;             //!< See @ref USBDM::DigitalIOT
const USBDM::GpioD<10>    gpioD_10;            //!< See @ref USBDM::DigitalIOT
const USBDM::GpioD<11>    gpioD_11;            //!< See @ref USBDM::DigitalIOT
const USBDM::GpioD<12>    gpioD_12;            //!< See @ref USBDM::DigitalIOT
const USBDM::GpioD<13>    gpioD_13;            //!< See @ref USBDM::DigitalIOT
const USBDM::GpioD<14>    gpioD_14;            //!< See @ref USBDM::DigitalIOT
const USBDM::GpioD<15>    gpioD_15;            //!< See @ref USBDM::DigitalIOT
...
const USBDM::GpioE<8>     gpioE_8;             //!< See @ref USBDM::DigitalIOT
const USBDM::GpioE<9>     gpioE_9;             //!< See @ref USBDM::DigitalIOT
const USBDM::GpioE<10>    gpioE_10;            //!< See @ref USBDM::DigitalIOT
const USBDM::GpioE<11>    gpioE_11;            //!< See @ref USBDM::DigitalIOT
const USBDM::GpioE<12>    gpioE_12;            //!< See @ref USBDM::DigitalIOT
...
const USBDM::GpioE<27>    gpioE_27;            //!< See @ref USBDM::DigitalIOT
const USBDM::GpioE<28>    gpioE_28;            //!< See @ref USBDM::DigitalIOT
