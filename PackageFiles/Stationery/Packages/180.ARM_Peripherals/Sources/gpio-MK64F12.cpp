...
const AnalogueIO analogueIO_ADC0_SE16_1       = {0,                ADC(ADC0_SE16_ADC_NUM_1),&ADC_CLOCK_REG(ADC0_SE16_ADC_NUM_1),ADC_CLOCK_MASK(ADC0_SE16_ADC_NUM_1),ADC0_SE16_ADC_CH_1};
...
const AnalogueIO analogueIO_ADC1_SE16_1       = {0,                ADC(ADC1_SE16_ADC_NUM_1),&ADC_CLOCK_REG(ADC1_SE16_ADC_NUM_1),ADC_CLOCK_MASK(ADC1_SE16_ADC_NUM_1),ADC1_SE16_ADC_CH_1};
...
const AnalogueIO analogueIO_PTE2_1            = {&digitalIO_PTE2,  ADC(PTE2_ADC_NUM_1),&ADC_CLOCK_REG(PTE2_ADC_NUM_1),ADC_CLOCK_MASK(PTE2_ADC_NUM_1),PTE2_ADC_CH_1};
...
const AnalogueIO analogueIO_PTE3_1            = {&digitalIO_PTE3,  ADC(PTE3_ADC_NUM_1),&ADC_CLOCK_REG(PTE3_ADC_NUM_1),ADC_CLOCK_MASK(PTE3_ADC_NUM_1),PTE3_ADC_CH_1};
...
#endif
#if FTM0_CH3_SEL == 1
const PwmIO  pwmIO_PTA6      = {&digitalIO_PTA6,   (volatile FTM_Type*)FTM(PTA6_FTM_NUM),  PTA6_FTM_CH,   PORT_PCR_MUX(PTA6_FTM_FN),  &FTM_CLOCK_REG(PTA6_FTM_NUM),  FTM_CLOCK_MASK(PTA6_FTM_NUM), FTM0_SC};
#endif
#if FTM0_CH4_SEL == 1
const PwmIO  pwmIO_PTA7      = {&digitalIO_PTA7,   (volatile FTM_Type*)FTM(PTA7_FTM_NUM),  PTA7_FTM_CH,   PORT_PCR_MUX(PTA7_FTM_FN),  &FTM_CLOCK_REG(PTA7_FTM_NUM),  FTM_CLOCK_MASK(PTA7_FTM_NUM), FTM0_SC};
#endif
#if FTM1_CH0_SEL == 1
const PwmIO  pwmIO_PTA8      = {&digitalIO_PTA8,   (volatile FTM_Type*)FTM(PTA8_FTM_NUM),  PTA8_FTM_CH,   PORT_PCR_MUX(PTA8_FTM_FN),  &FTM_CLOCK_REG(PTA8_FTM_NUM),  FTM_CLOCK_MASK(PTA8_FTM_NUM), FTM1_SC};
#endif
#if FTM1_CH1_SEL == 1
const PwmIO  pwmIO_PTA9      = {&digitalIO_PTA9,   (volatile FTM_Type*)FTM(PTA9_FTM_NUM),  PTA9_FTM_CH,   PORT_PCR_MUX(PTA9_FTM_FN),  &FTM_CLOCK_REG(PTA9_FTM_NUM),  FTM_CLOCK_MASK(PTA9_FTM_NUM), FTM1_SC};
#endif
#if FTM2_CH0_SEL == 1
const PwmIO  pwmIO_PTA10     = {&digitalIO_PTA10,  (volatile FTM_Type*)FTM(PTA10_FTM_NUM), PTA10_FTM_CH,  PORT_PCR_MUX(PTA10_FTM_FN), &FTM_CLOCK_REG(PTA10_FTM_NUM), FTM_CLOCK_MASK(PTA10_FTM_NUM), FTM2_SC};
#endif
#if FTM2_CH1_SEL == 1
const PwmIO  pwmIO_PTA11     = {&digitalIO_PTA11,  (volatile FTM_Type*)FTM(PTA11_FTM_NUM), PTA11_FTM_CH,  PORT_PCR_MUX(PTA11_FTM_FN), &FTM_CLOCK_REG(PTA11_FTM_NUM), FTM_CLOCK_MASK(PTA11_FTM_NUM), FTM2_SC};
#endif
#if FTM1_CH0_SEL == 2
...
#endif
#if FTM1_CH0_SEL == 4
const PwmIO  pwmIO_PTB12     = {&digitalIO_PTB12,  (volatile FTM_Type*)FTM(PTB12_FTM_NUM), PTB12_FTM_CH,  PORT_PCR_MUX(PTB12_FTM_FN), &FTM_CLOCK_REG(PTB12_FTM_NUM), FTM_CLOCK_MASK(PTB12_FTM_NUM), FTM1_SC};
#endif
#if FTM0_CH4_SEL == 2
const PwmIO  pwmIO_PTB12     = {&digitalIO_PTB12,  (volatile FTM_Type*)FTM(PTB12_FTM_NUM), PTB12_FTM_CH,  PORT_PCR_MUX(PTB12_FTM_FN), &FTM_CLOCK_REG(PTB12_FTM_NUM), FTM_CLOCK_MASK(PTB12_FTM_NUM), FTM0_SC};
#endif
#if FTM1_CH1_SEL == 4
const PwmIO  pwmIO_PTB13     = {&digitalIO_PTB13,  (volatile FTM_Type*)FTM(PTB13_FTM_NUM), PTB13_FTM_CH,  PORT_PCR_MUX(PTB13_FTM_FN), &FTM_CLOCK_REG(PTB13_FTM_NUM), FTM_CLOCK_MASK(PTB13_FTM_NUM), FTM1_SC};
#endif
#if FTM0_CH5_SEL == 2
const PwmIO  pwmIO_PTB13     = {&digitalIO_PTB13,  (volatile FTM_Type*)FTM(PTB13_FTM_NUM), PTB13_FTM_CH,  PORT_PCR_MUX(PTB13_FTM_FN), &FTM_CLOCK_REG(PTB13_FTM_NUM), FTM_CLOCK_MASK(PTB13_FTM_NUM), FTM0_SC};
#endif
#if FTM2_CH0_SEL == 2
...
#endif
#if FTM3_CH4_SEL == 1
const PwmIO  pwmIO_PTC8      = {&digitalIO_PTC8,   (volatile FTM_Type*)FTM(PTC8_FTM_NUM),  PTC8_FTM_CH,   PORT_PCR_MUX(PTC8_FTM_FN),  &FTM_CLOCK_REG(PTC8_FTM_NUM),  FTM_CLOCK_MASK(PTC8_FTM_NUM), FTM3_SC};
#endif
#if FTM3_CH5_SEL == 1
const PwmIO  pwmIO_PTC9      = {&digitalIO_PTC9,   (volatile FTM_Type*)FTM(PTC9_FTM_NUM),  PTC9_FTM_CH,   PORT_PCR_MUX(PTC9_FTM_FN),  &FTM_CLOCK_REG(PTC9_FTM_NUM),  FTM_CLOCK_MASK(PTC9_FTM_NUM), FTM3_SC};
#endif
#if FTM3_CH6_SEL == 1
const PwmIO  pwmIO_PTC10     = {&digitalIO_PTC10,  (volatile FTM_Type*)FTM(PTC10_FTM_NUM), PTC10_FTM_CH,  PORT_PCR_MUX(PTC10_FTM_FN), &FTM_CLOCK_REG(PTC10_FTM_NUM), FTM_CLOCK_MASK(PTC10_FTM_NUM), FTM3_SC};
#endif
#if FTM3_CH7_SEL == 1
const PwmIO  pwmIO_PTC11     = {&digitalIO_PTC11,  (volatile FTM_Type*)FTM(PTC11_FTM_NUM), PTC11_FTM_CH,  PORT_PCR_MUX(PTC11_FTM_FN), &FTM_CLOCK_REG(PTC11_FTM_NUM), FTM_CLOCK_MASK(PTC11_FTM_NUM), FTM3_SC};
#endif
#if FTM3_CH0_SEL == 1
const PwmIO  pwmIO_PTD0      = {&digitalIO_PTD0,   (volatile FTM_Type*)FTM(PTD0_FTM_NUM),  PTD0_FTM_CH,   PORT_PCR_MUX(PTD0_FTM_FN),  &FTM_CLOCK_REG(PTD0_FTM_NUM),  FTM_CLOCK_MASK(PTD0_FTM_NUM), FTM3_SC};
#endif
#if FTM3_CH1_SEL == 1
const PwmIO  pwmIO_PTD1      = {&digitalIO_PTD1,   (volatile FTM_Type*)FTM(PTD1_FTM_NUM),  PTD1_FTM_CH,   PORT_PCR_MUX(PTD1_FTM_FN),  &FTM_CLOCK_REG(PTD1_FTM_NUM),  FTM_CLOCK_MASK(PTD1_FTM_NUM), FTM3_SC};
#endif
#if FTM3_CH2_SEL == 1
const PwmIO  pwmIO_PTD2      = {&digitalIO_PTD2,   (volatile FTM_Type*)FTM(PTD2_FTM_NUM),  PTD2_FTM_CH,   PORT_PCR_MUX(PTD2_FTM_FN),  &FTM_CLOCK_REG(PTD2_FTM_NUM),  FTM_CLOCK_MASK(PTD2_FTM_NUM), FTM3_SC};
#endif
#if FTM3_CH3_SEL == 1
const PwmIO  pwmIO_PTD3      = {&digitalIO_PTD3,   (volatile FTM_Type*)FTM(PTD3_FTM_NUM),  PTD3_FTM_CH,   PORT_PCR_MUX(PTD3_FTM_FN),  &FTM_CLOCK_REG(PTD3_FTM_NUM),  FTM_CLOCK_MASK(PTD3_FTM_NUM), FTM3_SC};
#endif
#if FTM0_CH4_SEL == 3
...
#endif
#if FTM3_CH0_SEL == 2
const PwmIO  pwmIO_PTE5      = {&digitalIO_PTE5,   (volatile FTM_Type*)FTM(PTE5_FTM_NUM),  PTE5_FTM_CH,   PORT_PCR_MUX(PTE5_FTM_FN),  &FTM_CLOCK_REG(PTE5_FTM_NUM),  FTM_CLOCK_MASK(PTE5_FTM_NUM), FTM3_SC};
#endif
#if FTM3_CH1_SEL == 2
const PwmIO  pwmIO_PTE6      = {&digitalIO_PTE6,   (volatile FTM_Type*)FTM(PTE6_FTM_NUM),  PTE6_FTM_CH,   PORT_PCR_MUX(PTE6_FTM_FN),  &FTM_CLOCK_REG(PTE6_FTM_NUM),  FTM_CLOCK_MASK(PTE6_FTM_NUM), FTM3_SC};
#endif
#if FTM3_CH2_SEL == 2
const PwmIO  pwmIO_PTE7      = {&digitalIO_PTE7,   (volatile FTM_Type*)FTM(PTE7_FTM_NUM),  PTE7_FTM_CH,   PORT_PCR_MUX(PTE7_FTM_FN),  &FTM_CLOCK_REG(PTE7_FTM_NUM),  FTM_CLOCK_MASK(PTE7_FTM_NUM), FTM3_SC};
#endif
#if FTM3_CH3_SEL == 2
const PwmIO  pwmIO_PTE8      = {&digitalIO_PTE8,   (volatile FTM_Type*)FTM(PTE8_FTM_NUM),  PTE8_FTM_CH,   PORT_PCR_MUX(PTE8_FTM_FN),  &FTM_CLOCK_REG(PTE8_FTM_NUM),  FTM_CLOCK_MASK(PTE8_FTM_NUM), FTM3_SC};
#endif
#if FTM3_CH4_SEL == 2
const PwmIO  pwmIO_PTE9      = {&digitalIO_PTE9,   (volatile FTM_Type*)FTM(PTE9_FTM_NUM),  PTE9_FTM_CH,   PORT_PCR_MUX(PTE9_FTM_FN),  &FTM_CLOCK_REG(PTE9_FTM_NUM),  FTM_CLOCK_MASK(PTE9_FTM_NUM), FTM3_SC};
#endif
#if FTM3_CH5_SEL == 2
const PwmIO  pwmIO_PTE10     = {&digitalIO_PTE10,  (volatile FTM_Type*)FTM(PTE10_FTM_NUM), PTE10_FTM_CH,  PORT_PCR_MUX(PTE10_FTM_FN), &FTM_CLOCK_REG(PTE10_FTM_NUM), FTM_CLOCK_MASK(PTE10_FTM_NUM), FTM3_SC};
#endif
#if FTM3_CH6_SEL == 2
const PwmIO  pwmIO_PTE11     = {&digitalIO_PTE11,  (volatile FTM_Type*)FTM(PTE11_FTM_NUM), PTE11_FTM_CH,  PORT_PCR_MUX(PTE11_FTM_FN), &FTM_CLOCK_REG(PTE11_FTM_NUM), FTM_CLOCK_MASK(PTE11_FTM_NUM), FTM3_SC};
#endif
#if FTM3_CH7_SEL == 2
const PwmIO  pwmIO_PTE12     = {&digitalIO_PTE12,  (volatile FTM_Type*)FTM(PTE12_FTM_NUM), PTE12_FTM_CH,  PORT_PCR_MUX(PTE12_FTM_FN), &FTM_CLOCK_REG(PTE12_FTM_NUM), FTM_CLOCK_MASK(PTE12_FTM_NUM), FTM3_SC};
#endif
