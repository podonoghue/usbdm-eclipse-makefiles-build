/*****************************************************************
 * @file     Segment_LCD.h (derived from segment_lcd-MKL43Z4.c)
 *
 ...
 * s401 Pin KL43 Pin
 * =========================
 *     1    PTE20  LCD_P59  (COM0)
 *     2    PTE21  LCD_P60  (COM1)
 *     3    PTB18  LCD_P14  (COM2)
 *     4    PTB19  LCD_P15  (COM3)
 *
 *     5    PTC0   LCD_P20  (1D/1E/1G/1F)
 *     6    PTC4   LCD_P24  (DP1/1C/1B/1A)
 *     7    PTC6   LCD_P26  (2D/2E/2G/2F)
 *     8    PTC7   LCD_P27  (DP2/2C/2B/2A)
 *     9    PTD0   LCD_P40  (3D/3E/3G/3F)
 *    10    PTD2   LCD_P42  (DP3/3C/3B/3A)
 *    11    PTD3   LCD_P43  (4D/4E/4G/4F)
 *    12    PTD4   LCD_P44  (COL/4C/4B/4A)
 */
...
void SegLCD_Init(void){
   ...
   LCD->GCR =
       //LCD_GCR_RVEN_MASK |      // Clear LCD_GCR_RVEN, disable voltage regulator.
         ...
         LCD_GCR_ALTDIV(0x00) |   // Set LCD_GCR_ALTDIV to 0, divide alternate clock by 1.  This is assuming an 32kHz External Crystal is used.
