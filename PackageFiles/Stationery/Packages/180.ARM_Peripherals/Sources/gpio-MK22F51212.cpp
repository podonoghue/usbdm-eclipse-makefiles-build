...
const AnalogueIO analogueIO_ADC0_DM0_1        = {0,                ADC(ADC0_DM0_ADC_NUM_1),&ADC_CLOCK_REG(ADC0_DM0_ADC_NUM_1),ADC_CLOCK_MASK(ADC0_DM0_ADC_NUM_1),ADC0_DM0_ADC_CH_1};
const AnalogueIO analogueIO_ADC0_DM1          = {0,                ADC(ADC0_DM1_ADC_NUM),&ADC_CLOCK_REG(ADC0_DM1_ADC_NUM),ADC_CLOCK_MASK(ADC0_DM1_ADC_NUM),ADC0_DM1_ADC_CH};
...
const AnalogueIO analogueIO_ADC0_DP0_1        = {0,                ADC(ADC0_DP0_ADC_NUM_1),&ADC_CLOCK_REG(ADC0_DP0_ADC_NUM_1),ADC_CLOCK_MASK(ADC0_DP0_ADC_NUM_1),ADC0_DP0_ADC_CH_1};
const AnalogueIO analogueIO_ADC0_DP1          = {0,                ADC(ADC0_DP1_ADC_NUM),&ADC_CLOCK_REG(ADC0_DP1_ADC_NUM),ADC_CLOCK_MASK(ADC0_DP1_ADC_NUM),ADC0_DP1_ADC_CH};
...
const AnalogueIO analogueIO_ADC1_DM0          = {0,                ADC(ADC1_DM0_ADC_NUM),&ADC_CLOCK_REG(ADC1_DM0_ADC_NUM),ADC_CLOCK_MASK(ADC1_DM0_ADC_NUM),ADC1_DM0_ADC_CH};
const AnalogueIO analogueIO_ADC1_DM0_1        = {0,                ADC(ADC1_DM0_ADC_NUM_1),&ADC_CLOCK_REG(ADC1_DM0_ADC_NUM_1),ADC_CLOCK_MASK(ADC1_DM0_ADC_NUM_1),ADC1_DM0_ADC_CH_1};
const AnalogueIO analogueIO_ADC1_DM1          = {0,                ADC(ADC1_DM1_ADC_NUM),&ADC_CLOCK_REG(ADC1_DM1_ADC_NUM),ADC_CLOCK_MASK(ADC1_DM1_ADC_NUM),ADC1_DM1_ADC_CH};
const AnalogueIO analogueIO_ADC1_DM1_1        = {0,                ADC(ADC1_DM1_ADC_NUM_1),&ADC_CLOCK_REG(ADC1_DM1_ADC_NUM_1),ADC_CLOCK_MASK(ADC1_DM1_ADC_NUM_1),ADC1_DM1_ADC_CH_1};
const AnalogueIO analogueIO_ADC1_DP0          = {0,                ADC(ADC1_DP0_ADC_NUM),&ADC_CLOCK_REG(ADC1_DP0_ADC_NUM),ADC_CLOCK_MASK(ADC1_DP0_ADC_NUM),ADC1_DP0_ADC_CH};
const AnalogueIO analogueIO_ADC1_DP0_1        = {0,                ADC(ADC1_DP0_ADC_NUM_1),&ADC_CLOCK_REG(ADC1_DP0_ADC_NUM_1),ADC_CLOCK_MASK(ADC1_DP0_ADC_NUM_1),ADC1_DP0_ADC_CH_1};
const AnalogueIO analogueIO_ADC1_DP1          = {0,                ADC(ADC1_DP1_ADC_NUM),&ADC_CLOCK_REG(ADC1_DP1_ADC_NUM),ADC_CLOCK_MASK(ADC1_DP1_ADC_NUM),ADC1_DP1_ADC_CH};
const AnalogueIO analogueIO_ADC1_DP1_1        = {0,                ADC(ADC1_DP1_ADC_NUM_1),&ADC_CLOCK_REG(ADC1_DP1_ADC_NUM_1),ADC_CLOCK_MASK(ADC1_DP1_ADC_NUM_1),ADC1_DP1_ADC_CH_1};
...
const AnalogueIO analogueIO_PTB0_1            = {&digitalIO_PTB0,  ADC(PTB0_ADC_NUM_1),&ADC_CLOCK_REG(PTB0_ADC_NUM_1),ADC_CLOCK_MASK(PTB0_ADC_NUM_1),PTB0_ADC_CH_1};
...
const AnalogueIO analogueIO_PTB1_1            = {&digitalIO_PTB1,  ADC(PTB1_ADC_NUM_1),&ADC_CLOCK_REG(PTB1_ADC_NUM_1),ADC_CLOCK_MASK(PTB1_ADC_NUM_1),PTB1_ADC_CH_1};
...
const AnalogueIO analogueIO_PTE0              = {&digitalIO_PTE0,  ADC(PTE0_ADC_NUM),  &ADC_CLOCK_REG(PTE0_ADC_NUM),  ADC_CLOCK_MASK(PTE0_ADC_NUM),  PTE0_ADC_CH};
const AnalogueIO analogueIO_PTE1              = {&digitalIO_PTE1,  ADC(PTE1_ADC_NUM),  &ADC_CLOCK_REG(PTE1_ADC_NUM),  ADC_CLOCK_MASK(PTE1_ADC_NUM),  PTE1_ADC_CH};
const AnalogueIO analogueIO_PTE2              = {&digitalIO_PTE2,  ADC(PTE2_ADC_NUM),  &ADC_CLOCK_REG(PTE2_ADC_NUM),  ADC_CLOCK_MASK(PTE2_ADC_NUM),  PTE2_ADC_CH};
const AnalogueIO analogueIO_PTE3              = {&digitalIO_PTE3,  ADC(PTE3_ADC_NUM),  &ADC_CLOCK_REG(PTE3_ADC_NUM),  ADC_CLOCK_MASK(PTE3_ADC_NUM),  PTE3_ADC_CH};
...
#endif
const PwmIO  pwmIO_PTB18     = {&digitalIO_PTB18,  (volatile FTM_Type*)FTM(PTB18_FTM_NUM), PTB18_FTM_CH,  PORT_PCR_MUX(PTB18_FTM_FN), &FTM_CLOCK_REG(PTB18_FTM_NUM), FTM_CLOCK_MASK(PTB18_FTM_NUM), FTM2_SC};
const PwmIO  pwmIO_PTB19     = {&digitalIO_PTB19,  (volatile FTM_Type*)FTM(PTB19_FTM_NUM), PTB19_FTM_CH,  PORT_PCR_MUX(PTB19_FTM_FN), &FTM_CLOCK_REG(PTB19_FTM_NUM), FTM_CLOCK_MASK(PTB19_FTM_NUM), FTM2_SC};
#if FTM0_CH0_SEL == 2
...
#if FTM0_CH2_SEL == 3
const PwmIO  pwmIO_PTC5      = {&digitalIO_PTC5,   (volatile FTM_Type*)FTM(PTC5_FTM_NUM),  PTC5_FTM_CH,   PORT_PCR_MUX(PTC5_FTM_FN),  &FTM_CLOCK_REG(PTC5_FTM_NUM),  FTM_CLOCK_MASK(PTC5_FTM_NUM), FTM0_SC};
#endif
