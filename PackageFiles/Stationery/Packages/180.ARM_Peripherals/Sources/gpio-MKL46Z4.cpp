...
#endif
#if (PTE16_SIG_SEL == 0)
const AnalogueIO analogueIO_ADC0_SE1       = {{&PORTE->PCR[16],  PORTE_CLOCK_MASK}, ADC0,     &ADC0_CLOCK_REG,    ADC0_CLOCK_MASK,    1};
#endif
#if (PTE17_SIG_SEL == 0)
const AnalogueIO analogueIO_ADC0_SE5a      = {{&PORTE->PCR[17],  PORTE_CLOCK_MASK}, ADC0,     &ADC0_CLOCK_REG,    ADC0_CLOCK_MASK,    5};
#endif
#if (PTE18_SIG_SEL == 0)
const AnalogueIO analogueIO_ADC0_SE2       = {{&PORTE->PCR[18],  PORTE_CLOCK_MASK}, ADC0,     &ADC0_CLOCK_REG,    ADC0_CLOCK_MASK,    2};
#endif
#if (PTE19_SIG_SEL == 0)
const AnalogueIO analogueIO_ADC0_SE6a      = {{&PORTE->PCR[19],  PORTE_CLOCK_MASK}, ADC0,     &ADC0_CLOCK_REG,    ADC0_CLOCK_MASK,    6};
#endif
#if (PTE20_SIG_SEL == 0)
...
#endif
#if (PTA6_SIG_SEL == 3)
const PwmIO  pwmIO_TPM0_CH3  = {{&PORTA->PCR[6],   PORTA_CLOCK_MASK},(volatile TPM_Type*)TPM0,   3,    PORT_PCR_MUX(3),&TPM0_CLOCK_REG,    TPM0_CLOCK_MASK, TPM0_SC};
#endif
#if (PTA7_SIG_SEL == 3)
const PwmIO  pwmIO_TPM0_CH4  = {{&PORTA->PCR[7],   PORTA_CLOCK_MASK},(volatile TPM_Type*)TPM0,   4,    PORT_PCR_MUX(3),&TPM0_CLOCK_REG,    TPM0_CLOCK_MASK, TPM0_SC};
#endif
#if (PTA12_SIG_SEL == 3)
...
#endif
#if (PTE26_SIG_SEL == 3)
const PwmIO  pwmIO_TPM0_CH5  = {{&PORTE->PCR[26],  PORTE_CLOCK_MASK},(volatile TPM_Type*)TPM0,   5,    PORT_PCR_MUX(3),&TPM0_CLOCK_REG,    TPM0_CLOCK_MASK, TPM0_SC};
#endif
#if (PTE29_SIG_SEL == 3)
...
static const PinInit pinInit[] = {
   ...
   { PORT_PCR_MUX(PTE16_SIG_SEL)|DigitalIO::DEFAULT_PCR, &PORTE->PCR[16]},
#endif
#if defined(PTE17_SIG_SEL) && (PTE17_SIG_SEL>=0)
   { PORT_PCR_MUX(PTE17_SIG_SEL)|DigitalIO::DEFAULT_PCR, &PORTE->PCR[17]},
#endif
#if defined(PTE18_SIG_SEL) && (PTE18_SIG_SEL>=0)
   { PORT_PCR_MUX(PTE18_SIG_SEL)|DigitalIO::DEFAULT_PCR, &PORTE->PCR[18]},
#endif
#if defined(PTE19_SIG_SEL) && (PTE19_SIG_SEL>=0)
   { PORT_PCR_MUX(PTE19_SIG_SEL)|DigitalIO::DEFAULT_PCR, &PORTE->PCR[19]},
#endif
