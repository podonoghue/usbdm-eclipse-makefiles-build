...
const USBDM::PortE_T<16>  digitalIO_PTE16;     //!< See @ref DigitalIO
const USBDM::PortE_T<17>  digitalIO_PTE17;     //!< See @ref DigitalIO
const USBDM::PortE_T<18>  digitalIO_PTE18;     //!< See @ref DigitalIO
const USBDM::PortE_T<19>  digitalIO_PTE19;     //!< See @ref DigitalIO
...
#endif
#if (PTE16_SIG_SEL == 0)
const USBDM::AnalogueIOT<PORTE_CLOCK_MASK, PORTE_BasePtr+offsetof(PORT_Type,PCR[16]), ADC0_BasePtr, SIM_BasePtr+offsetof(SIM_Type, ADC0_CLOCK_REG),ADC0_CLOCK_MASK, 1> analogueIO_ADC0_SE1;
#endif
#if (PTE17_SIG_SEL == 0)
const USBDM::AnalogueIOT<PORTE_CLOCK_MASK, PORTE_BasePtr+offsetof(PORT_Type,PCR[17]), ADC0_BasePtr, SIM_BasePtr+offsetof(SIM_Type, ADC0_CLOCK_REG),ADC0_CLOCK_MASK, 5> analogueIO_ADC0_SE5a;
#endif
#if (PTE18_SIG_SEL == 0)
const USBDM::AnalogueIOT<PORTE_CLOCK_MASK, PORTE_BasePtr+offsetof(PORT_Type,PCR[18]), ADC0_BasePtr, SIM_BasePtr+offsetof(SIM_Type, ADC0_CLOCK_REG),ADC0_CLOCK_MASK, 2> analogueIO_ADC0_SE2;
#endif
#if (PTE19_SIG_SEL == 0)
const USBDM::AnalogueIOT<PORTE_CLOCK_MASK, PORTE_BasePtr+offsetof(PORT_Type,PCR[19]), ADC0_BasePtr, SIM_BasePtr+offsetof(SIM_Type, ADC0_CLOCK_REG),ADC0_CLOCK_MASK, 6> analogueIO_ADC0_SE6a;
#endif
#if (PTE20_SIG_SEL == 0)
