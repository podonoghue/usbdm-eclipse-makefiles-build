...
#define USB0_CLOCK_REG       SIM->SCGC4          
#define USB0_CLOCK_MASK      SIM_SCGC4_USB0_MASK 
...
const DigitalIO digitalIO_PTE16    = {{&PORTE->PCR[16],  PORTE_CLOCK_MASK}, GPIOE,  (1UL<<16)};
const DigitalIO digitalIO_PTE17    = {{&PORTE->PCR[17],  PORTE_CLOCK_MASK}, GPIOE,  (1UL<<17)};
const DigitalIO digitalIO_PTE18    = {{&PORTE->PCR[18],  PORTE_CLOCK_MASK}, GPIOE,  (1UL<<18)};
const DigitalIO digitalIO_PTE19    = {{&PORTE->PCR[19],  PORTE_CLOCK_MASK}, GPIOE,  (1UL<<19)};
...
const AnalogueIO analogueIO_PTE16          = {{&PORTE->PCR[16],  PORTE_CLOCK_MASK}, ADC0,     &ADC0_CLOCK_REG,    ADC0_CLOCK_MASK,    1};
const AnalogueIO analogueIO_PTE16_1        = {{&PORTE->PCR[16],  PORTE_CLOCK_MASK}, ADC0,     &ADC0_CLOCK_REG,    ADC0_CLOCK_MASK,    1};
const AnalogueIO analogueIO_PTE17          = {{&PORTE->PCR[17],  PORTE_CLOCK_MASK}, ADC0,     &ADC0_CLOCK_REG,    ADC0_CLOCK_MASK,    1};
const AnalogueIO analogueIO_PTE17_1        = {{&PORTE->PCR[17],  PORTE_CLOCK_MASK}, ADC0,     &ADC0_CLOCK_REG,    ADC0_CLOCK_MASK,    5};
const AnalogueIO analogueIO_PTE18          = {{&PORTE->PCR[18],  PORTE_CLOCK_MASK}, ADC0,     &ADC0_CLOCK_REG,    ADC0_CLOCK_MASK,    2};
const AnalogueIO analogueIO_PTE18_1        = {{&PORTE->PCR[18],  PORTE_CLOCK_MASK}, ADC0,     &ADC0_CLOCK_REG,    ADC0_CLOCK_MASK,    2};
const AnalogueIO analogueIO_PTE19          = {{&PORTE->PCR[19],  PORTE_CLOCK_MASK}, ADC0,     &ADC0_CLOCK_REG,    ADC0_CLOCK_MASK,    2};
const AnalogueIO analogueIO_PTE19_1        = {{&PORTE->PCR[19],  PORTE_CLOCK_MASK}, ADC0,     &ADC0_CLOCK_REG,    ADC0_CLOCK_MASK,    6};
...
const PwmIO  pwmIO_PTA6      = {{&PORTA->PCR[6],   PORTA_CLOCK_MASK}, (volatile TPM_Type*)TPM0,   3,    3,    &TPM0_CLOCK_REG,    TPM0_CLOCK_MASK, TPM0_SC};
const PwmIO  pwmIO_PTA7      = {{&PORTA->PCR[7],   PORTA_CLOCK_MASK}, (volatile TPM_Type*)TPM0,   4,    3,    &TPM0_CLOCK_REG,    TPM0_CLOCK_MASK, TPM0_SC};
...
const PwmIO  pwmIO_PTE26     = {{&PORTE->PCR[26],  PORTE_CLOCK_MASK}, (volatile TPM_Type*)TPM0,   5,    3,    &TPM0_CLOCK_REG,    TPM0_CLOCK_MASK, TPM0_SC};
