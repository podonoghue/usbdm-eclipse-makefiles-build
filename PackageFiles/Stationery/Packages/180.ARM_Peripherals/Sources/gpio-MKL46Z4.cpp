...
const AnalogueIO analogueIO_PTE16_1           = {&digitalIO_PTE16, ADC(PTE16_ADC_NUM_1),&ADC_CLOCK_REG(PTE16_ADC_NUM_1),ADC_CLOCK_MASK(PTE16_ADC_NUM_1),PTE16_ADC_CH_1};
const AnalogueIO analogueIO_PTE17             = {&digitalIO_PTE17, ADC(PTE17_ADC_NUM), &ADC_CLOCK_REG(PTE17_ADC_NUM), ADC_CLOCK_MASK(PTE17_ADC_NUM), PTE17_ADC_CH};
const AnalogueIO analogueIO_PTE17_1           = {&digitalIO_PTE17, ADC(PTE17_ADC_NUM_1),&ADC_CLOCK_REG(PTE17_ADC_NUM_1),ADC_CLOCK_MASK(PTE17_ADC_NUM_1),PTE17_ADC_CH_1};
...
const AnalogueIO analogueIO_PTE18_1           = {&digitalIO_PTE18, ADC(PTE18_ADC_NUM_1),&ADC_CLOCK_REG(PTE18_ADC_NUM_1),ADC_CLOCK_MASK(PTE18_ADC_NUM_1),PTE18_ADC_CH_1};
const AnalogueIO analogueIO_PTE19             = {&digitalIO_PTE19, ADC(PTE19_ADC_NUM), &ADC_CLOCK_REG(PTE19_ADC_NUM), ADC_CLOCK_MASK(PTE19_ADC_NUM), PTE19_ADC_CH};
const AnalogueIO analogueIO_PTE19_1           = {&digitalIO_PTE19, ADC(PTE19_ADC_NUM_1),&ADC_CLOCK_REG(PTE19_ADC_NUM_1),ADC_CLOCK_MASK(PTE19_ADC_NUM_1),PTE19_ADC_CH_1};
...
const AnalogueIO analogueIO_PTE20_1           = {&digitalIO_PTE20, ADC(PTE20_ADC_NUM_1),&ADC_CLOCK_REG(PTE20_ADC_NUM_1),ADC_CLOCK_MASK(PTE20_ADC_NUM_1),PTE20_ADC_CH_1};
const AnalogueIO analogueIO_PTE21             = {&digitalIO_PTE21, ADC(PTE21_ADC_NUM), &ADC_CLOCK_REG(PTE21_ADC_NUM), ADC_CLOCK_MASK(PTE21_ADC_NUM), PTE21_ADC_CH};
const AnalogueIO analogueIO_PTE21_1           = {&digitalIO_PTE21, ADC(PTE21_ADC_NUM_1),&ADC_CLOCK_REG(PTE21_ADC_NUM_1),ADC_CLOCK_MASK(PTE21_ADC_NUM_1),PTE21_ADC_CH_1};
...
const AnalogueIO analogueIO_PTE22_1           = {&digitalIO_PTE22, ADC(PTE22_ADC_NUM_1),&ADC_CLOCK_REG(PTE22_ADC_NUM_1),ADC_CLOCK_MASK(PTE22_ADC_NUM_1),PTE22_ADC_CH_1};
const AnalogueIO analogueIO_PTE23             = {&digitalIO_PTE23, ADC(PTE23_ADC_NUM), &ADC_CLOCK_REG(PTE23_ADC_NUM), ADC_CLOCK_MASK(PTE23_ADC_NUM), PTE23_ADC_CH};
const AnalogueIO analogueIO_PTE23_1           = {&digitalIO_PTE23, ADC(PTE23_ADC_NUM_1),&ADC_CLOCK_REG(PTE23_ADC_NUM_1),ADC_CLOCK_MASK(PTE23_ADC_NUM_1),PTE23_ADC_CH_1};
...
#if TPM0_CH5_SEL == 1
const PwmIO  pwmIO_PTA0      = {&digitalIO_PTA0,   (volatile TPM_Type*)TPM(PTA0_TPM_NUM),  PTA0_TPM_CH,   PORT_PCR_MUX(PTA0_TPM_FN),  &TPM_CLOCK_REG(PTA0_TPM_NUM),  TPM_CLOCK_MASK(PTA0_TPM_NUM), TPM0_SC};
#endif
#if TPM2_CH0_SEL == 1
const PwmIO  pwmIO_PTA1      = {&digitalIO_PTA1,   (volatile TPM_Type*)TPM(PTA1_TPM_NUM),  PTA1_TPM_CH,   PORT_PCR_MUX(PTA1_TPM_FN),  &TPM_CLOCK_REG(PTA1_TPM_NUM),  TPM_CLOCK_MASK(PTA1_TPM_NUM), TPM2_SC};
#endif
#if TPM2_CH1_SEL == 1
const PwmIO  pwmIO_PTA2      = {&digitalIO_PTA2,   (volatile TPM_Type*)TPM(PTA2_TPM_NUM),  PTA2_TPM_CH,   PORT_PCR_MUX(PTA2_TPM_FN),  &TPM_CLOCK_REG(PTA2_TPM_NUM),  TPM_CLOCK_MASK(PTA2_TPM_NUM), TPM2_SC};
#endif
#if TPM0_CH0_SEL == 1
const PwmIO  pwmIO_PTA3      = {&digitalIO_PTA3,   (volatile TPM_Type*)TPM(PTA3_TPM_NUM),  PTA3_TPM_CH,   PORT_PCR_MUX(PTA3_TPM_FN),  &TPM_CLOCK_REG(PTA3_TPM_NUM),  TPM_CLOCK_MASK(PTA3_TPM_NUM), TPM0_SC};
#endif
#if TPM0_CH1_SEL == 1
const PwmIO  pwmIO_PTA4      = {&digitalIO_PTA4,   (volatile TPM_Type*)TPM(PTA4_TPM_NUM),  PTA4_TPM_CH,   PORT_PCR_MUX(PTA4_TPM_FN),  &TPM_CLOCK_REG(PTA4_TPM_NUM),  TPM_CLOCK_MASK(PTA4_TPM_NUM), TPM0_SC};
#endif
#if TPM0_CH2_SEL == 1
const PwmIO  pwmIO_PTA5      = {&digitalIO_PTA5,   (volatile TPM_Type*)TPM(PTA5_TPM_NUM),  PTA5_TPM_CH,   PORT_PCR_MUX(PTA5_TPM_FN),  &TPM_CLOCK_REG(PTA5_TPM_NUM),  TPM_CLOCK_MASK(PTA5_TPM_NUM), TPM0_SC};
#endif
#if TPM0_CH3_SEL == 1
const PwmIO  pwmIO_PTA6      = {&digitalIO_PTA6,   (volatile TPM_Type*)TPM(PTA6_TPM_NUM),  PTA6_TPM_CH,   PORT_PCR_MUX(PTA6_TPM_FN),  &TPM_CLOCK_REG(PTA6_TPM_NUM),  TPM_CLOCK_MASK(PTA6_TPM_NUM), TPM0_SC};
#endif
#if TPM0_CH4_SEL == 1
const PwmIO  pwmIO_PTA7      = {&digitalIO_PTA7,   (volatile TPM_Type*)TPM(PTA7_TPM_NUM),  PTA7_TPM_CH,   PORT_PCR_MUX(PTA7_TPM_FN),  &TPM_CLOCK_REG(PTA7_TPM_NUM),  TPM_CLOCK_MASK(PTA7_TPM_NUM), TPM0_SC};
#endif
#if TPM1_CH0_SEL == 1
const PwmIO  pwmIO_PTA12     = {&digitalIO_PTA12,  (volatile TPM_Type*)TPM(PTA12_TPM_NUM), PTA12_TPM_CH,  PORT_PCR_MUX(PTA12_TPM_FN), &TPM_CLOCK_REG(PTA12_TPM_NUM), TPM_CLOCK_MASK(PTA12_TPM_NUM), TPM1_SC};
#endif
#if TPM1_CH1_SEL == 1
const PwmIO  pwmIO_PTA13     = {&digitalIO_PTA13,  (volatile TPM_Type*)TPM(PTA13_TPM_NUM), PTA13_TPM_CH,  PORT_PCR_MUX(PTA13_TPM_FN), &TPM_CLOCK_REG(PTA13_TPM_NUM), TPM_CLOCK_MASK(PTA13_TPM_NUM), TPM1_SC};
#endif
#if TPM1_CH0_SEL == 2
const PwmIO  pwmIO_PTB0      = {&digitalIO_PTB0,   (volatile TPM_Type*)TPM(PTB0_TPM_NUM),  PTB0_TPM_CH,   PORT_PCR_MUX(PTB0_TPM_FN),  &TPM_CLOCK_REG(PTB0_TPM_NUM),  TPM_CLOCK_MASK(PTB0_TPM_NUM), TPM1_SC};
#endif
#if TPM1_CH1_SEL == 2
const PwmIO  pwmIO_PTB1      = {&digitalIO_PTB1,   (volatile TPM_Type*)TPM(PTB1_TPM_NUM),  PTB1_TPM_CH,   PORT_PCR_MUX(PTB1_TPM_FN),  &TPM_CLOCK_REG(PTB1_TPM_NUM),  TPM_CLOCK_MASK(PTB1_TPM_NUM), TPM1_SC};
#endif
#if TPM2_CH0_SEL == 2
const PwmIO  pwmIO_PTB2      = {&digitalIO_PTB2,   (volatile TPM_Type*)TPM(PTB2_TPM_NUM),  PTB2_TPM_CH,   PORT_PCR_MUX(PTB2_TPM_FN),  &TPM_CLOCK_REG(PTB2_TPM_NUM),  TPM_CLOCK_MASK(PTB2_TPM_NUM), TPM2_SC};
#endif
#if TPM2_CH1_SEL == 2
const PwmIO  pwmIO_PTB3      = {&digitalIO_PTB3,   (volatile TPM_Type*)TPM(PTB3_TPM_NUM),  PTB3_TPM_CH,   PORT_PCR_MUX(PTB3_TPM_FN),  &TPM_CLOCK_REG(PTB3_TPM_NUM),  TPM_CLOCK_MASK(PTB3_TPM_NUM), TPM2_SC};
#endif
#if TPM2_CH0_SEL == 3
const PwmIO  pwmIO_PTB18     = {&digitalIO_PTB18,  (volatile TPM_Type*)TPM(PTB18_TPM_NUM), PTB18_TPM_CH,  PORT_PCR_MUX(PTB18_TPM_FN), &TPM_CLOCK_REG(PTB18_TPM_NUM), TPM_CLOCK_MASK(PTB18_TPM_NUM), TPM2_SC};
#endif
#if TPM2_CH1_SEL == 3
const PwmIO  pwmIO_PTB19     = {&digitalIO_PTB19,  (volatile TPM_Type*)TPM(PTB19_TPM_NUM), PTB19_TPM_CH,  PORT_PCR_MUX(PTB19_TPM_FN), &TPM_CLOCK_REG(PTB19_TPM_NUM), TPM_CLOCK_MASK(PTB19_TPM_NUM), TPM2_SC};
#endif
#if TPM0_CH0_SEL == 2
const PwmIO  pwmIO_PTC1      = {&digitalIO_PTC1,   (volatile TPM_Type*)TPM(PTC1_TPM_NUM),  PTC1_TPM_CH,   PORT_PCR_MUX(PTC1_TPM_FN),  &TPM_CLOCK_REG(PTC1_TPM_NUM),  TPM_CLOCK_MASK(PTC1_TPM_NUM), TPM0_SC};
#endif
#if TPM0_CH1_SEL == 2
const PwmIO  pwmIO_PTC2      = {&digitalIO_PTC2,   (volatile TPM_Type*)TPM(PTC2_TPM_NUM),  PTC2_TPM_CH,   PORT_PCR_MUX(PTC2_TPM_FN),  &TPM_CLOCK_REG(PTC2_TPM_NUM),  TPM_CLOCK_MASK(PTC2_TPM_NUM), TPM0_SC};
#endif
#if TPM0_CH2_SEL == 2
const PwmIO  pwmIO_PTC3      = {&digitalIO_PTC3,   (volatile TPM_Type*)TPM(PTC3_TPM_NUM),  PTC3_TPM_CH,   PORT_PCR_MUX(PTC3_TPM_FN),  &TPM_CLOCK_REG(PTC3_TPM_NUM),  TPM_CLOCK_MASK(PTC3_TPM_NUM), TPM0_SC};
#endif
#if TPM0_CH3_SEL == 2
const PwmIO  pwmIO_PTC4      = {&digitalIO_PTC4,   (volatile TPM_Type*)TPM(PTC4_TPM_NUM),  PTC4_TPM_CH,   PORT_PCR_MUX(PTC4_TPM_FN),  &TPM_CLOCK_REG(PTC4_TPM_NUM),  TPM_CLOCK_MASK(PTC4_TPM_NUM), TPM0_SC};
#endif
#if TPM0_CH4_SEL == 2
const PwmIO  pwmIO_PTC8      = {&digitalIO_PTC8,   (volatile TPM_Type*)TPM(PTC8_TPM_NUM),  PTC8_TPM_CH,   PORT_PCR_MUX(PTC8_TPM_FN),  &TPM_CLOCK_REG(PTC8_TPM_NUM),  TPM_CLOCK_MASK(PTC8_TPM_NUM), TPM0_SC};
#endif
#if TPM0_CH5_SEL == 2
const PwmIO  pwmIO_PTC9      = {&digitalIO_PTC9,   (volatile TPM_Type*)TPM(PTC9_TPM_NUM),  PTC9_TPM_CH,   PORT_PCR_MUX(PTC9_TPM_FN),  &TPM_CLOCK_REG(PTC9_TPM_NUM),  TPM_CLOCK_MASK(PTC9_TPM_NUM), TPM0_SC};
#endif
#if TPM0_CH0_SEL == 3
const PwmIO  pwmIO_PTD0      = {&digitalIO_PTD0,   (volatile TPM_Type*)TPM(PTD0_TPM_NUM),  PTD0_TPM_CH,   PORT_PCR_MUX(PTD0_TPM_FN),  &TPM_CLOCK_REG(PTD0_TPM_NUM),  TPM_CLOCK_MASK(PTD0_TPM_NUM), TPM0_SC};
#endif
#if TPM0_CH1_SEL == 3
const PwmIO  pwmIO_PTD1      = {&digitalIO_PTD1,   (volatile TPM_Type*)TPM(PTD1_TPM_NUM),  PTD1_TPM_CH,   PORT_PCR_MUX(PTD1_TPM_FN),  &TPM_CLOCK_REG(PTD1_TPM_NUM),  TPM_CLOCK_MASK(PTD1_TPM_NUM), TPM0_SC};
#endif
#if TPM0_CH2_SEL == 3
const PwmIO  pwmIO_PTD2      = {&digitalIO_PTD2,   (volatile TPM_Type*)TPM(PTD2_TPM_NUM),  PTD2_TPM_CH,   PORT_PCR_MUX(PTD2_TPM_FN),  &TPM_CLOCK_REG(PTD2_TPM_NUM),  TPM_CLOCK_MASK(PTD2_TPM_NUM), TPM0_SC};
#endif
#if TPM0_CH3_SEL == 3
const PwmIO  pwmIO_PTD3      = {&digitalIO_PTD3,   (volatile TPM_Type*)TPM(PTD3_TPM_NUM),  PTD3_TPM_CH,   PORT_PCR_MUX(PTD3_TPM_FN),  &TPM_CLOCK_REG(PTD3_TPM_NUM),  TPM_CLOCK_MASK(PTD3_TPM_NUM), TPM0_SC};
#endif
#if TPM0_CH4_SEL == 3
const PwmIO  pwmIO_PTD4      = {&digitalIO_PTD4,   (volatile TPM_Type*)TPM(PTD4_TPM_NUM),  PTD4_TPM_CH,   PORT_PCR_MUX(PTD4_TPM_FN),  &TPM_CLOCK_REG(PTD4_TPM_NUM),  TPM_CLOCK_MASK(PTD4_TPM_NUM), TPM0_SC};
#endif
#if TPM0_CH5_SEL == 3
const PwmIO  pwmIO_PTD5      = {&digitalIO_PTD5,   (volatile TPM_Type*)TPM(PTD5_TPM_NUM),  PTD5_TPM_CH,   PORT_PCR_MUX(PTD5_TPM_FN),  &TPM_CLOCK_REG(PTD5_TPM_NUM),  TPM_CLOCK_MASK(PTD5_TPM_NUM), TPM0_SC};
#endif
#if TPM1_CH0_SEL == 3
const PwmIO  pwmIO_PTE20     = {&digitalIO_PTE20,  (volatile TPM_Type*)TPM(PTE20_TPM_NUM), PTE20_TPM_CH,  PORT_PCR_MUX(PTE20_TPM_FN), &TPM_CLOCK_REG(PTE20_TPM_NUM), TPM_CLOCK_MASK(PTE20_TPM_NUM), TPM1_SC};
#endif
#if TPM1_CH1_SEL == 3
const PwmIO  pwmIO_PTE21     = {&digitalIO_PTE21,  (volatile TPM_Type*)TPM(PTE21_TPM_NUM), PTE21_TPM_CH,  PORT_PCR_MUX(PTE21_TPM_FN), &TPM_CLOCK_REG(PTE21_TPM_NUM), TPM_CLOCK_MASK(PTE21_TPM_NUM), TPM1_SC};
#endif
#if TPM2_CH0_SEL == 4
const PwmIO  pwmIO_PTE22     = {&digitalIO_PTE22,  (volatile TPM_Type*)TPM(PTE22_TPM_NUM), PTE22_TPM_CH,  PORT_PCR_MUX(PTE22_TPM_FN), &TPM_CLOCK_REG(PTE22_TPM_NUM), TPM_CLOCK_MASK(PTE22_TPM_NUM), TPM2_SC};
#endif
#if TPM2_CH1_SEL == 4
const PwmIO  pwmIO_PTE23     = {&digitalIO_PTE23,  (volatile TPM_Type*)TPM(PTE23_TPM_NUM), PTE23_TPM_CH,  PORT_PCR_MUX(PTE23_TPM_FN), &TPM_CLOCK_REG(PTE23_TPM_NUM), TPM_CLOCK_MASK(PTE23_TPM_NUM), TPM2_SC};
#endif
#if TPM0_CH0_SEL == 4
const PwmIO  pwmIO_PTE24     = {&digitalIO_PTE24,  (volatile TPM_Type*)TPM(PTE24_TPM_NUM), PTE24_TPM_CH,  PORT_PCR_MUX(PTE24_TPM_FN), &TPM_CLOCK_REG(PTE24_TPM_NUM), TPM_CLOCK_MASK(PTE24_TPM_NUM), TPM0_SC};
#endif
#if TPM0_CH1_SEL == 4
const PwmIO  pwmIO_PTE25     = {&digitalIO_PTE25,  (volatile TPM_Type*)TPM(PTE25_TPM_NUM), PTE25_TPM_CH,  PORT_PCR_MUX(PTE25_TPM_FN), &TPM_CLOCK_REG(PTE25_TPM_NUM), TPM_CLOCK_MASK(PTE25_TPM_NUM), TPM0_SC};
#endif
#if TPM0_CH5_SEL == 4
const PwmIO  pwmIO_PTE26     = {&digitalIO_PTE26,  (volatile TPM_Type*)TPM(PTE26_TPM_NUM), PTE26_TPM_CH,  PORT_PCR_MUX(PTE26_TPM_FN), &TPM_CLOCK_REG(PTE26_TPM_NUM), TPM_CLOCK_MASK(PTE26_TPM_NUM), TPM0_SC};
#endif
#if TPM0_CH2_SEL == 4
const PwmIO  pwmIO_PTE29     = {&digitalIO_PTE29,  (volatile TPM_Type*)TPM(PTE29_TPM_NUM), PTE29_TPM_CH,  PORT_PCR_MUX(PTE29_TPM_FN), &TPM_CLOCK_REG(PTE29_TPM_NUM), TPM_CLOCK_MASK(PTE29_TPM_NUM), TPM0_SC};
#endif
#if TPM0_CH3_SEL == 4
const PwmIO  pwmIO_PTE30     = {&digitalIO_PTE30,  (volatile TPM_Type*)TPM(PTE30_TPM_NUM), PTE30_TPM_CH,  PORT_PCR_MUX(PTE30_TPM_FN), &TPM_CLOCK_REG(PTE30_TPM_NUM), TPM_CLOCK_MASK(PTE30_TPM_NUM), TPM0_SC};
#endif
#if TPM0_CH4_SEL == 4
const PwmIO  pwmIO_PTE31     = {&digitalIO_PTE31,  (volatile TPM_Type*)TPM(PTE31_TPM_NUM), PTE31_TPM_CH,  PORT_PCR_MUX(PTE31_TPM_FN), &TPM_CLOCK_REG(PTE31_TPM_NUM), TPM_CLOCK_MASK(PTE31_TPM_NUM), TPM0_SC};
#endif
