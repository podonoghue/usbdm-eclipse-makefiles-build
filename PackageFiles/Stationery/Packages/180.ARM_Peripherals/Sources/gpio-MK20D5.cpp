...
const PwmIO  pwmIO_PTA0      = {{&PORTA->PCR[0],   PORTA_CLOCK_MASK},(volatile FTM_Type*)FTM0,   5,    PORT_PCR_MUX(3),&FTM0_CLOCK_REG,    FTM0_CLOCK_MASK, FTM0_SC};
const PwmIO  pwmIO_PTA1      = {{&PORTA->PCR[1],   PORTA_CLOCK_MASK},(volatile FTM_Type*)FTM0,   6,    PORT_PCR_MUX(3),&FTM0_CLOCK_REG,    FTM0_CLOCK_MASK, FTM0_SC};
const PwmIO  pwmIO_PTA2      = {{&PORTA->PCR[2],   PORTA_CLOCK_MASK},(volatile FTM_Type*)FTM0,   7,    PORT_PCR_MUX(3),&FTM0_CLOCK_REG,    FTM0_CLOCK_MASK, FTM0_SC};
const PwmIO  pwmIO_PTA3      = {{&PORTA->PCR[3],   PORTA_CLOCK_MASK},(volatile FTM_Type*)FTM0,   0,    PORT_PCR_MUX(3),&FTM0_CLOCK_REG,    FTM0_CLOCK_MASK, FTM0_SC};
const PwmIO  pwmIO_PTA4      = {{&PORTA->PCR[4],   PORTA_CLOCK_MASK},(volatile FTM_Type*)FTM0,   1,    PORT_PCR_MUX(3),&FTM0_CLOCK_REG,    FTM0_CLOCK_MASK, FTM0_SC};
const PwmIO  pwmIO_PTA5      = {{&PORTA->PCR[5],   PORTA_CLOCK_MASK},(volatile FTM_Type*)FTM0,   2,    PORT_PCR_MUX(3),&FTM0_CLOCK_REG,    FTM0_CLOCK_MASK, FTM0_SC};
const PwmIO  pwmIO_PTA12     = {{&PORTA->PCR[12],  PORTA_CLOCK_MASK},(volatile FTM_Type*)FTM1,   0,    PORT_PCR_MUX(3),&FTM1_CLOCK_REG,    FTM1_CLOCK_MASK, FTM1_SC};
const PwmIO  pwmIO_PTA13     = {{&PORTA->PCR[13],  PORTA_CLOCK_MASK},(volatile FTM_Type*)FTM1,   1,    PORT_PCR_MUX(3),&FTM1_CLOCK_REG,    FTM1_CLOCK_MASK, FTM1_SC};
const PwmIO  pwmIO_PTB0      = {{&PORTB->PCR[0],   PORTB_CLOCK_MASK},(volatile FTM_Type*)FTM1,   0,    PORT_PCR_MUX(3),&FTM1_CLOCK_REG,    FTM1_CLOCK_MASK, FTM1_SC};
const PwmIO  pwmIO_PTB1      = {{&PORTB->PCR[1],   PORTB_CLOCK_MASK},(volatile FTM_Type*)FTM1,   1,    PORT_PCR_MUX(3),&FTM1_CLOCK_REG,    FTM1_CLOCK_MASK, FTM1_SC};
const PwmIO  pwmIO_PTC1      = {{&PORTC->PCR[1],   PORTC_CLOCK_MASK},(volatile FTM_Type*)FTM0,   0,    PORT_PCR_MUX(4),&FTM0_CLOCK_REG,    FTM0_CLOCK_MASK, FTM0_SC};
const PwmIO  pwmIO_PTC2      = {{&PORTC->PCR[2],   PORTC_CLOCK_MASK},(volatile FTM_Type*)FTM0,   1,    PORT_PCR_MUX(4),&FTM0_CLOCK_REG,    FTM0_CLOCK_MASK, FTM0_SC};
const PwmIO  pwmIO_PTC3      = {{&PORTC->PCR[3],   PORTC_CLOCK_MASK},(volatile FTM_Type*)FTM0,   2,    PORT_PCR_MUX(4),&FTM0_CLOCK_REG,    FTM0_CLOCK_MASK, FTM0_SC};
const PwmIO  pwmIO_PTC4      = {{&PORTC->PCR[4],   PORTC_CLOCK_MASK},(volatile FTM_Type*)FTM0,   3,    PORT_PCR_MUX(4),&FTM0_CLOCK_REG,    FTM0_CLOCK_MASK, FTM0_SC};
const PwmIO  pwmIO_PTD4      = {{&PORTD->PCR[4],   PORTD_CLOCK_MASK},(volatile FTM_Type*)FTM0,   4,    PORT_PCR_MUX(4),&FTM0_CLOCK_REG,    FTM0_CLOCK_MASK, FTM0_SC};
const PwmIO  pwmIO_PTD5      = {{&PORTD->PCR[5],   PORTD_CLOCK_MASK},(volatile FTM_Type*)FTM0,   5,    PORT_PCR_MUX(4),&FTM0_CLOCK_REG,    FTM0_CLOCK_MASK, FTM0_SC};
const PwmIO  pwmIO_PTD6      = {{&PORTD->PCR[6],   PORTD_CLOCK_MASK},(volatile FTM_Type*)FTM0,   6,    PORT_PCR_MUX(4),&FTM0_CLOCK_REG,    FTM0_CLOCK_MASK, FTM0_SC};
const PwmIO  pwmIO_PTD7      = {{&PORTD->PCR[7],   PORTD_CLOCK_MASK},(volatile FTM_Type*)FTM0,   7,    PORT_PCR_MUX(4),&FTM0_CLOCK_REG,    FTM0_CLOCK_MASK, FTM0_SC};
