/**
 * @file      gpio.cpp (from gpio-MK22F12810.cpp)
 *
...
void usbdm_PinMapping() {
   ...
   SIM->FIXED_PORT_CLOCK_REG |= PORTA_CLOCK_MASK;
    ...
    (PTB3_SIG_SEL>=0) || (PTB8_SIG_SEL>=0) || (PTB9_SIG_SEL>=0) || (PTB10_SIG_SEL>=0) || \
   ...
   SIM->FIXED_PORT_CLOCK_REG |= PORTB_CLOCK_MASK;
    ...
    (PTC12_SIG_SEL>=0) || (PTC13_SIG_SEL>=0) || (PTC14_SIG_SEL>=0) || (PTC15_SIG_SEL>=0) || \
    (PTC16_SIG_SEL>=0) || (PTC17_SIG_SEL>=0) || (PTC18_SIG_SEL>=0)
