...
public:
   ...
   static constexpr uint32_t clkdiv2 = 
      0;  // USB clock divider divisor & fraction 
...
public:
   ...
   static constexpr PcrInfo  info[] = {
         ...
         /*   8: ADC0_SE8             = PTB0 (A0/J24_2)                */  { PORTB_CLOCK_MASK, PORTB_BasePtr,  GPIOB_BasePtr,  0,   PORT_PCR_MUX(0)|defaultPcrValue  },
         /*   9: ADC0_SE9             = PTB1 (A1/J24_4)                */  { PORTB_CLOCK_MASK, PORTB_BasePtr,  GPIOB_BasePtr,  1,   PORT_PCR_MUX(0)|defaultPcrValue  },
         /*  10: --                   = --                             */  { 0, 0, 0, INVALID_PCR,  0 },
         /*  11: --                   = --                             */  { 0, 0, 0, INVALID_PCR,  0 },
         /*  12: ADC0_SE12            = PTB2 (A5/J24_12/ONBOARD_SCL)   */  { PORTB_CLOCK_MASK, PORTB_BasePtr,  GPIOB_BasePtr,  2,   PORT_PCR_MUX(0)|defaultPcrValue  },
         /*  13: ADC0_SE13            = PTB3 (A4/J24_10/ONBOARD_SDA)   */  { PORTB_CLOCK_MASK, PORTB_BasePtr,  GPIOB_BasePtr,  3,   PORT_PCR_MUX(0)|defaultPcrValue  },
         /*  14: ADC0_SE14            = --                             */  { 0, 0, 0, UNMAPPED_PCR, 0 },
         /*  15: ADC0_SE15            = PTC1 (A2/J24_6/SW2)            */  { PORTC_CLOCK_MASK, PORTC_BasePtr,  GPIOC_BasePtr,  1,   PORT_PCR_MUX(0)|defaultPcrValue  },
   ...
   static void initPCRs(uint32_t pcrValue=defaultPcrValue) {
      ...
      ((PORT_Type *)PORTB_BasePtr)->GPCLR = pcrValue|PORT_PCR_MUX(0)|PORT_GPCLR_GPWE(0x000FUL);
      ((PORT_Type *)PORTC_BasePtr)->GPCLR = pcrValue|PORT_PCR_MUX(0)|PORT_GPCLR_GPWE(0x0002UL);
   }
...
public:
   ...
   static constexpr PcrInfo  info[] = {
         ...
         /*   7: ADC1_SE7b            = PTC11                          */  { PORTC_CLOCK_MASK, PORTC_BasePtr,  GPIOC_BasePtr,  11,  PORT_PCR_MUX(0)|defaultPcrValue  },
         /*   8: ADC1_SE8             = PTB0 (A0/J24_2)                */  { PORTB_CLOCK_MASK, PORTB_BasePtr,  GPIOB_BasePtr,  0,   PORT_PCR_MUX(0)|defaultPcrValue  },
         /*   9: ADC1_SE9             = PTB1 (A1/J24_4)                */  { PORTB_CLOCK_MASK, PORTB_BasePtr,  GPIOB_BasePtr,  1,   PORT_PCR_MUX(0)|defaultPcrValue  },
         /*  10: --                   = --                             */  { 0, 0, 0, INVALID_PCR,  0 },
         /*  11: --                   = --                             */  { 0, 0, 0, INVALID_PCR,  0 },
   ...
   static void initPCRs(uint32_t pcrValue=defaultPcrValue) {
      ...
      ((PORT_Type *)PORTC_BasePtr)->GPCLR = pcrValue|PORT_PCR_MUX(0)|PORT_GPCLR_GPWE(0x0800UL);
   }
   ...
   static void clearPCRs() {
      ...
      ((PORT_Type *)PORTC_BasePtr)->GPCLR = PORT_PCR_MUX(0)|PORT_GPCLR_GPWE(0x800U);
   }
...
public:
   ...
   static constexpr PcrInfo  info[] = {
         ...
         /*   1: FTM0_CH1             = PTC2 (A3/J24_8)                */  { PORTC_CLOCK_MASK, PORTC_BasePtr,  GPIOC_BasePtr,  2,   PORT_PCR_MUX(4)|defaultPcrValue  },
...
public:
   ...
   static constexpr PcrInfo  info[] = {
         ...
         /*   3: LLWU_P3              = PTA4 (D4/J1_10)                */  { PORTA_CLOCK_MASK, PORTA_BasePtr,  GPIOA_BasePtr,  4,   PORT_PCR_MUX(1)|defaultPcrValue  },
         /*   4: LLWU_P4              = PTA13 (D17/J1_3)               */  { PORTA_CLOCK_MASK, PORTA_BasePtr,  GPIOA_BasePtr,  13,  PORT_PCR_MUX(1)|defaultPcrValue  },
         /*   5: LLWU_P5              = --                             */  { 0, 0, 0, UNMAPPED_PCR, 0 },
         /*   6: LLWU_P6              = --                             */  { 0, 0, 0, UNMAPPED_PCR, 0 },
         /*   7: LLWU_P7              = PTC3 (D6/J1_14)                */  { PORTC_CLOCK_MASK, PORTC_BasePtr,  GPIOC_BasePtr,  3,   PORT_PCR_MUX(1)|defaultPcrValue  },
         /*   8: LLWU_P8              = --                             */  { 0, 0, 0, UNMAPPED_PCR, 0 },
         /*   9: LLWU_P9              = PTC5 (D23/J1_15)               */  { PORTC_CLOCK_MASK, PORTC_BasePtr,  GPIOC_BasePtr,  5,   PORT_PCR_MUX(1)|defaultPcrValue  },
         /*  10: LLWU_P10             = PTC6 (D7/J1_16)                */  { PORTC_CLOCK_MASK, PORTC_BasePtr,  GPIOC_BasePtr,  6,   PORT_PCR_MUX(1)|defaultPcrValue  },
         /*  11: LLWU_P11             = --                             */  { 0, 0, 0, UNMAPPED_PCR, 0 },
         /*  12: LLWU_P12             = --                             */  { 0, 0, 0, UNMAPPED_PCR, 0 },
         /*  13: LLWU_P13             = PTD2 (D0/J1_2/SD_MOSI/BT_RX)   */  { PORTD_CLOCK_MASK, PORTD_BasePtr,  GPIOD_BasePtr,  2,   PORT_PCR_MUX(1)|defaultPcrValue  },
         /*  14: LLWU_P14             = PTD4 (D10/J2_6)                */  { PORTD_CLOCK_MASK, PORTD_BasePtr,  GPIOD_BasePtr,  4,   PORT_PCR_MUX(1)|defaultPcrValue  },
   ...
   static void initPCRs(uint32_t pcrValue=defaultPcrValue) {
      ...
      ((PORT_Type *)PORTC_BasePtr)->GPCLR = pcrValue|PORT_PCR_MUX(1)|PORT_GPCLR_GPWE(0x0068UL);
      ((PORT_Type *)PORTD_BasePtr)->GPCLR = pcrValue|PORT_PCR_MUX(1)|PORT_GPCLR_GPWE(0x0014UL);
   }
   ...
   static void clearPCRs() {
      ...
      ((PORT_Type *)PORTD_BasePtr)->GPCLR = PORT_PCR_MUX(0)|PORT_GPCLR_GPWE(0x14U);
   }
...
public:
   ...
   static constexpr PcrInfo  info[] = {
         ...
         /*   1: UART0_RX             = PTA1 (D9/J2_4/LED_RED)         */  { PORTA_CLOCK_MASK, PORTA_BasePtr,  GPIOA_BasePtr,  1,   PORT_PCR_MUX(2)|defaultPcrValue  },
 ...
 *  PTA1                     | UART0_RX                                    | D9/J2_4/LED_RED           | Red LED       
 ...
 *  PTE0                     | -                                           | D14/J2_18/ConTx           | USB Serial Tx       
 *  PTE1                     | -                                           | D15/J2_19/ConRx           | USB Serial Rx       
