...
/**
 * Interface for low-level functions to FATFS
 */
class SdInterface {
...
public:
    ...
    * @return  Status
    */
   virtual DRESULT disk_read (uint8_t *buffer, uint32_t startBlock, uint32_t blockCount) = 0;
    ...
    * @return  Status
    */
   virtual DRESULT disk_write(const uint8_t *buffer, uint32_t startBlock, uint32_t blockCount) = 0;
    ...
    * @return  Status
    */
   virtual DRESULT disk_ioctl (uint8_t ctrl, void *buff) = 0;
};
