...
constexpr MemoryAddressWrapper<AccessType, 0x0800'0000, (1<<23)/sizeof(AccessType)> sdram;
...
constexpr MemoryAddressWrapper<AccessType, SDRAMC_BASEADDRESS, (1<<23)/sizeof(AccessType)> sdram;
...
int main() {
   ...
   const size_t numberOfTests = sdram.size;
