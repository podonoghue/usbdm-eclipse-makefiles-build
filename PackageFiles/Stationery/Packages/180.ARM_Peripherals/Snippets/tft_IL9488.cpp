/******************************************************************************
 * @file tft_IL9488.cpp (180.ARM_Peripherals/Snippets)
 *
 ...
 *  TftBusyPin  TFT Busy pin as GPIO e.g. GpioB.0 (A5)
 *
 ...
 */
void TFT_ILI9488::waitWhileBusy() {

   while(TftBusyPin::isActive()) {
      __asm__("NOP");
      //         console.WRITELN("Tft busy...\r\n");
   }
   //   console.WRITELN("Tft busy release\r\n");
}

/**
 * Force hardware reset of module
 */
void TFT_ILI9488::hardwareReset() {
 ...
 */
void TFT_ILI9488::sendCommand(Command Command) {
 ...
 */
void TFT_ILI9488::sendCommand(Command Command, const uint8_t data) {
 ...
 */
void TFT_ILI9488::sendCommand(Command Command, unsigned size, const uint8_t *data) {
 ...
 */
template<size_t N>
void TFT_ILI9488::sendCommand(Command Command, const uint8_t (&data)[N]) {
 ...
 */
template<size_t N>
void TFT_ILI9488::sendCommand(Command Command, const std::array<uint8_t, N>&data) {
 ...
 */
void TFT_ILI9488::sendData(uint8_t data) {
 ...
 * @param data    Data array
 */
void TFT_ILI9488::sendData(unsigned length, const uint8_t *data) {
 ...
 */
template<size_t N>
void TFT_ILI9488::sendData(const uint8_t (&data)[N]) {
...
void TFT_ILI9488::sendSequence(const uint8_t sequence[]) {
 ...
 */
void TFT_ILI9488::sendColour(Colour colour) {
...
void TFT_ILI9488::initialise() {
   ...
   static const uint8_t initSequence[] = {
         ...
         1, Command_SetPixelFormat,
         0x66,  // Pixel Interface Format - 18-bit colour for SPI

         1,  Command_InterfaceModeControl,
         0x00, // 0x80 to disable SDO

         1,  Command_SetFrameRateNormalMode,
         0xA0, // 60 Hz
         ...
         0x02, 0x02, (480/8)-1, // x x 8*(59+1) = 480 lines
 ...
 * @param Yend    Y end
 */
void TFT_ILI9488::setWindow(uint16_t Xstart, uint16_t Ystart, uint16_t Xend, uint16_t Yend) {
...
void TFT_ILI9488::drawPixel(unsigned x, unsigned y, Colour colour) {
 ...
 * @param x1   End X
 */
void TFT_ILI9488::drawHorizontalLine(unsigned x0, unsigned y0, unsigned x1) {
 ...
 * @param y1   End Y
 */
void TFT_ILI9488::drawVerticalLine(unsigned x0, unsigned y0, unsigned y1) {
 ...
 * @param y1   End Y
 */
void TFT_ILI9488::drawLine(unsigned x0, unsigned y0, unsigned x1, unsigned y1) {
 ...
 */
void TFT_ILI9488::drawRect(unsigned x0, unsigned y0, unsigned x1, unsigned y1) {
 ...
 * @param y1  Bottom-right Y
 */
void TFT_ILI9488::drawOpenRect(unsigned x0, unsigned y0, unsigned x1, unsigned y1) {
 ...
 */
void TFT_ILI9488::drawCircle(unsigned X, unsigned Y, unsigned Radius) {
 ...
 * @param Radius  Circle radius
 */
void TFT_ILI9488::drawOpenCircle(unsigned X, unsigned Y, unsigned Radius) {
 ...
 * @param h    Height
 */
void TFT_ILI9488::drawImage(const uint8_t* img, uint16_t x, uint16_t y, uint16_t w, uint16_t h) {
 ...
 * @param h    Height
 */
void TFT_ILI9488::drawBitmap(const uint8_t* img, uint16_t x, uint16_t y, uint16_t w, uint16_t h) {
 ...
 */
TFT_ILI9488 &TFT_ILI9488::putCustomChar(const uint8_t *image, unsigned width, unsigned height) {
 ...
 * @return Reference to self
 */
TFT_ILI9488 &TFT_ILI9488::putSpace(int width) {
 ...
 */
void TFT_ILI9488::_writeChar(char ch) {
