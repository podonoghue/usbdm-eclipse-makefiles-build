/******************************************************************************
 * @file   tft-example-IL9488.cpp (180.ARM_Peripherals/Snippets)
 * @brief  Example for IL9488 based TFT display
 * @author podonoghue
 *
...
int main() {
   ...
   // TFT interface
   TFT_ILI9488<Orientation_Normal> tft(spi);
