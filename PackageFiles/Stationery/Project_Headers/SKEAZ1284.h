 ...
 * @file     SKEAZ1284.h
 *
 * @brief    CMSIS Cortex-M Peripheral Access Layer Header File for SKEAZ1284.
 *           Equivalent: 
 *
 * @version  V1.6
 * @date     2022/07
...
#ifndef _SKEAZ1284_H_
#define _SKEAZ1284_H_
...
/* ----------------------   MKE06Z4 VectorTable                      ---------------------- */
  ...
  CAN_RX_IRQn                   =  30,   /**<  46 Scalable Controller Area Network                                                 */
  CAN_TX_IRQn                   =  31,   /**<  47 Scalable Controller Area Network                                                 */
} IRQn_Type;
...
extern void CAN_RX_IRQHandler(void);                 /**< Scalable Controller Area Network                                                 */
extern void CAN_TX_IRQHandler(void);                 /**< Scalable Controller Area Network                                                 */
...
/*! @name PID - Peripheral Identification Register %s */

/*! @name CID - Component Identification Register 0 */
/**
...
/*! @name CANCTL0 - Control Register 0 */
...
#define CAN_CANCTL0_INITRQ(x)                    (((uint8_t)(((uint8_t)(x))<<CAN_CANCTL0_INITRQ_SHIFT))&CAN_CANCTL0_INITRQ_MASK) /*!< CAN0_CANCTL0.INITRQ Field               */
#define CAN_CANCTL0_SLPRQ_MASK                   (0x2U)                                              /*!< CAN0_CANCTL0.SLPRQ Mask                 */
#define CAN_CANCTL0_SLPRQ_SHIFT                  (1U)                                                /*!< CAN0_CANCTL0.SLPRQ Position             */
#define CAN_CANCTL0_SLPRQ(x)                     (((uint8_t)(((uint8_t)(x))<<CAN_CANCTL0_SLPRQ_SHIFT))&CAN_CANCTL0_SLPRQ_MASK) /*!< CAN0_CANCTL0.SLPRQ Field                */
#define CAN_CANCTL0_WUPE_MASK                    (0x4U)                                              /*!< CAN0_CANCTL0.WUPE Mask                  */
#define CAN_CANCTL0_WUPE_SHIFT                   (2U)                                                /*!< CAN0_CANCTL0.WUPE Position              */
#define CAN_CANCTL0_WUPE(x)                      (((uint8_t)(((uint8_t)(x))<<CAN_CANCTL0_WUPE_SHIFT))&CAN_CANCTL0_WUPE_MASK) /*!< CAN0_CANCTL0.WUPE Field                 */
#define CAN_CANCTL0_TIME_MASK                    (0x8U)                                              /*!< CAN0_CANCTL0.TIME Mask                  */
#define CAN_CANCTL0_TIME_SHIFT                   (3U)                                                /*!< CAN0_CANCTL0.TIME Position              */
#define CAN_CANCTL0_TIME(x)                      (((uint8_t)(((uint8_t)(x))<<CAN_CANCTL0_TIME_SHIFT))&CAN_CANCTL0_TIME_MASK) /*!< CAN0_CANCTL0.TIME Field                 */
#define CAN_CANCTL0_SYNCH_MASK                   (0x10U)                                             /*!< CAN0_CANCTL0.SYNCH Mask                 */
#define CAN_CANCTL0_SYNCH_SHIFT                  (4U)                                                /*!< CAN0_CANCTL0.SYNCH Position             */
#define CAN_CANCTL0_SYNCH(x)                     (((uint8_t)(((uint8_t)(x))<<CAN_CANCTL0_SYNCH_SHIFT))&CAN_CANCTL0_SYNCH_MASK) /*!< CAN0_CANCTL0.SYNCH Field                */
#define CAN_CANCTL0_CSWAI_MASK                   (0x20U)                                             /*!< CAN0_CANCTL0.CSWAI Mask                 */
#define CAN_CANCTL0_CSWAI_SHIFT                  (5U)                                                /*!< CAN0_CANCTL0.CSWAI Position             */
#define CAN_CANCTL0_CSWAI(x)                     (((uint8_t)(((uint8_t)(x))<<CAN_CANCTL0_CSWAI_SHIFT))&CAN_CANCTL0_CSWAI_MASK) /*!< CAN0_CANCTL0.CSWAI Field                */
#define CAN_CANCTL0_RXACT_MASK                   (0x40U)                                             /*!< CAN0_CANCTL0.RXACT Mask                 */
#define CAN_CANCTL0_RXACT_SHIFT                  (6U)                                                /*!< CAN0_CANCTL0.RXACT Position             */
#define CAN_CANCTL0_RXACT(x)                     (((uint8_t)(((uint8_t)(x))<<CAN_CANCTL0_RXACT_SHIFT))&CAN_CANCTL0_RXACT_MASK) /*!< CAN0_CANCTL0.RXACT Field                */
#define CAN_CANCTL0_RXFRM_MASK                   (0x80U)                                             /*!< CAN0_CANCTL0.RXFRM Mask                 */
#define CAN_CANCTL0_RXFRM_SHIFT                  (7U)                                                /*!< CAN0_CANCTL0.RXFRM Position             */
#define CAN_CANCTL0_RXFRM(x)                     (((uint8_t)(((uint8_t)(x))<<CAN_CANCTL0_RXFRM_SHIFT))&CAN_CANCTL0_RXFRM_MASK) /*!< CAN0_CANCTL0.RXFRM Field                */

/*! @name CANCTL1 - Control Register 1 */
...
#define CAN_CANCTL1_INITAK(x)                    (((uint8_t)(((uint8_t)(x))<<CAN_CANCTL1_INITAK_SHIFT))&CAN_CANCTL1_INITAK_MASK) /*!< CAN0_CANCTL1.INITAK Field               */
#define CAN_CANCTL1_SLPAK_MASK                   (0x2U)                                              /*!< CAN0_CANCTL1.SLPAK Mask                 */
#define CAN_CANCTL1_SLPAK_SHIFT                  (1U)                                                /*!< CAN0_CANCTL1.SLPAK Position             */
#define CAN_CANCTL1_SLPAK(x)                     (((uint8_t)(((uint8_t)(x))<<CAN_CANCTL1_SLPAK_SHIFT))&CAN_CANCTL1_SLPAK_MASK) /*!< CAN0_CANCTL1.SLPAK Field                */
#define CAN_CANCTL1_WUPM_MASK                    (0x4U)                                              /*!< CAN0_CANCTL1.WUPM Mask                  */
#define CAN_CANCTL1_WUPM_SHIFT                   (2U)                                                /*!< CAN0_CANCTL1.WUPM Position              */
#define CAN_CANCTL1_WUPM(x)                      (((uint8_t)(((uint8_t)(x))<<CAN_CANCTL1_WUPM_SHIFT))&CAN_CANCTL1_WUPM_MASK) /*!< CAN0_CANCTL1.WUPM Field                 */
#define CAN_CANCTL1_BORM_MASK                    (0x8U)                                              /*!< CAN0_CANCTL1.BORM Mask                  */
#define CAN_CANCTL1_BORM_SHIFT                   (3U)                                                /*!< CAN0_CANCTL1.BORM Position              */
#define CAN_CANCTL1_BORM(x)                      (((uint8_t)(((uint8_t)(x))<<CAN_CANCTL1_BORM_SHIFT))&CAN_CANCTL1_BORM_MASK) /*!< CAN0_CANCTL1.BORM Field                 */
...
#define CAN_CANCTL1_LISTEN(x)                    (((uint8_t)(((uint8_t)(x))<<CAN_CANCTL1_LISTEN_SHIFT))&CAN_CANCTL1_LISTEN_MASK) /*!< CAN0_CANCTL1.LISTEN Field               */
#define CAN_CANCTL1_LOOPB_MASK                   (0x20U)                                             /*!< CAN0_CANCTL1.LOOPB Mask                 */
#define CAN_CANCTL1_LOOPB_SHIFT                  (5U)                                                /*!< CAN0_CANCTL1.LOOPB Position             */
#define CAN_CANCTL1_LOOPB(x)                     (((uint8_t)(((uint8_t)(x))<<CAN_CANCTL1_LOOPB_SHIFT))&CAN_CANCTL1_LOOPB_MASK) /*!< CAN0_CANCTL1.LOOPB Field                */
...
#define CAN_CANCTL1_CLKSRC(x)                    (((uint8_t)(((uint8_t)(x))<<CAN_CANCTL1_CLKSRC_SHIFT))&CAN_CANCTL1_CLKSRC_MASK) /*!< CAN0_CANCTL1.CLKSRC Field               */
#define CAN_CANCTL1_CANE_MASK                    (0x80U)                                             /*!< CAN0_CANCTL1.CANE Mask                  */
#define CAN_CANCTL1_CANE_SHIFT                   (7U)                                                /*!< CAN0_CANCTL1.CANE Position              */
#define CAN_CANCTL1_CANE(x)                      (((uint8_t)(((uint8_t)(x))<<CAN_CANCTL1_CANE_SHIFT))&CAN_CANCTL1_CANE_MASK) /*!< CAN0_CANCTL1.CANE Field                 */

/*! @name CANBTR0 - Bus Timing Register 0 */
#define CAN_CANBTR0_BRP_MASK                     (0x1FU)                                             /*!< CAN0_CANBTR0.BRP Mask                   */
#define CAN_CANBTR0_BRP_SHIFT                    (0U)                                                /*!< CAN0_CANBTR0.BRP Position               */
#define CAN_CANBTR0_BRP(x)                       (((uint8_t)(((uint8_t)(x))<<CAN_CANBTR0_BRP_SHIFT))&CAN_CANBTR0_BRP_MASK) /*!< CAN0_CANBTR0.BRP Field                  */
#define CAN_CANBTR0_SJW_MASK                     (0xC0U)                                             /*!< CAN0_CANBTR0.SJW Mask                   */
#define CAN_CANBTR0_SJW_SHIFT                    (6U)                                                /*!< CAN0_CANBTR0.SJW Position               */
#define CAN_CANBTR0_SJW(x)                       (((uint8_t)(((uint8_t)(x))<<CAN_CANBTR0_SJW_SHIFT))&CAN_CANBTR0_SJW_MASK) /*!< CAN0_CANBTR0.SJW Field                  */

/*! @name CANBTR1 - Bus Timing Register 1 */
#define CAN_CANBTR1_TSEG1_MASK                   (0xFU)                                              /*!< CAN0_CANBTR1.TSEG1 Mask                 */
#define CAN_CANBTR1_TSEG1_SHIFT                  (0U)                                                /*!< CAN0_CANBTR1.TSEG1 Position             */
#define CAN_CANBTR1_TSEG1(x)                     (((uint8_t)(((uint8_t)(x))<<CAN_CANBTR1_TSEG1_SHIFT))&CAN_CANBTR1_TSEG1_MASK) /*!< CAN0_CANBTR1.TSEG1 Field                */
#define CAN_CANBTR1_TSEG2_MASK                   (0x70U)                                             /*!< CAN0_CANBTR1.TSEG2 Mask                 */
#define CAN_CANBTR1_TSEG2_SHIFT                  (4U)                                                /*!< CAN0_CANBTR1.TSEG2 Position             */
#define CAN_CANBTR1_TSEG2(x)                     (((uint8_t)(((uint8_t)(x))<<CAN_CANBTR1_TSEG2_SHIFT))&CAN_CANBTR1_TSEG2_MASK) /*!< CAN0_CANBTR1.TSEG2 Field                */
#define CAN_CANBTR1_SAMP_MASK                    (0x80U)                                             /*!< CAN0_CANBTR1.SAMP Mask                  */
#define CAN_CANBTR1_SAMP_SHIFT                   (7U)                                                /*!< CAN0_CANBTR1.SAMP Position              */
#define CAN_CANBTR1_SAMP(x)                      (((uint8_t)(((uint8_t)(x))<<CAN_CANBTR1_SAMP_SHIFT))&CAN_CANBTR1_SAMP_MASK) /*!< CAN0_CANBTR1.SAMP Field                 */

/*! @name CANRFLG - Receiver Flag Register */
#define CAN_CANRFLG_RXF_MASK                     (0x1U)                                              /*!< CAN0_CANRFLG.RXF Mask                   */
#define CAN_CANRFLG_RXF_SHIFT                    (0U)                                                /*!< CAN0_CANRFLG.RXF Position               */
#define CAN_CANRFLG_RXF(x)                       (((uint8_t)(((uint8_t)(x))<<CAN_CANRFLG_RXF_SHIFT))&CAN_CANRFLG_RXF_MASK) /*!< CAN0_CANRFLG.RXF Field                  */
#define CAN_CANRFLG_OVRIF_MASK                   (0x2U)                                              /*!< CAN0_CANRFLG.OVRIF Mask                 */
#define CAN_CANRFLG_OVRIF_SHIFT                  (1U)                                                /*!< CAN0_CANRFLG.OVRIF Position             */
#define CAN_CANRFLG_OVRIF(x)                     (((uint8_t)(((uint8_t)(x))<<CAN_CANRFLG_OVRIF_SHIFT))&CAN_CANRFLG_OVRIF_MASK) /*!< CAN0_CANRFLG.OVRIF Field                */
#define CAN_CANRFLG_TSTAT_MASK                   (0xCU)                                              /*!< CAN0_CANRFLG.TSTAT Mask                 */
#define CAN_CANRFLG_TSTAT_SHIFT                  (2U)                                                /*!< CAN0_CANRFLG.TSTAT Position             */
#define CAN_CANRFLG_TSTAT(x)                     (((uint8_t)(((uint8_t)(x))<<CAN_CANRFLG_TSTAT_SHIFT))&CAN_CANRFLG_TSTAT_MASK) /*!< CAN0_CANRFLG.TSTAT Field                */
#define CAN_CANRFLG_RSTAT_MASK                   (0x30U)                                             /*!< CAN0_CANRFLG.RSTAT Mask                 */
#define CAN_CANRFLG_RSTAT_SHIFT                  (4U)                                                /*!< CAN0_CANRFLG.RSTAT Position             */
#define CAN_CANRFLG_RSTAT(x)                     (((uint8_t)(((uint8_t)(x))<<CAN_CANRFLG_RSTAT_SHIFT))&CAN_CANRFLG_RSTAT_MASK) /*!< CAN0_CANRFLG.RSTAT Field                */
#define CAN_CANRFLG_CSCIF_MASK                   (0x40U)                                             /*!< CAN0_CANRFLG.CSCIF Mask                 */
#define CAN_CANRFLG_CSCIF_SHIFT                  (6U)                                                /*!< CAN0_CANRFLG.CSCIF Position             */
#define CAN_CANRFLG_CSCIF(x)                     (((uint8_t)(((uint8_t)(x))<<CAN_CANRFLG_CSCIF_SHIFT))&CAN_CANRFLG_CSCIF_MASK) /*!< CAN0_CANRFLG.CSCIF Field                */
#define CAN_CANRFLG_WUPIF_MASK                   (0x80U)                                             /*!< CAN0_CANRFLG.WUPIF Mask                 */
#define CAN_CANRFLG_WUPIF_SHIFT                  (7U)                                                /*!< CAN0_CANRFLG.WUPIF Position             */
#define CAN_CANRFLG_WUPIF(x)                     (((uint8_t)(((uint8_t)(x))<<CAN_CANRFLG_WUPIF_SHIFT))&CAN_CANRFLG_WUPIF_MASK) /*!< CAN0_CANRFLG.WUPIF Field                */

/*! @name CANRIER - Receiver Interrupt Enable Register */
#define CAN_CANRIER_RXFIE_MASK                   (0x1U)                                              /*!< CAN0_CANRIER.RXFIE Mask                 */
#define CAN_CANRIER_RXFIE_SHIFT                  (0U)                                                /*!< CAN0_CANRIER.RXFIE Position             */
#define CAN_CANRIER_RXFIE(x)                     (((uint8_t)(((uint8_t)(x))<<CAN_CANRIER_RXFIE_SHIFT))&CAN_CANRIER_RXFIE_MASK) /*!< CAN0_CANRIER.RXFIE Field                */
#define CAN_CANRIER_OVRIE_MASK                   (0x2U)                                              /*!< CAN0_CANRIER.OVRIE Mask                 */
#define CAN_CANRIER_OVRIE_SHIFT                  (1U)                                                /*!< CAN0_CANRIER.OVRIE Position             */
#define CAN_CANRIER_OVRIE(x)                     (((uint8_t)(((uint8_t)(x))<<CAN_CANRIER_OVRIE_SHIFT))&CAN_CANRIER_OVRIE_MASK) /*!< CAN0_CANRIER.OVRIE Field                */
...
#define CAN_CANRIER_TSTATE(x)                    (((uint8_t)(((uint8_t)(x))<<CAN_CANRIER_TSTATE_SHIFT))&CAN_CANRIER_TSTATE_MASK) /*!< CAN0_CANRIER.TSTATE Field               */
...
#define CAN_CANRIER_RSTATE(x)                    (((uint8_t)(((uint8_t)(x))<<CAN_CANRIER_RSTATE_SHIFT))&CAN_CANRIER_RSTATE_MASK) /*!< CAN0_CANRIER.RSTATE Field               */
#define CAN_CANRIER_CSCIE_MASK                   (0x40U)                                             /*!< CAN0_CANRIER.CSCIE Mask                 */
#define CAN_CANRIER_CSCIE_SHIFT                  (6U)                                                /*!< CAN0_CANRIER.CSCIE Position             */
#define CAN_CANRIER_CSCIE(x)                     (((uint8_t)(((uint8_t)(x))<<CAN_CANRIER_CSCIE_SHIFT))&CAN_CANRIER_CSCIE_MASK) /*!< CAN0_CANRIER.CSCIE Field                */
#define CAN_CANRIER_WUPIE_MASK                   (0x80U)                                             /*!< CAN0_CANRIER.WUPIE Mask                 */
#define CAN_CANRIER_WUPIE_SHIFT                  (7U)                                                /*!< CAN0_CANRIER.WUPIE Position             */
#define CAN_CANRIER_WUPIE(x)                     (((uint8_t)(((uint8_t)(x))<<CAN_CANRIER_WUPIE_SHIFT))&CAN_CANRIER_WUPIE_MASK) /*!< CAN0_CANRIER.WUPIE Field                */

/*! @name CANTFLG - Transmitter Flag Register */
#define CAN_CANTFLG_TXE_MASK                     (0x7U)                                              /*!< CAN0_CANTFLG.TXE Mask                   */
#define CAN_CANTFLG_TXE_SHIFT                    (0U)                                                /*!< CAN0_CANTFLG.TXE Position               */
#define CAN_CANTFLG_TXE(x)                       (((uint8_t)(((uint8_t)(x))<<CAN_CANTFLG_TXE_SHIFT))&CAN_CANTFLG_TXE_MASK) /*!< CAN0_CANTFLG.TXE Field                  */

/*! @name CANTIER - Transmitter Interrupt Enable Register */
#define CAN_CANTIER_TXEIE_MASK                   (0x7U)                                              /*!< CAN0_CANTIER.TXEIE Mask                 */
#define CAN_CANTIER_TXEIE_SHIFT                  (0U)                                                /*!< CAN0_CANTIER.TXEIE Position             */
#define CAN_CANTIER_TXEIE(x)                     (((uint8_t)(((uint8_t)(x))<<CAN_CANTIER_TXEIE_SHIFT))&CAN_CANTIER_TXEIE_MASK) /*!< CAN0_CANTIER.TXEIE Field                */

/*! @name CANTARQ - Transmitter Message Abort Request Register */
#define CAN_CANTARQ_ABTRQ_MASK                   (0x7U)                                              /*!< CAN0_CANTARQ.ABTRQ Mask                 */
#define CAN_CANTARQ_ABTRQ_SHIFT                  (0U)                                                /*!< CAN0_CANTARQ.ABTRQ Position             */
#define CAN_CANTARQ_ABTRQ(x)                     (((uint8_t)(((uint8_t)(x))<<CAN_CANTARQ_ABTRQ_SHIFT))&CAN_CANTARQ_ABTRQ_MASK) /*!< CAN0_CANTARQ.ABTRQ Field                */

/*! @name CANTAAK - Transmitter Message Abort Acknowledge Register */
#define CAN_CANTAAK_ABTAK_MASK                   (0x7U)                                              /*!< CAN0_CANTAAK.ABTAK Mask                 */
#define CAN_CANTAAK_ABTAK_SHIFT                  (0U)                                                /*!< CAN0_CANTAAK.ABTAK Position             */
#define CAN_CANTAAK_ABTAK(x)                     (((uint8_t)(((uint8_t)(x))<<CAN_CANTAAK_ABTAK_SHIFT))&CAN_CANTAAK_ABTAK_MASK) /*!< CAN0_CANTAAK.ABTAK Field                */

/*! @name CANTBSEL - Transmit Buffer Selection Register */
#define CAN_CANTBSEL_TX_MASK                     (0x7U)                                              /*!< CAN0_CANTBSEL.TX Mask                   */
#define CAN_CANTBSEL_TX_SHIFT                    (0U)                                                /*!< CAN0_CANTBSEL.TX Position               */
#define CAN_CANTBSEL_TX(x)                       (((uint8_t)(((uint8_t)(x))<<CAN_CANTBSEL_TX_SHIFT))&CAN_CANTBSEL_TX_MASK) /*!< CAN0_CANTBSEL.TX Field                  */

/*! @name CANIDAC - Identifier Acceptance Control Register */
#define CAN_CANIDAC_IDHIT_MASK                   (0x7U)                                              /*!< CAN0_CANIDAC.IDHIT Mask                 */
#define CAN_CANIDAC_IDHIT_SHIFT                  (0U)                                                /*!< CAN0_CANIDAC.IDHIT Position             */
#define CAN_CANIDAC_IDHIT(x)                     (((uint8_t)(((uint8_t)(x))<<CAN_CANIDAC_IDHIT_SHIFT))&CAN_CANIDAC_IDHIT_MASK) /*!< CAN0_CANIDAC.IDHIT Field                */
#define CAN_CANIDAC_IDAM_MASK                    (0x30U)                                             /*!< CAN0_CANIDAC.IDAM Mask                  */
#define CAN_CANIDAC_IDAM_SHIFT                   (4U)                                                /*!< CAN0_CANIDAC.IDAM Position              */
#define CAN_CANIDAC_IDAM(x)                      (((uint8_t)(((uint8_t)(x))<<CAN_CANIDAC_IDAM_SHIFT))&CAN_CANIDAC_IDAM_MASK) /*!< CAN0_CANIDAC.IDAM Field                 */

/*! @name CANMISC - Miscellaneous Register */
...
#define CAN_CANMISC_BOHOLD(x)                    (((uint8_t)(((uint8_t)(x))<<CAN_CANMISC_BOHOLD_SHIFT))&CAN_CANMISC_BOHOLD_MASK) /*!< CAN0_CANMISC.BOHOLD Field               */

/*! @name CANRXERR - Receive Error Counter */

/*! @name CANTXERR - Transmit Error Counter */

/*! @name CANIDAR - Identifier Acceptance Register n of First Bank */

/*! @name CANIDMR - Identifier Mask Register n of First Bank */

/*! @name CANIDAR - Identifier Acceptance Register n of Second Bank */

/*! @name CANIDMR - Identifier Mask Register n of Second Bank */

/*! @name REIDR - Receive Extended Identifier Register %n */

/*! @name RSIDR - Receive Standard Identifier Register %n */
...
#define CAN_RDLR_RDLC(x)                         (((uint8_t)(((uint8_t)(x))<<CAN_RDLR_RDLC_SHIFT))&CAN_RDLR_RDLC_MASK) /*!< CAN0_RDLR.RDLC Field                    */

/*! @name RTSRH - Receive Time Stamp Register High */

/*! @name RTSRL - Receive Time Stamp Register Low */

/*! @name TEIDR - Transmit Extended Identifier Register %n */

/*! @name TSIDR - Transmit Standard Identifier Register %n */
...
#define CAN0_IRQS { CAN_RX_IRQn, CAN_TX_IRQn,  }
...
/*! @name PDORA - Port Data Output Register */

/*! @name PDORB - Port Data Output Register */

/*! @name PDORC - Port Data Output Register */

/*! @name PDORD - Port Data Output Register */

/*! @name PSOR - Port Set Output Register */

/*! @name PSORA - Port Set Output Register */

/*! @name PSORB - Port Set Output Register */

/*! @name PSORC - Port Set Output Register */

/*! @name PSORD - Port Set Output Register */

/*! @name PCOR - Port Clear Output Register */

/*! @name PCORA - Port Clear Output Register */

/*! @name PCORB - Port Clear Output Register */

/*! @name PCORC - Port Clear Output Register */

/*! @name PCORD - Port Clear Output Register */

/*! @name PTOR - Port Toggle Output Register */

/*! @name PTORA - Port Toggle Output Register */

/*! @name PTORB - Port Toggle Output Register */

/*! @name PTORC - Port Toggle Output Register */

/*! @name PTORD - Port Toggle Output Register */

/*! @name PDIR - Port Data Input Register */

/*! @name PDIRA - Port Data Input Register */

/*! @name PDIRB - Port Data Input Register */

/*! @name PDIRC - Port Data Input Register */

/*! @name PDIRD - Port Data Input Register */

/*! @name PDDR - Port Data Direction Register */

/*! @name PDDRA - Port Data Direction Register */

/*! @name PDDRB - Port Data Direction Register */

/*! @name PDDRC - Port Data Direction Register */

/*! @name PDDRD - Port Data Direction Register */

/*! @name PIDR - Port Input Disable Register */

/*! @name PIDRA - Port Input Disable Register */

/*! @name PIDRB - Port Input Disable Register */

/*! @name PIDRC - Port Input Disable Register */

/*! @name PIDRD - Port Input Disable Register */
/**
...
/*! @name PDORE - Port Data Output Register */

/*! @name PDORF - Port Data Output Register */

/*! @name PDORG - Port Data Output Register */

/*! @name PDORH - Port Data Output Register */

/*! @name PSOR - Port Set Output Register */

/*! @name PSORE - Port Set Output Register */

/*! @name PSORF - Port Set Output Register */

/*! @name PSORG - Port Set Output Register */

/*! @name PSORH - Port Set Output Register */

/*! @name PCOR - Port Clear Output Register */

/*! @name PCORE - Port Clear Output Register */

/*! @name PCORF - Port Clear Output Register */

/*! @name PCORG - Port Clear Output Register */

/*! @name PCORH - Port Clear Output Register */

/*! @name PTOR - Port Toggle Output Register */

/*! @name PTORE - Port Toggle Output Register */

/*! @name PTORF - Port Toggle Output Register */

/*! @name PTORG - Port Toggle Output Register */

/*! @name PTORH - Port Toggle Output Register */

/*! @name PDIR - Port Data Input Register */

/*! @name PDIRE - Port Data Input Register */

/*! @name PDIRF - Port Data Input Register */

/*! @name PDIRG - Port Data Input Register */

/*! @name PDIRH - Port Data Input Register */

/*! @name PDDR - Port Data Direction Register */

/*! @name PDDRE - Port Data Direction Register */

/*! @name PDDRF - Port Data Direction Register */

/*! @name PDDRG - Port Data Direction Register */

/*! @name PDDRH - Port Data Direction Register */

/*! @name PIDR - Port Input Disable Register */

/*! @name PIDRE - Port Input Disable Register */

/*! @name PIDRF - Port Input Disable Register */

/*! @name PIDRG - Port Input Disable Register */

/*! @name PIDRH - Port Input Disable Register */
/**
...
/*! @name PDORI - Port Data Output Register */

/*! @name PSOR - Port Set Output Register */

/*! @name PSORI - Port Set Output Register */

/*! @name PCOR - Port Clear Output Register */

/*! @name PCORI - Port Clear Output Register */

/*! @name PTOR - Port Toggle Output Register */

/*! @name PTORI - Port Toggle Output Register */

/*! @name PDIR - Port Data Input Register */

/*! @name PDIRI - Port Data Input Register */

/*! @name PDDR - Port Data Direction Register */

/*! @name PDDRI - Port Data Direction Register */

/*! @name PIDR - Port Input Disable Register */

/*! @name PIDRI - Port Input Disable Register */
/**
...
/*! @name FCCOB - Flash Common Command Object Register (FCCOBLO:FCCOBHI)  */
...
#define FTMRE_FPROT_FPHS_MASK                    (0x18U)                                             /*!< FTMRE_FPROT.FPHS Mask                   */
#define FTMRE_FPROT_FPHS_SHIFT                   (3U)                                                /*!< FTMRE_FPROT.FPHS Position               */
#define FTMRE_FPROT_FPHS(x)                      (((uint8_t)(((uint8_t)(x))<<FTMRE_FPROT_FPHS_SHIFT))&FTMRE_FPROT_FPHS_MASK) /*!< FTMRE_FPROT.FPHS Field                  */
#define FTMRE_FPROT_FPHDIS_MASK                  (0x20U)                                             /*!< FTMRE_FPROT.FPHDIS Mask                 */
#define FTMRE_FPROT_FPHDIS_SHIFT                 (5U)                                                /*!< FTMRE_FPROT.FPHDIS Position             */
#define FTMRE_FPROT_FPHDIS(x)                    (((uint8_t)(((uint8_t)(x))<<FTMRE_FPROT_FPHDIS_SHIFT))&FTMRE_FPROT_FPHDIS_MASK) /*!< FTMRE_FPROT.FPHDIS Field                */
...
#define KBI0_PE_KBIPE(x)                         (((uint32_t)(((uint32_t)(x))<<KBI0_PE_KBIPE_SHIFT))&KBI0_PE_KBIPE_MASK) /*!< KBI0_PE.KBIPE Field                     */
...
#define KBI0_ES_KBEDG(x)                         (((uint32_t)(((uint32_t)(x))<<KBI0_ES_KBEDG_SHIFT))&KBI0_ES_KBEDG_MASK) /*!< KBI0_ES.KBEDG Field                     */
...
#define KBI0_SC_KBMOD(x)                         (((uint32_t)(((uint32_t)(x))<<KBI0_SC_KBMOD_SHIFT))&KBI0_SC_KBMOD_MASK) /*!< KBI0_SC.KBMOD Field                     */
#define KBI0_SC_KBIE_MASK                        (0x2U)                                              /*!< KBI0_SC.KBIE Mask                       */
#define KBI0_SC_KBIE_SHIFT                       (1U)                                                /*!< KBI0_SC.KBIE Position                   */
#define KBI0_SC_KBIE(x)                          (((uint32_t)(((uint32_t)(x))<<KBI0_SC_KBIE_SHIFT))&KBI0_SC_KBIE_MASK) /*!< KBI0_SC.KBIE Field                      */
#define KBI0_SC_KBACK_MASK                       (0x4U)                                              /*!< KBI0_SC.KBACK Mask                      */
#define KBI0_SC_KBACK_SHIFT                      (2U)                                                /*!< KBI0_SC.KBACK Position                  */
#define KBI0_SC_KBACK(x)                         (((uint32_t)(((uint32_t)(x))<<KBI0_SC_KBACK_SHIFT))&KBI0_SC_KBACK_MASK) /*!< KBI0_SC.KBACK Field                     */
#define KBI0_SC_KBF_MASK                         (0x8U)                                              /*!< KBI0_SC.KBF Mask                        */
#define KBI0_SC_KBF_SHIFT                        (3U)                                                /*!< KBI0_SC.KBF Position                    */
#define KBI0_SC_KBF(x)                           (((uint32_t)(((uint32_t)(x))<<KBI0_SC_KBF_SHIFT))&KBI0_SC_KBF_MASK) /*!< KBI0_SC.KBF Field                       */
#define KBI0_SC_KBSPEN_MASK                      (0x10U)                                             /*!< KBI0_SC.KBSPEN Mask                     */
#define KBI0_SC_KBSPEN_SHIFT                     (4U)                                                /*!< KBI0_SC.KBSPEN Position                 */
#define KBI0_SC_KBSPEN(x)                        (((uint32_t)(((uint32_t)(x))<<KBI0_SC_KBSPEN_SHIFT))&KBI0_SC_KBSPEN_MASK) /*!< KBI0_SC.KBSPEN Field                    */
#define KBI0_SC_RSTKBSP_MASK                     (0x20U)                                             /*!< KBI0_SC.RSTKBSP Mask                    */
#define KBI0_SC_RSTKBSP_SHIFT                    (5U)                                                /*!< KBI0_SC.RSTKBSP Position                */
#define KBI0_SC_RSTKBSP(x)                       (((uint32_t)(((uint32_t)(x))<<KBI0_SC_RSTKBSP_SHIFT))&KBI0_SC_RSTKBSP_MASK) /*!< KBI0_SC.RSTKBSP Field                   */
...
#define PORT_IOFLT0_FLTA_MASK                    (0x3U)                                              /*!< PORT_IOFLT0.FLTA Mask                   */
#define PORT_IOFLT0_FLTA_SHIFT                   (0U)                                                /*!< PORT_IOFLT0.FLTA Position               */
#define PORT_IOFLT0_FLTA(x)                      (((uint32_t)(((uint32_t)(x))<<PORT_IOFLT0_FLTA_SHIFT))&PORT_IOFLT0_FLTA_MASK) /*!< PORT_IOFLT0.FLTA Field                  */
#define PORT_IOFLT0_FLTB_MASK                    (0xCU)                                              /*!< PORT_IOFLT0.FLTB Mask                   */
#define PORT_IOFLT0_FLTB_SHIFT                   (2U)                                                /*!< PORT_IOFLT0.FLTB Position               */
#define PORT_IOFLT0_FLTB(x)                      (((uint32_t)(((uint32_t)(x))<<PORT_IOFLT0_FLTB_SHIFT))&PORT_IOFLT0_FLTB_MASK) /*!< PORT_IOFLT0.FLTB Field                  */
#define PORT_IOFLT0_FLTC_MASK                    (0x30U)                                             /*!< PORT_IOFLT0.FLTC Mask                   */
#define PORT_IOFLT0_FLTC_SHIFT                   (4U)                                                /*!< PORT_IOFLT0.FLTC Position               */
#define PORT_IOFLT0_FLTC(x)                      (((uint32_t)(((uint32_t)(x))<<PORT_IOFLT0_FLTC_SHIFT))&PORT_IOFLT0_FLTC_MASK) /*!< PORT_IOFLT0.FLTC Field                  */
#define PORT_IOFLT0_FLTD_MASK                    (0xC0U)                                             /*!< PORT_IOFLT0.FLTD Mask                   */
#define PORT_IOFLT0_FLTD_SHIFT                   (6U)                                                /*!< PORT_IOFLT0.FLTD Position               */
#define PORT_IOFLT0_FLTD(x)                      (((uint32_t)(((uint32_t)(x))<<PORT_IOFLT0_FLTD_SHIFT))&PORT_IOFLT0_FLTD_MASK) /*!< PORT_IOFLT0.FLTD Field                  */
#define PORT_IOFLT0_FLTE_MASK                    (0x300U)                                            /*!< PORT_IOFLT0.FLTE Mask                   */
#define PORT_IOFLT0_FLTE_SHIFT                   (8U)                                                /*!< PORT_IOFLT0.FLTE Position               */
#define PORT_IOFLT0_FLTE(x)                      (((uint32_t)(((uint32_t)(x))<<PORT_IOFLT0_FLTE_SHIFT))&PORT_IOFLT0_FLTE_MASK) /*!< PORT_IOFLT0.FLTE Field                  */
#define PORT_IOFLT0_FLTF_MASK                    (0xC00U)                                            /*!< PORT_IOFLT0.FLTF Mask                   */
#define PORT_IOFLT0_FLTF_SHIFT                   (10U)                                               /*!< PORT_IOFLT0.FLTF Position               */
#define PORT_IOFLT0_FLTF(x)                      (((uint32_t)(((uint32_t)(x))<<PORT_IOFLT0_FLTF_SHIFT))&PORT_IOFLT0_FLTF_MASK) /*!< PORT_IOFLT0.FLTF Field                  */
#define PORT_IOFLT0_FLTG_MASK                    (0x3000U)                                           /*!< PORT_IOFLT0.FLTG Mask                   */
#define PORT_IOFLT0_FLTG_SHIFT                   (12U)                                               /*!< PORT_IOFLT0.FLTG Position               */
#define PORT_IOFLT0_FLTG(x)                      (((uint32_t)(((uint32_t)(x))<<PORT_IOFLT0_FLTG_SHIFT))&PORT_IOFLT0_FLTG_MASK) /*!< PORT_IOFLT0.FLTG Field                  */
#define PORT_IOFLT0_FLTH_MASK                    (0xC000U)                                           /*!< PORT_IOFLT0.FLTH Mask                   */
#define PORT_IOFLT0_FLTH_SHIFT                   (14U)                                               /*!< PORT_IOFLT0.FLTH Position               */
#define PORT_IOFLT0_FLTH(x)                      (((uint32_t)(((uint32_t)(x))<<PORT_IOFLT0_FLTH_SHIFT))&PORT_IOFLT0_FLTH_MASK) /*!< PORT_IOFLT0.FLTH Field                  */
#define PORT_IOFLT0_FLTRST_MASK                  (0x30000U)                                          /*!< PORT_IOFLT0.FLTRST Mask                 */
#define PORT_IOFLT0_FLTRST_SHIFT                 (16U)                                               /*!< PORT_IOFLT0.FLTRST Position             */
#define PORT_IOFLT0_FLTRST(x)                    (((uint32_t)(((uint32_t)(x))<<PORT_IOFLT0_FLTRST_SHIFT))&PORT_IOFLT0_FLTRST_MASK) /*!< PORT_IOFLT0.FLTRST Field                */
#define PORT_IOFLT0_FLTKBI0_MASK                 (0xC0000U)                                          /*!< PORT_IOFLT0.FLTKBI0 Mask                */
#define PORT_IOFLT0_FLTKBI0_SHIFT                (18U)                                               /*!< PORT_IOFLT0.FLTKBI0 Position            */
#define PORT_IOFLT0_FLTKBI0(x)                   (((uint32_t)(((uint32_t)(x))<<PORT_IOFLT0_FLTKBI0_SHIFT))&PORT_IOFLT0_FLTKBI0_MASK) /*!< PORT_IOFLT0.FLTKBI0 Field               */
#define PORT_IOFLT0_FLTKBI1_MASK                 (0x300000U)                                         /*!< PORT_IOFLT0.FLTKBI1 Mask                */
#define PORT_IOFLT0_FLTKBI1_SHIFT                (20U)                                               /*!< PORT_IOFLT0.FLTKBI1 Position            */
#define PORT_IOFLT0_FLTKBI1(x)                   (((uint32_t)(((uint32_t)(x))<<PORT_IOFLT0_FLTKBI1_SHIFT))&PORT_IOFLT0_FLTKBI1_MASK) /*!< PORT_IOFLT0.FLTKBI1 Field               */
#define PORT_IOFLT0_FLTNMI_MASK                  (0xC00000U)                                         /*!< PORT_IOFLT0.FLTNMI Mask                 */
#define PORT_IOFLT0_FLTNMI_SHIFT                 (22U)                                               /*!< PORT_IOFLT0.FLTNMI Position             */
#define PORT_IOFLT0_FLTNMI(x)                    (((uint32_t)(((uint32_t)(x))<<PORT_IOFLT0_FLTNMI_SHIFT))&PORT_IOFLT0_FLTNMI_MASK) /*!< PORT_IOFLT0.FLTNMI Field                */
#define PORT_IOFLT0_FLTDIV1_MASK                 (0x3000000U)                                        /*!< PORT_IOFLT0.FLTDIV1 Mask                */
#define PORT_IOFLT0_FLTDIV1_SHIFT                (24U)                                               /*!< PORT_IOFLT0.FLTDIV1 Position            */
#define PORT_IOFLT0_FLTDIV1(x)                   (((uint32_t)(((uint32_t)(x))<<PORT_IOFLT0_FLTDIV1_SHIFT))&PORT_IOFLT0_FLTDIV1_MASK) /*!< PORT_IOFLT0.FLTDIV1 Field               */
#define PORT_IOFLT0_FLTDIV2_MASK                 (0x1C000000U)                                       /*!< PORT_IOFLT0.FLTDIV2 Mask                */
#define PORT_IOFLT0_FLTDIV2_SHIFT                (26U)                                               /*!< PORT_IOFLT0.FLTDIV2 Position            */
#define PORT_IOFLT0_FLTDIV2(x)                   (((uint32_t)(((uint32_t)(x))<<PORT_IOFLT0_FLTDIV2_SHIFT))&PORT_IOFLT0_FLTDIV2_MASK) /*!< PORT_IOFLT0.FLTDIV2 Field               */
#define PORT_IOFLT0_FLTDIV3_MASK                 (0xE0000000U)                                       /*!< PORT_IOFLT0.FLTDIV3 Mask                */
#define PORT_IOFLT0_FLTDIV3_SHIFT                (29U)                                               /*!< PORT_IOFLT0.FLTDIV3 Position            */
#define PORT_IOFLT0_FLTDIV3(x)                   (((uint32_t)(((uint32_t)(x))<<PORT_IOFLT0_FLTDIV3_SHIFT))&PORT_IOFLT0_FLTDIV3_MASK) /*!< PORT_IOFLT0.FLTDIV3 Field               */

/*! @name IOFLT1 - Port Filter Register 1 */
#define PORT_IOFLT1_FLTI_MASK                    (0x3U)                                              /*!< PORT_IOFLT1.FLTI Mask                   */
#define PORT_IOFLT1_FLTI_SHIFT                   (0U)                                                /*!< PORT_IOFLT1.FLTI Position               */
#define PORT_IOFLT1_FLTI(x)                      (((uint32_t)(((uint32_t)(x))<<PORT_IOFLT1_FLTI_SHIFT))&PORT_IOFLT1_FLTI_MASK) /*!< PORT_IOFLT1.FLTI Field                  */
#define PORT_IOFLT1_FLTIRQ_MASK                  (0x30U)                                             /*!< PORT_IOFLT1.FLTIRQ Mask                 */
#define PORT_IOFLT1_FLTIRQ_SHIFT                 (4U)                                                /*!< PORT_IOFLT1.FLTIRQ Position             */
#define PORT_IOFLT1_FLTIRQ(x)                    (((uint32_t)(((uint32_t)(x))<<PORT_IOFLT1_FLTIRQ_SHIFT))&PORT_IOFLT1_FLTIRQ_MASK) /*!< PORT_IOFLT1.FLTIRQ Field                */
#define PORT_IOFLT1_FLTFTM0_MASK                 (0xC0U)                                             /*!< PORT_IOFLT1.FLTFTM0 Mask                */
#define PORT_IOFLT1_FLTFTM0_SHIFT                (6U)                                                /*!< PORT_IOFLT1.FLTFTM0 Position            */
#define PORT_IOFLT1_FLTFTM0(x)                   (((uint32_t)(((uint32_t)(x))<<PORT_IOFLT1_FLTFTM0_SHIFT))&PORT_IOFLT1_FLTFTM0_MASK) /*!< PORT_IOFLT1.FLTFTM0 Field               */
#define PORT_IOFLT1_FLTFTM1_MASK                 (0x300U)                                            /*!< PORT_IOFLT1.FLTFTM1 Mask                */
#define PORT_IOFLT1_FLTFTM1_SHIFT                (8U)                                                /*!< PORT_IOFLT1.FLTFTM1 Position            */
#define PORT_IOFLT1_FLTFTM1(x)                   (((uint32_t)(((uint32_t)(x))<<PORT_IOFLT1_FLTFTM1_SHIFT))&PORT_IOFLT1_FLTFTM1_MASK) /*!< PORT_IOFLT1.FLTFTM1 Field               */
#define PORT_IOFLT1_FLTPWT_MASK                  (0xC00U)                                            /*!< PORT_IOFLT1.FLTPWT Mask                 */
#define PORT_IOFLT1_FLTPWT_SHIFT                 (10U)                                               /*!< PORT_IOFLT1.FLTPWT Position             */
#define PORT_IOFLT1_FLTPWT(x)                    (((uint32_t)(((uint32_t)(x))<<PORT_IOFLT1_FLTPWT_SHIFT))&PORT_IOFLT1_FLTPWT_MASK) /*!< PORT_IOFLT1.FLTPWT Field                */
#define PORT_IOFLT1_FLTI2C0_MASK                 (0x3000U)                                           /*!< PORT_IOFLT1.FLTI2C0 Mask                */
#define PORT_IOFLT1_FLTI2C0_SHIFT                (12U)                                               /*!< PORT_IOFLT1.FLTI2C0 Position            */
#define PORT_IOFLT1_FLTI2C0(x)                   (((uint32_t)(((uint32_t)(x))<<PORT_IOFLT1_FLTI2C0_SHIFT))&PORT_IOFLT1_FLTI2C0_MASK) /*!< PORT_IOFLT1.FLTI2C0 Field               */
#define PORT_IOFLT1_FLTI2C1_MASK                 (0xC000U)                                           /*!< PORT_IOFLT1.FLTI2C1 Mask                */
#define PORT_IOFLT1_FLTI2C1_SHIFT                (14U)                                               /*!< PORT_IOFLT1.FLTI2C1 Position            */
#define PORT_IOFLT1_FLTI2C1(x)                   (((uint32_t)(((uint32_t)(x))<<PORT_IOFLT1_FLTI2C1_SHIFT))&PORT_IOFLT1_FLTI2C1_MASK) /*!< PORT_IOFLT1.FLTI2C1 Field               */

/*! @name PUE0 - Port Pull-up Enable Register 0 */
#define PORT_PUE0_PTAPE_MASK                     (0xFFU)                                             /*!< PORT_PUE0.PTAPE Mask                    */
#define PORT_PUE0_PTAPE_SHIFT                    (0U)                                                /*!< PORT_PUE0.PTAPE Position                */
#define PORT_PUE0_PTAPE(x)                       (((uint32_t)(((uint32_t)(x))<<PORT_PUE0_PTAPE_SHIFT))&PORT_PUE0_PTAPE_MASK) /*!< PORT_PUE0.PTAPE Field                   */
#define PORT_PUE0_PTBPE_MASK                     (0xFF00U)                                           /*!< PORT_PUE0.PTBPE Mask                    */
#define PORT_PUE0_PTBPE_SHIFT                    (8U)                                                /*!< PORT_PUE0.PTBPE Position                */
#define PORT_PUE0_PTBPE(x)                       (((uint32_t)(((uint32_t)(x))<<PORT_PUE0_PTBPE_SHIFT))&PORT_PUE0_PTBPE_MASK) /*!< PORT_PUE0.PTBPE Field                   */
#define PORT_PUE0_PTCPE_MASK                     (0xFF0000U)                                         /*!< PORT_PUE0.PTCPE Mask                    */
#define PORT_PUE0_PTCPE_SHIFT                    (16U)                                               /*!< PORT_PUE0.PTCPE Position                */
#define PORT_PUE0_PTCPE(x)                       (((uint32_t)(((uint32_t)(x))<<PORT_PUE0_PTCPE_SHIFT))&PORT_PUE0_PTCPE_MASK) /*!< PORT_PUE0.PTCPE Field                   */
#define PORT_PUE0_PTDPE_MASK                     (0xFF000000U)                                       /*!< PORT_PUE0.PTDPE Mask                    */
#define PORT_PUE0_PTDPE_SHIFT                    (24U)                                               /*!< PORT_PUE0.PTDPE Position                */
#define PORT_PUE0_PTDPE(x)                       (((uint32_t)(((uint32_t)(x))<<PORT_PUE0_PTDPE_SHIFT))&PORT_PUE0_PTDPE_MASK) /*!< PORT_PUE0.PTDPE Field                   */

/*! @name PUE1 - Port Pull-up Enable Register 1 */
#define PORT_PUE1_PTEPE_MASK                     (0xFFU)                                             /*!< PORT_PUE1.PTEPE Mask                    */
#define PORT_PUE1_PTEPE_SHIFT                    (0U)                                                /*!< PORT_PUE1.PTEPE Position                */
#define PORT_PUE1_PTEPE(x)                       (((uint32_t)(((uint32_t)(x))<<PORT_PUE1_PTEPE_SHIFT))&PORT_PUE1_PTEPE_MASK) /*!< PORT_PUE1.PTEPE Field                   */
#define PORT_PUE1_PTFPE_MASK                     (0xFF00U)                                           /*!< PORT_PUE1.PTFPE Mask                    */
#define PORT_PUE1_PTFPE_SHIFT                    (8U)                                                /*!< PORT_PUE1.PTFPE Position                */
#define PORT_PUE1_PTFPE(x)                       (((uint32_t)(((uint32_t)(x))<<PORT_PUE1_PTFPE_SHIFT))&PORT_PUE1_PTFPE_MASK) /*!< PORT_PUE1.PTFPE Field                   */
#define PORT_PUE1_PTGPE_MASK                     (0xFF0000U)                                         /*!< PORT_PUE1.PTGPE Mask                    */
#define PORT_PUE1_PTGPE_SHIFT                    (16U)                                               /*!< PORT_PUE1.PTGPE Position                */
#define PORT_PUE1_PTGPE(x)                       (((uint32_t)(((uint32_t)(x))<<PORT_PUE1_PTGPE_SHIFT))&PORT_PUE1_PTGPE_MASK) /*!< PORT_PUE1.PTGPE Field                   */
#define PORT_PUE1_PTHPE_MASK                     (0xFF000000U)                                       /*!< PORT_PUE1.PTHPE Mask                    */
#define PORT_PUE1_PTHPE_SHIFT                    (24U)                                               /*!< PORT_PUE1.PTHPE Position                */
#define PORT_PUE1_PTHPE(x)                       (((uint32_t)(((uint32_t)(x))<<PORT_PUE1_PTHPE_SHIFT))&PORT_PUE1_PTHPE_MASK) /*!< PORT_PUE1.PTHPE Field                   */

/*! @name PUE2 - Port Pull-up Enable High Register */
#define PORT_PUE2_PTIPE_MASK                     (0x7FU)                                             /*!< PORT_PUE2.PTIPE Mask                    */
#define PORT_PUE2_PTIPE_SHIFT                    (0U)                                                /*!< PORT_PUE2.PTIPE Position                */
#define PORT_PUE2_PTIPE(x)                       (((uint32_t)(((uint32_t)(x))<<PORT_PUE2_PTIPE_SHIFT))&PORT_PUE2_PTIPE_MASK) /*!< PORT_PUE2.PTIPE Field                   */
...
/*! @name MOD - Modulo Register: Contains the modulo value used to reset the count to 0x0000 upon a compare match and set SC[RTIF] status field */
...
/*! @name CNT - Counter Register: Reset or writing different values to SC[RTCLKS] and SC[RTCPS] clear the count to 0x0000 */
...
#define SIM_SOPT0_NMIE_MASK                      (0x2U)                                              /*!< SIM_SOPT0.NMIE Mask                     */
#define SIM_SOPT0_NMIE_SHIFT                     (1U)                                                /*!< SIM_SOPT0.NMIE Position                 */
#define SIM_SOPT0_NMIE(x)                        (((uint32_t)(((uint32_t)(x))<<SIM_SOPT0_NMIE_SHIFT))&SIM_SOPT0_NMIE_MASK) /*!< SIM_SOPT0.NMIE Field                    */
#define SIM_SOPT0_RSTPE_MASK                     (0x4U)                                              /*!< SIM_SOPT0.RSTPE Mask                    */
#define SIM_SOPT0_RSTPE_SHIFT                    (2U)                                                /*!< SIM_SOPT0.RSTPE Position                */
#define SIM_SOPT0_RSTPE(x)                       (((uint32_t)(((uint32_t)(x))<<SIM_SOPT0_RSTPE_SHIFT))&SIM_SOPT0_RSTPE_MASK) /*!< SIM_SOPT0.RSTPE Field                   */
#define SIM_SOPT0_SWDE_MASK                      (0x8U)                                              /*!< SIM_SOPT0.SWDE Mask                     */
#define SIM_SOPT0_SWDE_SHIFT                     (3U)                                                /*!< SIM_SOPT0.SWDE Position                 */
#define SIM_SOPT0_SWDE(x)                        (((uint32_t)(((uint32_t)(x))<<SIM_SOPT0_SWDE_SHIFT))&SIM_SOPT0_SWDE_MASK) /*!< SIM_SOPT0.SWDE Field                    */
#define SIM_SOPT0_ACTRG_MASK                     (0x20U)                                             /*!< SIM_SOPT0.ACTRG Mask                    */
#define SIM_SOPT0_ACTRG_SHIFT                    (5U)                                                /*!< SIM_SOPT0.ACTRG Position                */
#define SIM_SOPT0_ACTRG(x)                       (((uint32_t)(((uint32_t)(x))<<SIM_SOPT0_ACTRG_SHIFT))&SIM_SOPT0_ACTRG_MASK) /*!< SIM_SOPT0.ACTRG Field                   */
#define SIM_SOPT0_RXDFE_MASK                     (0x300U)                                            /*!< SIM_SOPT0.RXDFE Mask                    */
#define SIM_SOPT0_RXDFE_SHIFT                    (8U)                                                /*!< SIM_SOPT0.RXDFE Position                */
#define SIM_SOPT0_RXDFE(x)                       (((uint32_t)(((uint32_t)(x))<<SIM_SOPT0_RXDFE_SHIFT))&SIM_SOPT0_RXDFE_MASK) /*!< SIM_SOPT0.RXDFE Field                   */
#define SIM_SOPT0_RTCC_MASK                      (0x400U)                                            /*!< SIM_SOPT0.RTCC Mask                     */
#define SIM_SOPT0_RTCC_SHIFT                     (10U)                                               /*!< SIM_SOPT0.RTCC Position                 */
#define SIM_SOPT0_RTCC(x)                        (((uint32_t)(((uint32_t)(x))<<SIM_SOPT0_RTCC_SHIFT))&SIM_SOPT0_RTCC_MASK) /*!< SIM_SOPT0.RTCC Field                    */
#define SIM_SOPT0_ACIC_MASK                      (0x800U)                                            /*!< SIM_SOPT0.ACIC Mask                     */
#define SIM_SOPT0_ACIC_SHIFT                     (11U)                                               /*!< SIM_SOPT0.ACIC Position                 */
#define SIM_SOPT0_ACIC(x)                        (((uint32_t)(((uint32_t)(x))<<SIM_SOPT0_ACIC_SHIFT))&SIM_SOPT0_ACIC_MASK) /*!< SIM_SOPT0.ACIC Field                    */
#define SIM_SOPT0_RXDCE_MASK                     (0x1000U)                                           /*!< SIM_SOPT0.RXDCE Mask                    */
#define SIM_SOPT0_RXDCE_SHIFT                    (12U)                                               /*!< SIM_SOPT0.RXDCE Position                */
#define SIM_SOPT0_RXDCE(x)                       (((uint32_t)(((uint32_t)(x))<<SIM_SOPT0_RXDCE_SHIFT))&SIM_SOPT0_RXDCE_MASK) /*!< SIM_SOPT0.RXDCE Field                   */
#define SIM_SOPT0_FTMSYNC_MASK                   (0x4000U)                                           /*!< SIM_SOPT0.FTMSYNC Mask                  */
#define SIM_SOPT0_FTMSYNC_SHIFT                  (14U)                                               /*!< SIM_SOPT0.FTMSYNC Position              */
#define SIM_SOPT0_FTMSYNC(x)                     (((uint32_t)(((uint32_t)(x))<<SIM_SOPT0_FTMSYNC_SHIFT))&SIM_SOPT0_FTMSYNC_MASK) /*!< SIM_SOPT0.FTMSYNC Field                 */
#define SIM_SOPT0_TXDME_MASK                     (0x8000U)                                           /*!< SIM_SOPT0.TXDME Mask                    */
#define SIM_SOPT0_TXDME_SHIFT                    (15U)                                               /*!< SIM_SOPT0.TXDME Position                */
#define SIM_SOPT0_TXDME(x)                       (((uint32_t)(((uint32_t)(x))<<SIM_SOPT0_TXDME_SHIFT))&SIM_SOPT0_TXDME_MASK) /*!< SIM_SOPT0.TXDME Field                   */
#define SIM_SOPT0_BUSREF_MASK                    (0x70000U)                                          /*!< SIM_SOPT0.BUSREF Mask                   */
#define SIM_SOPT0_BUSREF_SHIFT                   (16U)                                               /*!< SIM_SOPT0.BUSREF Position               */
#define SIM_SOPT0_BUSREF(x)                      (((uint32_t)(((uint32_t)(x))<<SIM_SOPT0_BUSREF_SHIFT))&SIM_SOPT0_BUSREF_MASK) /*!< SIM_SOPT0.BUSREF Field                  */
#define SIM_SOPT0_CLKOE_MASK                     (0x80000U)                                          /*!< SIM_SOPT0.CLKOE Mask                    */
#define SIM_SOPT0_CLKOE_SHIFT                    (19U)                                               /*!< SIM_SOPT0.CLKOE Position                */
#define SIM_SOPT0_CLKOE(x)                       (((uint32_t)(((uint32_t)(x))<<SIM_SOPT0_CLKOE_SHIFT))&SIM_SOPT0_CLKOE_MASK) /*!< SIM_SOPT0.CLKOE Field                   */
#define SIM_SOPT0_ADHWT_MASK                     (0x700000U)                                         /*!< SIM_SOPT0.ADHWT Mask                    */
#define SIM_SOPT0_ADHWT_SHIFT                    (20U)                                               /*!< SIM_SOPT0.ADHWT Position                */
#define SIM_SOPT0_ADHWT(x)                       (((uint32_t)(((uint32_t)(x))<<SIM_SOPT0_ADHWT_SHIFT))&SIM_SOPT0_ADHWT_MASK) /*!< SIM_SOPT0.ADHWT Field                   */
#define SIM_SOPT0_DLYACT_MASK                    (0x800000U)                                         /*!< SIM_SOPT0.DLYACT Mask                   */
#define SIM_SOPT0_DLYACT_SHIFT                   (23U)                                               /*!< SIM_SOPT0.DLYACT Position               */
#define SIM_SOPT0_DLYACT(x)                      (((uint32_t)(((uint32_t)(x))<<SIM_SOPT0_DLYACT_SHIFT))&SIM_SOPT0_DLYACT_MASK) /*!< SIM_SOPT0.DLYACT Field                  */
#define SIM_SOPT0_DELAY_MASK                     (0xFF000000U)                                       /*!< SIM_SOPT0.DELAY Mask                    */
#define SIM_SOPT0_DELAY_SHIFT                    (24U)                                               /*!< SIM_SOPT0.DELAY Position                */
#define SIM_SOPT0_DELAY(x)                       (((uint32_t)(((uint32_t)(x))<<SIM_SOPT0_DELAY_SHIFT))&SIM_SOPT0_DELAY_MASK) /*!< SIM_SOPT0.DELAY Field                   */

/*! @name SOPT1 - System Options Register 1 */
#define SIM_SOPT1_I2C04WEN_MASK                  (0x1U)                                              /*!< SIM_SOPT1.I2C04WEN Mask                 */
#define SIM_SOPT1_I2C04WEN_SHIFT                 (0U)                                                /*!< SIM_SOPT1.I2C04WEN Position             */
#define SIM_SOPT1_I2C04WEN(x)                    (((uint32_t)(((uint32_t)(x))<<SIM_SOPT1_I2C04WEN_SHIFT))&SIM_SOPT1_I2C04WEN_MASK) /*!< SIM_SOPT1.I2C04WEN Field                */
#define SIM_SOPT1_I2C0OINV_MASK                  (0x2U)                                              /*!< SIM_SOPT1.I2C0OINV Mask                 */
#define SIM_SOPT1_I2C0OINV_SHIFT                 (1U)                                                /*!< SIM_SOPT1.I2C0OINV Position             */
#define SIM_SOPT1_I2C0OINV(x)                    (((uint32_t)(((uint32_t)(x))<<SIM_SOPT1_I2C0OINV_SHIFT))&SIM_SOPT1_I2C0OINV_MASK) /*!< SIM_SOPT1.I2C0OINV Field                */
#define SIM_SOPT1_ACPWTS_MASK                    (0x8U)                                              /*!< SIM_SOPT1.ACPWTS Mask                   */
#define SIM_SOPT1_ACPWTS_SHIFT                   (3U)                                                /*!< SIM_SOPT1.ACPWTS Position               */
#define SIM_SOPT1_ACPWTS(x)                      (((uint32_t)(((uint32_t)(x))<<SIM_SOPT1_ACPWTS_SHIFT))&SIM_SOPT1_ACPWTS_MASK) /*!< SIM_SOPT1.ACPWTS Field                  */
#define SIM_SOPT1_UARTPWTS_MASK                  (0x30U)                                             /*!< SIM_SOPT1.UARTPWTS Mask                 */
#define SIM_SOPT1_UARTPWTS_SHIFT                 (4U)                                                /*!< SIM_SOPT1.UARTPWTS Position             */
#define SIM_SOPT1_UARTPWTS(x)                    (((uint32_t)(((uint32_t)(x))<<SIM_SOPT1_UARTPWTS_SHIFT))&SIM_SOPT1_UARTPWTS_MASK) /*!< SIM_SOPT1.UARTPWTS Field                */

/*! @name PINSEL0 - Pin Selection Register 0 */
#define SIM_PINSEL0_IRQPS_MASK                   (0x7U)                                              /*!< SIM_PINSEL0.IRQPS Mask                  */
#define SIM_PINSEL0_IRQPS_SHIFT                  (0U)                                                /*!< SIM_PINSEL0.IRQPS Position              */
#define SIM_PINSEL0_IRQPS(x)                     (((uint32_t)(((uint32_t)(x))<<SIM_PINSEL0_IRQPS_SHIFT))&SIM_PINSEL0_IRQPS_MASK) /*!< SIM_PINSEL0.IRQPS Field                 */
#define SIM_PINSEL0_RTCPS_MASK                   (0x10U)                                             /*!< SIM_PINSEL0.RTCPS Mask                  */
#define SIM_PINSEL0_RTCPS_SHIFT                  (4U)                                                /*!< SIM_PINSEL0.RTCPS Position              */
#define SIM_PINSEL0_RTCPS(x)                     (((uint32_t)(((uint32_t)(x))<<SIM_PINSEL0_RTCPS_SHIFT))&SIM_PINSEL0_RTCPS_MASK) /*!< SIM_PINSEL0.RTCPS Field                 */
#define SIM_PINSEL0_I2C0PS_MASK                  (0x20U)                                             /*!< SIM_PINSEL0.I2C0PS Mask                 */
#define SIM_PINSEL0_I2C0PS_SHIFT                 (5U)                                                /*!< SIM_PINSEL0.I2C0PS Position             */
#define SIM_PINSEL0_I2C0PS(x)                    (((uint32_t)(((uint32_t)(x))<<SIM_PINSEL0_I2C0PS_SHIFT))&SIM_PINSEL0_I2C0PS_MASK) /*!< SIM_PINSEL0.I2C0PS Field                */
#define SIM_PINSEL0_SPI0PS_MASK                  (0x40U)                                             /*!< SIM_PINSEL0.SPI0PS Mask                 */
#define SIM_PINSEL0_SPI0PS_SHIFT                 (6U)                                                /*!< SIM_PINSEL0.SPI0PS Position             */
#define SIM_PINSEL0_SPI0PS(x)                    (((uint32_t)(((uint32_t)(x))<<SIM_PINSEL0_SPI0PS_SHIFT))&SIM_PINSEL0_SPI0PS_MASK) /*!< SIM_PINSEL0.SPI0PS Field                */
#define SIM_PINSEL0_UART0PS_MASK                 (0x80U)                                             /*!< SIM_PINSEL0.UART0PS Mask                */
#define SIM_PINSEL0_UART0PS_SHIFT                (7U)                                                /*!< SIM_PINSEL0.UART0PS Position            */
#define SIM_PINSEL0_UART0PS(x)                   (((uint32_t)(((uint32_t)(x))<<SIM_PINSEL0_UART0PS_SHIFT))&SIM_PINSEL0_UART0PS_MASK) /*!< SIM_PINSEL0.UART0PS Field               */
#define SIM_PINSEL0_FTM0PS0_MASK                 (0x100U)                                            /*!< SIM_PINSEL0.FTM0PS0 Mask                */
#define SIM_PINSEL0_FTM0PS0_SHIFT                (8U)                                                /*!< SIM_PINSEL0.FTM0PS0 Position            */
#define SIM_PINSEL0_FTM0PS0(x)                   (((uint32_t)(((uint32_t)(x))<<SIM_PINSEL0_FTM0PS0_SHIFT))&SIM_PINSEL0_FTM0PS0_MASK) /*!< SIM_PINSEL0.FTM0PS0 Field               */
#define SIM_PINSEL0_FTM0PS1_MASK                 (0x200U)                                            /*!< SIM_PINSEL0.FTM0PS1 Mask                */
#define SIM_PINSEL0_FTM0PS1_SHIFT                (9U)                                                /*!< SIM_PINSEL0.FTM0PS1 Position            */
#define SIM_PINSEL0_FTM0PS1(x)                   (((uint32_t)(((uint32_t)(x))<<SIM_PINSEL0_FTM0PS1_SHIFT))&SIM_PINSEL0_FTM0PS1_MASK) /*!< SIM_PINSEL0.FTM0PS1 Field               */
#define SIM_PINSEL0_FTM1PS0_MASK                 (0x400U)                                            /*!< SIM_PINSEL0.FTM1PS0 Mask                */
#define SIM_PINSEL0_FTM1PS0_SHIFT                (10U)                                               /*!< SIM_PINSEL0.FTM1PS0 Position            */
#define SIM_PINSEL0_FTM1PS0(x)                   (((uint32_t)(((uint32_t)(x))<<SIM_PINSEL0_FTM1PS0_SHIFT))&SIM_PINSEL0_FTM1PS0_MASK) /*!< SIM_PINSEL0.FTM1PS0 Field               */
#define SIM_PINSEL0_FTM1PS1_MASK                 (0x800U)                                            /*!< SIM_PINSEL0.FTM1PS1 Mask                */
#define SIM_PINSEL0_FTM1PS1_SHIFT                (11U)                                               /*!< SIM_PINSEL0.FTM1PS1 Position            */
#define SIM_PINSEL0_FTM1PS1(x)                   (((uint32_t)(((uint32_t)(x))<<SIM_PINSEL0_FTM1PS1_SHIFT))&SIM_PINSEL0_FTM1PS1_MASK) /*!< SIM_PINSEL0.FTM1PS1 Field               */
#define SIM_PINSEL0_FTM0CLKPS_MASK               (0x3000000U)                                        /*!< SIM_PINSEL0.FTM0CLKPS Mask              */
#define SIM_PINSEL0_FTM0CLKPS_SHIFT              (24U)                                               /*!< SIM_PINSEL0.FTM0CLKPS Position          */
#define SIM_PINSEL0_FTM0CLKPS(x)                 (((uint32_t)(((uint32_t)(x))<<SIM_PINSEL0_FTM0CLKPS_SHIFT))&SIM_PINSEL0_FTM0CLKPS_MASK) /*!< SIM_PINSEL0.FTM0CLKPS Field             */
#define SIM_PINSEL0_FTM1CLKPS_MASK               (0xC000000U)                                        /*!< SIM_PINSEL0.FTM1CLKPS Mask              */
#define SIM_PINSEL0_FTM1CLKPS_SHIFT              (26U)                                               /*!< SIM_PINSEL0.FTM1CLKPS Position          */
#define SIM_PINSEL0_FTM1CLKPS(x)                 (((uint32_t)(((uint32_t)(x))<<SIM_PINSEL0_FTM1CLKPS_SHIFT))&SIM_PINSEL0_FTM1CLKPS_MASK) /*!< SIM_PINSEL0.FTM1CLKPS Field             */
#define SIM_PINSEL0_FTM2CLKPS_MASK               (0x30000000U)                                       /*!< SIM_PINSEL0.FTM2CLKPS Mask              */
#define SIM_PINSEL0_FTM2CLKPS_SHIFT              (28U)                                               /*!< SIM_PINSEL0.FTM2CLKPS Position          */
#define SIM_PINSEL0_FTM2CLKPS(x)                 (((uint32_t)(((uint32_t)(x))<<SIM_PINSEL0_FTM2CLKPS_SHIFT))&SIM_PINSEL0_FTM2CLKPS_MASK) /*!< SIM_PINSEL0.FTM2CLKPS Field             */
#define SIM_PINSEL0_PWTCLKPS_MASK                (0xC0000000U)                                       /*!< SIM_PINSEL0.PWTCLKPS Mask               */
#define SIM_PINSEL0_PWTCLKPS_SHIFT               (30U)                                               /*!< SIM_PINSEL0.PWTCLKPS Position           */
#define SIM_PINSEL0_PWTCLKPS(x)                  (((uint32_t)(((uint32_t)(x))<<SIM_PINSEL0_PWTCLKPS_SHIFT))&SIM_PINSEL0_PWTCLKPS_MASK) /*!< SIM_PINSEL0.PWTCLKPS Field              */

/*! @name PINSEL1 - Pin Selection Register 1 */
#define SIM_PINSEL1_FTM2PS0_MASK                 (0x3U)                                              /*!< SIM_PINSEL1.FTM2PS0 Mask                */
#define SIM_PINSEL1_FTM2PS0_SHIFT                (0U)                                                /*!< SIM_PINSEL1.FTM2PS0 Position            */
#define SIM_PINSEL1_FTM2PS0(x)                   (((uint32_t)(((uint32_t)(x))<<SIM_PINSEL1_FTM2PS0_SHIFT))&SIM_PINSEL1_FTM2PS0_MASK) /*!< SIM_PINSEL1.FTM2PS0 Field               */
#define SIM_PINSEL1_FTM2PS1_MASK                 (0xCU)                                              /*!< SIM_PINSEL1.FTM2PS1 Mask                */
#define SIM_PINSEL1_FTM2PS1_SHIFT                (2U)                                                /*!< SIM_PINSEL1.FTM2PS1 Position            */
#define SIM_PINSEL1_FTM2PS1(x)                   (((uint32_t)(((uint32_t)(x))<<SIM_PINSEL1_FTM2PS1_SHIFT))&SIM_PINSEL1_FTM2PS1_MASK) /*!< SIM_PINSEL1.FTM2PS1 Field               */
#define SIM_PINSEL1_FTM2PS2_MASK                 (0x30U)                                             /*!< SIM_PINSEL1.FTM2PS2 Mask                */
#define SIM_PINSEL1_FTM2PS2_SHIFT                (4U)                                                /*!< SIM_PINSEL1.FTM2PS2 Position            */
#define SIM_PINSEL1_FTM2PS2(x)                   (((uint32_t)(((uint32_t)(x))<<SIM_PINSEL1_FTM2PS2_SHIFT))&SIM_PINSEL1_FTM2PS2_MASK) /*!< SIM_PINSEL1.FTM2PS2 Field               */
#define SIM_PINSEL1_FTM2PS3_MASK                 (0xC0U)                                             /*!< SIM_PINSEL1.FTM2PS3 Mask                */
#define SIM_PINSEL1_FTM2PS3_SHIFT                (6U)                                                /*!< SIM_PINSEL1.FTM2PS3 Position            */
#define SIM_PINSEL1_FTM2PS3(x)                   (((uint32_t)(((uint32_t)(x))<<SIM_PINSEL1_FTM2PS3_SHIFT))&SIM_PINSEL1_FTM2PS3_MASK) /*!< SIM_PINSEL1.FTM2PS3 Field               */
#define SIM_PINSEL1_FTM2PS4_MASK                 (0x100U)                                            /*!< SIM_PINSEL1.FTM2PS4 Mask                */
#define SIM_PINSEL1_FTM2PS4_SHIFT                (8U)                                                /*!< SIM_PINSEL1.FTM2PS4 Position            */
#define SIM_PINSEL1_FTM2PS4(x)                   (((uint32_t)(((uint32_t)(x))<<SIM_PINSEL1_FTM2PS4_SHIFT))&SIM_PINSEL1_FTM2PS4_MASK) /*!< SIM_PINSEL1.FTM2PS4 Field               */
#define SIM_PINSEL1_FTM2PS5_MASK                 (0x200U)                                            /*!< SIM_PINSEL1.FTM2PS5 Mask                */
#define SIM_PINSEL1_FTM2PS5_SHIFT                (9U)                                                /*!< SIM_PINSEL1.FTM2PS5 Position            */
#define SIM_PINSEL1_FTM2PS5(x)                   (((uint32_t)(((uint32_t)(x))<<SIM_PINSEL1_FTM2PS5_SHIFT))&SIM_PINSEL1_FTM2PS5_MASK) /*!< SIM_PINSEL1.FTM2PS5 Field               */
#define SIM_PINSEL1_I2C1PS_MASK                  (0x400U)                                            /*!< SIM_PINSEL1.I2C1PS Mask                 */
#define SIM_PINSEL1_I2C1PS_SHIFT                 (10U)                                               /*!< SIM_PINSEL1.I2C1PS Position             */
#define SIM_PINSEL1_I2C1PS(x)                    (((uint32_t)(((uint32_t)(x))<<SIM_PINSEL1_I2C1PS_SHIFT))&SIM_PINSEL1_I2C1PS_MASK) /*!< SIM_PINSEL1.I2C1PS Field                */
#define SIM_PINSEL1_SPI1PS_MASK                  (0x800U)                                            /*!< SIM_PINSEL1.SPI1PS Mask                 */
#define SIM_PINSEL1_SPI1PS_SHIFT                 (11U)                                               /*!< SIM_PINSEL1.SPI1PS Position             */
#define SIM_PINSEL1_SPI1PS(x)                    (((uint32_t)(((uint32_t)(x))<<SIM_PINSEL1_SPI1PS_SHIFT))&SIM_PINSEL1_SPI1PS_MASK) /*!< SIM_PINSEL1.SPI1PS Field                */
#define SIM_PINSEL1_UART1PS_MASK                 (0x1000U)                                           /*!< SIM_PINSEL1.UART1PS Mask                */
#define SIM_PINSEL1_UART1PS_SHIFT                (12U)                                               /*!< SIM_PINSEL1.UART1PS Position            */
#define SIM_PINSEL1_UART1PS(x)                   (((uint32_t)(((uint32_t)(x))<<SIM_PINSEL1_UART1PS_SHIFT))&SIM_PINSEL1_UART1PS_MASK) /*!< SIM_PINSEL1.UART1PS Field               */
#define SIM_PINSEL1_UART2PS_MASK                 (0x2000U)                                           /*!< SIM_PINSEL1.UART2PS Mask                */
#define SIM_PINSEL1_UART2PS_SHIFT                (13U)                                               /*!< SIM_PINSEL1.UART2PS Position            */
#define SIM_PINSEL1_UART2PS(x)                   (((uint32_t)(((uint32_t)(x))<<SIM_PINSEL1_UART2PS_SHIFT))&SIM_PINSEL1_UART2PS_MASK) /*!< SIM_PINSEL1.UART2PS Field               */
#define SIM_PINSEL1_PWTIN0PS_MASK                (0x4000U)                                           /*!< SIM_PINSEL1.PWTIN0PS Mask               */
#define SIM_PINSEL1_PWTIN0PS_SHIFT               (14U)                                               /*!< SIM_PINSEL1.PWTIN0PS Position           */
#define SIM_PINSEL1_PWTIN0PS(x)                  (((uint32_t)(((uint32_t)(x))<<SIM_PINSEL1_PWTIN0PS_SHIFT))&SIM_PINSEL1_PWTIN0PS_MASK) /*!< SIM_PINSEL1.PWTIN0PS Field              */
#define SIM_PINSEL1_PWTIN1PS_MASK                (0x8000U)                                           /*!< SIM_PINSEL1.PWTIN1PS Mask               */
#define SIM_PINSEL1_PWTIN1PS_SHIFT               (15U)                                               /*!< SIM_PINSEL1.PWTIN1PS Position           */
#define SIM_PINSEL1_PWTIN1PS(x)                  (((uint32_t)(((uint32_t)(x))<<SIM_PINSEL1_PWTIN1PS_SHIFT))&SIM_PINSEL1_PWTIN1PS_MASK) /*!< SIM_PINSEL1.PWTIN1PS Field              */
#define SIM_PINSEL1_MSCANPS_MASK                 (0x10000U)                                          /*!< SIM_PINSEL1.MSCANPS Mask                */
#define SIM_PINSEL1_MSCANPS_SHIFT                (16U)                                               /*!< SIM_PINSEL1.MSCANPS Position            */
#define SIM_PINSEL1_MSCANPS(x)                   (((uint32_t)(((uint32_t)(x))<<SIM_PINSEL1_MSCANPS_SHIFT))&SIM_PINSEL1_MSCANPS_MASK) /*!< SIM_PINSEL1.MSCANPS Field               */
...
#define SIM_SCGC_MSCAN_MASK                      (0x8000U)                                           /*!< SIM_SCGC.MSCAN Mask                     */
#define SIM_SCGC_MSCAN_SHIFT                     (15U)                                               /*!< SIM_SCGC.MSCAN Position                 */
#define SIM_SCGC_MSCAN(x)                        (((uint32_t)(((uint32_t)(x))<<SIM_SCGC_MSCAN_SHIFT))&SIM_SCGC_MSCAN_MASK) /*!< SIM_SCGC.MSCAN Field                    */
#define SIM_SCGC_I2C0_MASK                       (0x10000U)                                          /*!< SIM_SCGC.I2C0 Mask                      */
#define SIM_SCGC_I2C0_SHIFT                      (16U)                                               /*!< SIM_SCGC.I2C0 Position                  */
#define SIM_SCGC_I2C0(x)                         (((uint32_t)(((uint32_t)(x))<<SIM_SCGC_I2C0_SHIFT))&SIM_SCGC_I2C0_MASK) /*!< SIM_SCGC.I2C0 Field                     */
#define SIM_SCGC_I2C1_MASK                       (0x20000U)                                          /*!< SIM_SCGC.I2C1 Mask                      */
#define SIM_SCGC_I2C1_SHIFT                      (17U)                                               /*!< SIM_SCGC.I2C1 Position                  */
#define SIM_SCGC_I2C1(x)                         (((uint32_t)(((uint32_t)(x))<<SIM_SCGC_I2C1_SHIFT))&SIM_SCGC_I2C1_MASK) /*!< SIM_SCGC.I2C1 Field                     */
...
/*! @name CNT - Counter Register: (Note: CNTL:CNTH) */

/*! @name CNTH - Counter Register: High (see CNT for description) */

/*! @name CNTL - Counter Register: Low (see CNT for description) */

/*! @name TOVAL - Timeout Value Register: (Note TOVALL:TOVALH) */

/*! @name TOVALH - Timeout Value Register: High (see TOVAL for description) */

/*! @name TOVALL - Timeout Value Register: Low (see TOVAL for description) */

/*! @name WIN - Window Register:(Note WINL:WINH) */

/*! @name WINH - Window Register: High (see WIN for description) */

/*! @name WINL - Window Register: Low (see WIN for description) */
/**
