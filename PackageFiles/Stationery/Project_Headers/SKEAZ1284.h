...
#define SIM_PINSEL1_MSCANPS_MASK                 (0x01UL << SIM_PINSEL1_MSCANPS_SHIFT)               /*!< SIM_PINSEL1: MSCANPS Mask               */
#define SIM_PINSEL1_MSCANPS_SHIFT                16                                                  /*!< SIM_PINSEL1: MSCANPS Position           */
...
#define SIM_SCGC_MSCAN_MASK                      (0x01UL << SIM_SCGC_MSCAN_SHIFT)                    /*!< SIM_SCGC: MSCAN Mask                    */
#define SIM_SCGC_MSCAN_SHIFT                     15                                                  /*!< SIM_SCGC: MSCAN Position                */
