 ...
 * @file     MKW01Z4.h
 *
 * @brief    CMSIS Cortex-M Peripheral Access Layer Header File for MKW01Z4.
 *           Equivalent: 
 *
 * @version  V1.6
 * @date     2024/01
...
#define PORTC_IRQS { PORTC_PORTD_IRQn,  }
...
#define PORTD_IRQS { PORTC_PORTD_IRQn,  }
