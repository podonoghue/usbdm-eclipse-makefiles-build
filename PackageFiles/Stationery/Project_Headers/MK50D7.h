...
#define DMA0_IRQS { DMA0_IRQn, DMA1_IRQn, DMA2_IRQn, DMA3_IRQn, DMA4_IRQn, DMA5_IRQn, DMA6_IRQn, DMA7_IRQn, DMA8_IRQn, DMA9_IRQn, DMA10_IRQn, DMA11_IRQn, DMA12_IRQn, DMA13_IRQn, DMA14_IRQn, DMA15_IRQn, DMA_Error_IRQn, MCM_IRQn,  }
 ...
 */
/**
* @addtogroup OPAMP_Peripheral_access_layer_GROUP OPAMP Peripheral Access Layer
* @brief C Struct for OPAMP
* @{
*/

/* ================================================================================ */
/* ================           OPAMP0 (file:OPAMP0_INV)             ================ */
/* ================================================================================ */
 ...
 */
/**
* @addtogroup OPAMP_structs_GROUP OPAMP struct
* @brief Struct for OPAMP
* @{
*/
typedef struct OPAMP_Type {
...
/**
* @addtogroup OPAMP_Register_Masks_GROUP OPAMP Register Masks
* @brief Register Masks for OPAMP
* @{
*/
/* ------- C0 Bit Fields                            ------ */
#define OPAMP0_C0_MODE_MASK                      (0x3U)                                              /*!< OPAMP0_C0.MODE Mask                     */
#define OPAMP0_C0_MODE_SHIFT                     (0U)                                                /*!< OPAMP0_C0.MODE Position                 */
#define OPAMP0_C0_MODE(x)                        (((uint8_t)(((uint8_t)(x))<<0U))&0x3UL)             /*!< OPAMP0_C0.MODE Field                    */
#define OPAMP0_C0_LPEN_MASK                      (0x40U)                                             /*!< OPAMP0_C0.LPEN Mask                     */
#define OPAMP0_C0_LPEN_SHIFT                     (6U)                                                /*!< OPAMP0_C0.LPEN Position                 */
#define OPAMP0_C0_LPEN(x)                        (((uint8_t)(((uint8_t)(x))<<6U))&0x40UL)            /*!< OPAMP0_C0.LPEN Field                    */
#define OPAMP0_C0_EN_MASK                        (0x80U)                                             /*!< OPAMP0_C0.EN Mask                       */
#define OPAMP0_C0_EN_SHIFT                       (7U)                                                /*!< OPAMP0_C0.EN Position                   */
#define OPAMP0_C0_EN(x)                          (((uint8_t)(((uint8_t)(x))<<7U))&0x80UL)            /*!< OPAMP0_C0.EN Field                      */
/* ------- C1 Bit Fields                            ------ */
#define OPAMP0_C1_AMPRI_MASK                     (0x3U)                                              /*!< OPAMP0_C1.AMPRI Mask                    */
#define OPAMP0_C1_AMPRI_SHIFT                    (0U)                                                /*!< OPAMP0_C1.AMPRI Position                */
#define OPAMP0_C1_AMPRI(x)                       (((uint8_t)(((uint8_t)(x))<<0U))&0x3UL)             /*!< OPAMP0_C1.AMPRI Field                   */
#define OPAMP0_C1_AMPRF_MASK                     (0x1CU)                                             /*!< OPAMP0_C1.AMPRF Mask                    */
#define OPAMP0_C1_AMPRF_SHIFT                    (2U)                                                /*!< OPAMP0_C1.AMPRF Position                */
#define OPAMP0_C1_AMPRF(x)                       (((uint8_t)(((uint8_t)(x))<<2U))&0x1CUL)            /*!< OPAMP0_C1.AMPRF Field                   */
/* ------- C2 Bit Fields                            ------ */
#define OPAMP0_C2_AMPNSEL_MASK                   (0x7U)                                              /*!< OPAMP0_C2.AMPNSEL Mask                  */
#define OPAMP0_C2_AMPNSEL_SHIFT                  (0U)                                                /*!< OPAMP0_C2.AMPNSEL Position              */
#define OPAMP0_C2_AMPNSEL(x)                     (((uint8_t)(((uint8_t)(x))<<0U))&0x7UL)             /*!< OPAMP0_C2.AMPNSEL Field                 */
#define OPAMP0_C2_AMPPSEL_MASK                   (0x70U)                                             /*!< OPAMP0_C2.AMPPSEL Mask                  */
#define OPAMP0_C2_AMPPSEL_SHIFT                  (4U)                                                /*!< OPAMP0_C2.AMPPSEL Position              */
#define OPAMP0_C2_AMPPSEL(x)                     (((uint8_t)(((uint8_t)(x))<<4U))&0x70UL)            /*!< OPAMP0_C2.AMPPSEL Field                 */
/**
 * @} */ /* End group OPAMP_Register_Masks_GROUP 
 */

/* OPAMP0 - Peripheral instance base addresses */
#define OPAMP0_BasePtr                 0x400F5000UL //!< Peripheral base address
#define OPAMP0                         ((OPAMP_Type *) OPAMP0_BasePtr) //!< Freescale base pointer
#define OPAMP0_BASE_PTR                (OPAMP0) //!< Freescale style base pointer
/**
 * @} */ /* End group OPAMP_Peripheral_access_layer_GROUP 
 */
/**
* @addtogroup OPAMP_Peripheral_access_layer_GROUP OPAMP Peripheral Access Layer
* @brief C Struct for OPAMP
...
#define OPAMP1_BasePtr                 0x400F5800UL //!< Peripheral base address
#define OPAMP1                         ((OPAMP_Type *) OPAMP1_BasePtr) //!< Freescale base pointer
#define OPAMP1_BASE_PTR                (OPAMP1) //!< Freescale style base pointer
/**
 * @} */ /* End group OPAMP_Peripheral_access_layer_GROUP 
 */
/**
...
#define SIM_SCGC1_OPAMP_MASK                     (0x200000U)                                         /*!< SIM_SCGC1.OPAMP Mask                    */
#define SIM_SCGC1_OPAMP_SHIFT                    (21U)                                               /*!< SIM_SCGC1.OPAMP Position                */
#define SIM_SCGC1_OPAMP(x)                       (((uint32_t)(((uint32_t)(x))<<21U))&0x200000UL)     /*!< SIM_SCGC1.OPAMP Field                   */
#define SIM_SCGC1_TRIAMP_MASK                    (0x1000000U)                                        /*!< SIM_SCGC1.TRIAMP Mask                   */
#define SIM_SCGC1_TRIAMP_SHIFT                   (24U)                                               /*!< SIM_SCGC1.TRIAMP Position               */
#define SIM_SCGC1_TRIAMP(x)                      (((uint32_t)(((uint32_t)(x))<<24U))&0x1000000UL)    /*!< SIM_SCGC1.TRIAMP Field                  */
/* ------- SCGC2 Bit Fields                         ------ */
 ...
 */
/**
* @addtogroup TRIAMP_Peripheral_access_layer_GROUP TRIAMP Peripheral Access Layer
* @brief C Struct for TRIAMP
* @{
*/
 ...
 */
/**
* @addtogroup TRIAMP_structs_GROUP TRIAMP struct
* @brief Struct for TRIAMP
* @{
*/
typedef struct TRIAMP_Type {
   __IO uint8_t   C0;                           /**< 0000: Control Register 0                                           */
} TRIAMP_Type;

/**
 * @} */ /* End group TRIAMP_structs_GROUP 
 */
...
/**
* @addtogroup TRIAMP_Register_Masks_GROUP TRIAMP Register Masks
* @brief Register Masks for TRIAMP
* @{
*/
/* ------- C0 Bit Fields                            ------ */
#define TRIAMP0_C0_LPEN_MASK                     (0x40U)                                             /*!< TRIAMP0_C0.LPEN Mask                    */
#define TRIAMP0_C0_LPEN_SHIFT                    (6U)                                                /*!< TRIAMP0_C0.LPEN Position                */
#define TRIAMP0_C0_LPEN(x)                       (((uint8_t)(((uint8_t)(x))<<6U))&0x40UL)            /*!< TRIAMP0_C0.LPEN Field                   */
#define TRIAMP0_C0_TRIAMPEN_MASK                 (0x80U)                                             /*!< TRIAMP0_C0.TRIAMPEN Mask                */
#define TRIAMP0_C0_TRIAMPEN_SHIFT                (7U)                                                /*!< TRIAMP0_C0.TRIAMPEN Position            */
#define TRIAMP0_C0_TRIAMPEN(x)                   (((uint8_t)(((uint8_t)(x))<<7U))&0x80UL)            /*!< TRIAMP0_C0.TRIAMPEN Field               */
/**
 * @} */ /* End group TRIAMP_Register_Masks_GROUP 
 */

/* TRIAMP0 - Peripheral instance base addresses */
#define TRIAMP0_BasePtr                0x400F8000UL //!< Peripheral base address
#define TRIAMP0                        ((TRIAMP_Type *) TRIAMP0_BasePtr) //!< Freescale base pointer
#define TRIAMP0_BASE_PTR               (TRIAMP0) //!< Freescale style base pointer
/**
 * @} */ /* End group TRIAMP_Peripheral_access_layer_GROUP 
 */
/**
