...
#define SIM_SCGC5_RNGB(x)                        (((uint8_t)(((uint8_t)(x))<<7U))&0x80UL)            /*!< SIM_SCGC5.RNGB Field                    */
/* ------- SCGC6 Bit Fields                         ------ */
