...
/**
 * @struct BWT_Type
 * @brief  C Struct allowing access to BWT registers
 */
...
/**
 * @struct CANMB_Type
 * @brief  C Struct allowing access to CANMB registers
 */
...
/**
 * @struct FBCS_Type
 * @brief  C Struct allowing access to FBCS registers
 */
...
/**
 * @struct FlexCAN_Type
 * @brief  C Struct allowing access to FlexCAN registers
 */
...
/**
 * @struct GPT_Type
 * @brief  C Struct allowing access to GPT registers
 */
