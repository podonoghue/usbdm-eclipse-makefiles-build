...
#define KBI0_SC_KBMOD(x)                         (((uint8_t)(((uint8_t)(x))<<KBI0_SC_KBMOD_SHIFT))&KBI0_SC_KBMOD_MASK) /*!< KBI0_SC.KBMOD Field                     */
#define KBI0_SC_KBIE_MASK                        (0x2U)                                              /*!< KBI0_SC.KBIE Mask                       */
#define KBI0_SC_KBIE_SHIFT                       (1U)                                                /*!< KBI0_SC.KBIE Position                   */
#define KBI0_SC_KBIE(x)                          (((uint8_t)(((uint8_t)(x))<<KBI0_SC_KBIE_SHIFT))&KBI0_SC_KBIE_MASK) /*!< KBI0_SC.KBIE Field                      */
#define KBI0_SC_KBACK_MASK                       (0x4U)                                              /*!< KBI0_SC.KBACK Mask                      */
#define KBI0_SC_KBACK_SHIFT                      (2U)                                                /*!< KBI0_SC.KBACK Position                  */
#define KBI0_SC_KBACK(x)                         (((uint8_t)(((uint8_t)(x))<<KBI0_SC_KBACK_SHIFT))&KBI0_SC_KBACK_MASK) /*!< KBI0_SC.KBACK Field                     */
#define KBI0_SC_KBF_MASK                         (0x8U)                                              /*!< KBI0_SC.KBF Mask                        */
#define KBI0_SC_KBF_SHIFT                        (3U)                                                /*!< KBI0_SC.KBF Position                    */
#define KBI0_SC_KBF(x)                           (((uint8_t)(((uint8_t)(x))<<KBI0_SC_KBF_SHIFT))&KBI0_SC_KBF_MASK) /*!< KBI0_SC.KBF Field                       */
...
#define KBI0_PE_KBIPE(x)                         (((uint8_t)(((uint8_t)(x))<<KBI0_PE_KBIPE_SHIFT))&KBI0_PE_KBIPE_MASK) /*!< KBI0_PE.KBIPE Field                     */
...
#define KBI0_ES_KBEDG(x)                         (((uint8_t)(((uint8_t)(x))<<KBI0_ES_KBEDG_SHIFT))&KBI0_ES_KBEDG_MASK) /*!< KBI0_ES.KBEDG Field                     */
/**
