...
/* ----------------------   MKL17Z4 VectorTable                      ---------------------- */
  ...
  UART2_FLEXIO_IRQn             =  14,   /**<  30 UART2/FLEXIO                                                                     */
...
extern void UART2_FLEXIO_IRQHandler(void);           /**< UART2/FLEXIO                                                                     */
...
#define SIM_SCGC4_USBFS(x)                       (((uint32_t)(((uint32_t)(x))<<SIM_SCGC4_USBFS_SHIFT))&SIM_SCGC4_USBFS_MASK) /*!< SIM_SCGC4.USBFS Field                   */
