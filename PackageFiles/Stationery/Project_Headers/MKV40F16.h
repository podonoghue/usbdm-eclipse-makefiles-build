...
#define ADC0_IRQS { ADC_Error_IRQn, ADCA_IRQn, ADCB_IRQn,  }
...
/**
 * @struct AOI_Type
 * @brief  C Struct allowing access to AOI registers
 */
...
/**
 * @struct ENC_Type
 * @brief  C Struct allowing access to ENC registers
 */
...
#define ENC_IRQS { ENC_COMPARE_IRQn, ENC_HOME_IRQn, ENC_WDOG_SAB_IRQn, ENC_INDEX_IRQn,  }
...
#define PDB_PO_COUNT         4          /**< Number of Pulse outputs                            */
/**
 * @struct PDB_Type
...
typedef struct PDB_Type {
   ...
   } PO[PDB_PO_COUNT];                          /**< 0194: (cluster: size=0x0010, 16)                                   */
} PDB_Type;
...
/**
 * @struct XBARA_Type
 * @brief  C Struct allowing access to XBARA registers
 */
...
/**
 * @struct XBARB_Type
 * @brief  C Struct allowing access to XBARB registers
 */
