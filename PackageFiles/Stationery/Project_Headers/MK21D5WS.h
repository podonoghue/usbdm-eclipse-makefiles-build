...
#define RCM_SRS1_TAMPER(x)                       (((uint8_t)(((uint8_t)(x))<<7U))&0x80UL)            /*!< RCM_SRS1.TAMPER Field                   */
/* ------- RPFC Bit Fields                          ------ */
...
#define SIM_SCGC5_DRYICE(x)                      (((uint32_t)(((uint32_t)(x))<<2U))&0x4UL)           /*!< SIM_SCGC5.DRYICE Field                  */
