...
/* ----------------------   MK02F12810 VectorTable                   ---------------------- */
  ...
  DMA0_Error_IRQn               =  16,   /**<  32 DMA error interrupt                                                              */
