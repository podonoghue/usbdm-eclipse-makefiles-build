...
#define DMA_CR_ACTIVE_MASK                       (0x01UL << DMA_CR_ACTIVE_SHIFT)                     /*!< DMA0_CR: ACTIVE Mask                    */
#define DMA_CR_ACTIVE_SHIFT                      31                                                  /*!< DMA0_CR: ACTIVE Position                */
#define DMA_CR_ACTIVE(x)                         (((uint32_t)(((uint32_t)(x))<<DMA_CR_ACTIVE_SHIFT))&DMA_CR_ACTIVE_MASK) /*!< DMA0_CR                                 */
/* ------- ES Bit Fields                            ------ */
