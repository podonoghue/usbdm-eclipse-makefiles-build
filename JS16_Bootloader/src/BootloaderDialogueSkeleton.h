...
class BootloaderDialogueSkeleton : public wxDialog
{
	...
	public:
		...
		BootloaderDialogueSkeleton( wxWindow* parent, wxWindowID id = wxID_ANY, const wxString& title = wxT("JS16 ICP Bootloader"), const wxPoint& pos = wxDefaultPosition, const wxSize& size = wxSize( 371,500 ), long style = wxDEFAULT_DIALOG_STYLE|wxMINIMIZE_BOX|wxRESIZE_BORDER );
