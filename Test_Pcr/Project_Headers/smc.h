...
protected:
   /**
    * Enter Stop mode after running wait loop in RAM to allow for flash pipeline
    */
   static void executeRamStopCommand() {
      ...
      console.write("&space = ").writeln(space);
...
public:
   ...
   static void enterStopMode() {
      ...
      // Make sure write completes and Flash idle
      executeRamStopCommand();
   }
