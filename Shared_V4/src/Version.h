...
#define USBDM_VERSION_NANO   90      //!< DLL Nano version #

#ifdef LOG
#define USBDM_VERSION_STRING "4.12.1.90-Debug" //!< Version as string
#else
#define USBDM_VERSION_STRING "4.12.1.90"       //!< Version as string
#endif
...
// Revision History
//-----------+----------------------------------------------------------------
//    Feb 16 | 4.12.1.90 Build                                           - pgo
//-----------+----------------------------------------------------------------
//    Feb 16 | 4.12.1.80 Build                                           - pgo
//-----------+----------------------------------------------------------------
