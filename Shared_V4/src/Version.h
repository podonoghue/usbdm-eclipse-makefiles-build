...
#define USBDM_VERSION_NANO   140      //!< DLL Nano version #

#ifdef LOG
#define USBDM_VERSION_STRING "4.12.1.140-Debug" //!< Version as string
#else
#define USBDM_VERSION_STRING "4.12.1.140"       //!< Version as string
#endif
