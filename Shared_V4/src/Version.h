...
#define USBDM_VERSION_NANO   261      //!< DLL Nano version #

#ifdef LOG
#define USBDM_VERSION_STRING "4.12.1.261-Debug" //!< Version as string
#else
#define USBDM_VERSION_STRING "4.12.1.261"       //!< Version as string
#endif
