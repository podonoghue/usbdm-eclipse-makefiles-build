...
#define USBDM_VERSION_NANO   130      //!< DLL Nano version #

#ifdef LOG
#define USBDM_VERSION_STRING "4.12.1.130-Debug" //!< Version as string
#else
#define USBDM_VERSION_STRING "4.12.1.130"       //!< Version as string
#endif
