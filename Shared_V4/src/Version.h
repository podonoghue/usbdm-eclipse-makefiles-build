...
#define USBDM_VERSION_NANO   150      //!< DLL Nano version #

#ifdef LOG
#define USBDM_VERSION_STRING "4.12.1.150-Debug" //!< Version as string
#else
#define USBDM_VERSION_STRING "4.12.1.150"       //!< Version as string
#endif
