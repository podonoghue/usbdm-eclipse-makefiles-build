...
#define USBDM_VERSION_NANO   10      //!< DLL Nano version #

#ifdef LOG
#define USBDM_VERSION_STRING "4.11.1.10-Debug" //!< Version as string
#else
#define USBDM_VERSION_STRING "4.11.1.10"       //!< Version as string
#endif
