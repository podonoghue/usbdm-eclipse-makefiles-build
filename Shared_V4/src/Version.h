...
#define USBDM_VERSION_NANO   120      //!< DLL Nano version #

#ifdef LOG
#define USBDM_VERSION_STRING "4.12.1.120-Debug" //!< Version as string
#else
#define USBDM_VERSION_STRING "4.12.1.120"       //!< Version as string
#endif
