...
#define USBDM_VERSION_NANO   220      //!< DLL Nano version #

#ifdef LOG
#define USBDM_VERSION_STRING "4.12.1.220-Debug" //!< Version as string
#else
#define USBDM_VERSION_STRING "4.12.1.220"       //!< Version as string
#endif
