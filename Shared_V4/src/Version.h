...
#define USBDM_VERSION_NANO   170      //!< DLL Nano version #

#ifdef LOG
#define USBDM_VERSION_STRING "4.12.1.170-Debug" //!< Version as string
#else
#define USBDM_VERSION_STRING "4.12.1.170"       //!< Version as string
#endif
