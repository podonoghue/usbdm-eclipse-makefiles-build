...
#define USBDM_VERSION_NANO   70      //!< DLL Nano version #

#ifdef LOG
#define USBDM_VERSION_STRING "4.12.1.70-Debug" //!< Version as string
#else
#define USBDM_VERSION_STRING "4.12.1.70"       //!< Version as string
#endif
