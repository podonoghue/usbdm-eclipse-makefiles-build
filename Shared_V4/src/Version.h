...
#define USBDM_VERSION_NANO   80      //!< DLL Nano version #

#ifdef LOG
#define USBDM_VERSION_STRING "4.12.1.80-Debug" //!< Version as string
#else
#define USBDM_VERSION_STRING "4.12.1.80"       //!< Version as string
#endif
