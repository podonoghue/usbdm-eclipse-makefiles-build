/*! \file
    \brief Header file for BdmInterface.cpp
...
public:
    ...
    *
    * A return value of UsbdmWxConstants::NO will men to abort operation.
    */
...
public:
   ...
   */
   ...
   /*!
    * Indicates if the opened BDM must match the serial number
    *
    * @return serial number
    */
