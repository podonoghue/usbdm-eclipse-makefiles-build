...
FirmwareChangerSkeleton::FirmwareChangerSkeleton( wxWindow* parent, wxWindowID id, const wxString& title, const wxPoint& pos, const wxSize& size, long style ) : wxDialog( parent, id, title, pos, size, style )
{
	...
	loadFirmwareButton = new wxButton( this, wxID_ANY, wxT("Load Firmware File..."), wxDefaultPosition, wxDefaultSize, 0 );
	bSizer5->Add( loadFirmwareButton, 0, wxALL, 5 );
	
	autoSelectFirmwareCheckbox = new wxCheckBox( this, wxID_ANY, wxT("Auto select BDM firmware"), wxDefaultPosition, wxDefaultSize, 0 );
	...
	filenameStaticText = new wxStaticText( this, wxID_ANY, wxT("No file loaded"), wxDefaultPosition, wxDefaultSize, 0 );
	...
	fileInformationStaticText = new wxTextCtrl( this, wxID_ANY, wxEmptyString, wxDefaultPosition, wxDefaultSize, wxTE_CHARWRAP|wxTE_MULTILINE|wxTE_READONLY|wxTE_WORDWRAP );
